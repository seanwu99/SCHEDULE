 ...
 */
    var COL_MIN_WIDTH, Calendar_buildCurrentBusinessFootprints, Calendar_buildSelectFootprint, Calendar_constructed,
        Calendar_eventRangeToEventFootprints, Calendar_footprintContainsFootprint, Calendar_footprintsIntersect,
        Calendar_getPeerEventInstances, Calendar_isFootprintAllowed, Calendar_parseFootprints, Calendar_requestEvents,
        ClippedScroller, DEFAULT_GRID_DURATION, DateComponent_eventRangeToEventFootprints,
        DateSelecting_computeSelectionFootprint, EnhancedScroller, EventDef_applyMiscProps, EventDef_clone,
        EventDef_toLegacy, EventDragging_computeEventDropMutation, EventRenderer_getFallbackStylingObjs,
        EventResizing_computeEventEndResizeMutation, EventResizing_computeEventStartResizeMutation, EventRow,
        ExternalDropping_computeExternalDrop, HRowGroup, InteractiveDateComponent_isEventDefDraggable, LICENSE_INFO_URL,
        MAX_AUTO_CELLS, MAX_AUTO_SLOTS_PER_LABEL, MAX_CELLS, MIN_AUTO_LABELS, PRESET_LICENSE_KEYS, RELEASE_DATE,
        Resource, ResourceAgendaView, ResourceBasicView, ResourceComponentFootprint, ResourceDayGrid,
        ResourceDayTableMixin, ResourceManager, ResourceMonthView, ResourceRow, ResourceTimeGrid,
        ResourceTimelineEventRenderer, ResourceTimelineView, ResourceViewMixin, RowGroup, RowParent,
        STOCK_SUB_DURATIONS, ScrollFollower, ScrollFollowerSprite, ScrollJoiner, ScrollerCanvas, Spreadsheet,
        TimelineEventDragging, TimelineEventRenderer, TimelineEventResizing, TimelineFillRenderer,
        TimelineHelperRenderer, TimelineView, UPGRADE_WINDOW, VRowGroup, View_removeElement, View_setElement,
        View_triggerViewRender, _filterResourcesWithEvents, computeOffsetForSeg, computeOffsetForSegs, copyRect,
        detectWarningInContainer, getOwnCells, getRectHeight, getRectWidth, groupEventFootprintsByResourceId,
        hContainRect, isImmuneUrl, isValidKey, joinRects, oldMutateSingle, processLicenseKey,
        renderingWarningInContainer, testRectContains, testRectHContains, testRectVContains, timeRowSegsCollide,
        vContainRect,
 ...
 */
    ...
    ResourceDayTableMixin = {
        ...
        renderBusinessHours: function (businessHourGenerator) {
            var eventFootprints, eventInstanceGroup, eventRange, isAllDay, j, k, len, len1, ref, ref1, resource,
                unzonedRange;
    ...
    Calendar.prototype.buildCurrentBusinessFootprints = function (isAllDay) {
        var anyCustomBusinessHours, businessHourGenerator, componentFootprints, eventInstanceGroup, eventRange,
            flatResources, generalBusinessHourGenerator, j, k, l, len, len1, len2, ref, resource, unzonedRange, view;
 ...
 */
   ...
   */
        ...
        TimelineEventRenderer.prototype.buildSegLevels = function (segs) {
            var belowSeg, isLevelCollision, j, k, l, len, len1, len2, level, placedSeg, ref, ref1, segLevels,
                unplacedSeg;
            segLevels = [];
 ...
 */
   ...
   */
        ...
        TimelineView.prototype.renderSlatHtml = function () {
            var cell, cellRows, date, format, formats, headerCellClassNames, html, i, isChrono, isLast, isSingleDay,
                isSuperRow, isWeekStart, j, k, l, labelInterval, leadingCell, len, len1, len2, len3, len4, len5, len6,
                m, n, newCell, p, prevWeekNumber, q, row, rowCells, rowUnits, slatHtml, slotCells, slotDates, text,
                theme, weekNumber;
            theme = this.calendar.theme;
        ...
        TimelineView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
            var availableWidth, bodyHeight, containerMinWidth, containerWidth, isDatesRendered, nonLastSlotWidth,
                slotWidth;
            if (isAuto) {
                bodyHeight = 'auto';
            } else {
        ...
        TimelineView.prototype.queryHit = function (leftOffset, topOffset) {
            var localSnapIndex, partial, slatCoordCache, slatIndex, slatLeft, slatRight, slatWidth, snapIndex, snapLeft,
                snapRight, snapsPerSlot, timeBodyBoundCache;
   ...
   */
    ...
    Spreadsheet = (function () {
        ...
        Spreadsheet.prototype.renderSkeleton = function () {
            ...
            this.bodyScroller.canvas.contentEl.html('<div class="fc-rows"> <table class="' + theme.getClass('tableGrid') + '">' +
                // this.colGroupHtml +
                '<tbody/> </table> </div>');
        ...
        Spreadsheet.prototype.renderHeadHtml = function () {
            ...
            html = '<table class="' + theme.getClass('tableGrid') + '">';
            // colGroupHtml = '<colgroup></colgroup>';
        ...
        Spreadsheet.prototype.applyColWidths = function () {
            var allNumbers, anyPercentages, colMinWidths, colWidth, colWidths, cssWidth, cssWidths, defaultCssWidth, i,
                j, k, l, len, len1, len2, tableMinWidth, total;
    ...
    ResourceTimelineView = (function (superClass) {
        ...
        ResourceTimelineView.prototype.processResourceOptions = function () {
            var allColSpecs, allOrderSpecs, colSpec, defaultLabelText, groupColSpecs, groupSpec, groupSpecs,
                hGroupField, isGroup, isHGrouping, isVGrouping, j, k, l, labelText, len, len1, len2, orderSpec,
                plainColSpecs, plainOrderSpecs, superHeaderText;
        ...
        ResourceTimelineView.prototype.executeEventRender = function (eventsPayload) {
            var eventDef, eventDefId, eventInstanceGroup, genericPayload, j, len, payloadsByResourceId,
                resourceEventsPayload, resourceId, resourceIds, row;
