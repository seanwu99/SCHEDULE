	...
	var oMenuButton4 = new sap.ui.commons.MenuButton({text: "Scheduling", icon: "Common/img/list.png"});
	...
	var oMenu4 = new sap.ui.commons.Menu("menu4", {ariaDescription: "Scheduling", enabled:true});
	...
	// Create the items and add them to the menu 4 ------------------	Scheduling		-------------------------------------	
		...
		var oMenuItem410 = new sap.ui.commons.MenuItem("item4-1-0",{text: "Scheduling", enabled:false});
