	...
	// Create  submenu  7  	--------------	Master Data		------------------------
		...
		var oMenuItem77 = new sap.ui.commons.MenuItem("item1-7-7",{text: "OEE", enabled: false});
		oMenu7.addItem(oMenuItem77);

		var oMenu77 = new sap.ui.commons.Menu("menu77", {ariaDescription: "Master Data", enabled:true});
		oMenuItem77.setSubmenu(oMenu77);

		var oMenuItem77_1 = new sap.ui.commons.MenuItem("item1-7-7-1",{text: "OEE Shifts", enabled: false});
		oMenu77.addItem(oMenuItem77_1);
		var oMenuItem77_2 = new sap.ui.commons.MenuItem("item1-7-7-2",{text: "OEE Planned Downtime", enabled: false});
		oMenu77.addItem(oMenuItem77_2);
		var oMenuItem77_3 = new sap.ui.commons.MenuItem("item1-7-7-3",{text: "OEE Threshold", enabled: false});
		oMenu77.addItem(oMenuItem77_3);
	...
	// Create the items and add them to the menu 3
		...
		var oMenuItem34 = new sap.ui.commons.MenuItem("item3-0-7",{text: "Hourly Production Status", enabled:false});
		oMenu3.addItem(oMenuItem34);
		var oMenuItem35 = new sap.ui.commons.MenuItem("item3-0-8",{text: "Shims Report", enabled:false});
	...
	oMenuButton1.attachItemSelected(function (oEvent){
		...
		switch( oEvent.getParameter("itemId")) {
			...
			case "item1-7-6":
				...
				break;
			case "item1-7-7-1":
				setTimeout("location.href = '" +  "OEEShifts.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-7-7-2":
				setTimeout("location.href = '" +  "OEEPlannedDowntime.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item1-7-7-3":
				setTimeout("location.href = '" +  "OEEThreshold.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
	...
	oMenuButton3.attachItemSelected(function (oEvent){
		switch( oEvent.getParameter("itemId")) {
			...
			case "item3-0-3":
				...
				break;
			case "item3-0-7":
				setTimeout("location.href = '" + "ProductionStatusHours.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-8":
				setTimeout("location.href = '" + "ShimsReport.irpt?ROLE=" + document.getElementById("user_role").value + "'",0);
				break;
			case "item3-0-4":
