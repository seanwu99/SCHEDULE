...
function rstr_hmac_md5(A, e) {
    ...
    for (var o = Array(16), i = Array(16), s = 0; s < 16; s++)o[s] = 909522486 ^ t[s], i[s] = 1549556828 ^ t[s];
...
function rstr2hex(A) {
    ...
    for (var e = hexcase ? "0123456789ABCDEF" : "0123456789abcdef", t = "", o, i = 0; i < A.length; i++)o = A.charCodeAt(i), t += e.charAt(o >>> 4 & 15) + e.charAt(15 & o);
    return t
}
function str2rstr_utf8(A) {
    var e = "", t = -1, o, i;
    while (++t < A.length)o = A.charCodeAt(t), i = t + 1 < A.length ? A.charCodeAt(t + 1) : 0, 55296 <= o && o <= 56319 && 56320 <= i && i <= 57343 && (o = 65536 + ((1023 & o) << 10) + (1023 & i), t++), o <= 127 ? e += String.fromCharCode(o) : o <= 2047 ? e += String.fromCharCode(192 | o >>> 6 & 31, 128 | 63 & o) : o <= 65535 ? e += String.fromCharCode(224 | o >>> 12 & 15, 128 | o >>> 6 & 63, 128 | 63 & o) : o <= 2097151 && (e += String.fromCharCode(240 | o >>> 18 & 7, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o));
    return e
}
function rstr2binl(A) {
    for (var e = Array(A.length >> 2), t = 0; t < e.length; t++)e[t] = 0;
    for (var t = 0; t < 8 * A.length; t += 8)e[t >> 5] |= (255 & A.charCodeAt(t / 8)) << t % 32;
    return e
}
function binl2rstr(A) {
    for (var e = "", t = 0; t < 32 * A.length; t += 8)e += String.fromCharCode(A[t >> 5] >>> t % 32 & 255);
    return e
}
function binl_md5(A, e) {
    A[e >> 5] |= 128 << e % 32, A[(e + 64 >>> 9 << 4) + 14] = e;
    for (var t = 1732584193, o = -271733879, i = -1732584194, s = 271733878, n = 0; n < A.length; n += 16) {
        var a = t, r = o, l = i, c = s;
        t = md5_ff(t, o, i, s, A[n + 0], 7, -680876936), s = md5_ff(s, t, o, i, A[n + 1], 12, -389564586), i = md5_ff(i, s, t, o, A[n + 2], 17, 606105819), o = md5_ff(o, i, s, t, A[n + 3], 22, -1044525330), t = md5_ff(t, o, i, s, A[n + 4], 7, -176418897), s = md5_ff(s, t, o, i, A[n + 5], 12, 1200080426), i = md5_ff(i, s, t, o, A[n + 6], 17, -1473231341), o = md5_ff(o, i, s, t, A[n + 7], 22, -45705983), t = md5_ff(t, o, i, s, A[n + 8], 7, 1770035416), s = md5_ff(s, t, o, i, A[n + 9], 12, -1958414417), i = md5_ff(i, s, t, o, A[n + 10], 17, -42063), o = md5_ff(o, i, s, t, A[n + 11], 22, -1990404162), t = md5_ff(t, o, i, s, A[n + 12], 7, 1804603682), s = md5_ff(s, t, o, i, A[n + 13], 12, -40341101), i = md5_ff(i, s, t, o, A[n + 14], 17, -1502002290), o = md5_ff(o, i, s, t, A[n + 15], 22, 1236535329), t = md5_gg(t, o, i, s, A[n + 1], 5, -165796510), s = md5_gg(s, t, o, i, A[n + 6], 9, -1069501632), i = md5_gg(i, s, t, o, A[n + 11], 14, 643717713), o = md5_gg(o, i, s, t, A[n + 0], 20, -373897302), t = md5_gg(t, o, i, s, A[n + 5], 5, -701558691), s = md5_gg(s, t, o, i, A[n + 10], 9, 38016083), i = md5_gg(i, s, t, o, A[n + 15], 14, -660478335), o = md5_gg(o, i, s, t, A[n + 4], 20, -405537848), t = md5_gg(t, o, i, s, A[n + 9], 5, 568446438), s = md5_gg(s, t, o, i, A[n + 14], 9, -1019803690), i = md5_gg(i, s, t, o, A[n + 3], 14, -187363961), o = md5_gg(o, i, s, t, A[n + 8], 20, 1163531501), t = md5_gg(t, o, i, s, A[n + 13], 5, -1444681467), s = md5_gg(s, t, o, i, A[n + 2], 9, -51403784), i = md5_gg(i, s, t, o, A[n + 7], 14, 1735328473), o = md5_gg(o, i, s, t, A[n + 12], 20, -1926607734), t = md5_hh(t, o, i, s, A[n + 5], 4, -378558), s = md5_hh(s, t, o, i, A[n + 8], 11, -2022574463), i = md5_hh(i, s, t, o, A[n + 11], 16, 1839030562), o = md5_hh(o, i, s, t, A[n + 14], 23, -35309556), t = md5_hh(t, o, i, s, A[n + 1], 4, -1530992060), s = md5_hh(s, t, o, i, A[n + 4], 11, 1272893353), i = md5_hh(i, s, t, o, A[n + 7], 16, -155497632), o = md5_hh(o, i, s, t, A[n + 10], 23, -1094730640), t = md5_hh(t, o, i, s, A[n + 13], 4, 681279174), s = md5_hh(s, t, o, i, A[n + 0], 11, -358537222), i = md5_hh(i, s, t, o, A[n + 3], 16, -722521979), o = md5_hh(o, i, s, t, A[n + 6], 23, 76029189), t = md5_hh(t, o, i, s, A[n + 9], 4, -640364487), s = md5_hh(s, t, o, i, A[n + 12], 11, -421815835), i = md5_hh(i, s, t, o, A[n + 15], 16, 530742520), o = md5_hh(o, i, s, t, A[n + 2], 23, -995338651), t = md5_ii(t, o, i, s, A[n + 0], 6, -198630844), s = md5_ii(s, t, o, i, A[n + 7], 10, 1126891415), i = md5_ii(i, s, t, o, A[n + 14], 15, -1416354905), o = md5_ii(o, i, s, t, A[n + 5], 21, -57434055), t = md5_ii(t, o, i, s, A[n + 12], 6, 1700485571), s = md5_ii(s, t, o, i, A[n + 3], 10, -1894986606), i = md5_ii(i, s, t, o, A[n + 10], 15, -1051523), o = md5_ii(o, i, s, t, A[n + 1], 21, -2054922799), t = md5_ii(t, o, i, s, A[n + 8], 6, 1873313359), s = md5_ii(s, t, o, i, A[n + 15], 10, -30611744), i = md5_ii(i, s, t, o, A[n + 6], 15, -1560198380), o = md5_ii(o, i, s, t, A[n + 13], 21, 1309151649), t = md5_ii(t, o, i, s, A[n + 4], 6, -145523070), s = md5_ii(s, t, o, i, A[n + 11], 10, -1120210379), i = md5_ii(i, s, t, o, A[n + 2], 15, 718787259), o = md5_ii(o, i, s, t, A[n + 9], 21, -343485551), t = safe_add(t, a), o = safe_add(o, r), i = safe_add(i, l), s = safe_add(s, c)
    }
...
function safe_add(A, e) {
    var t = (65535 & A) + (65535 & e), o = (A >> 16) + (e >> 16) + (t >> 16);
    return o << 16 | 65535 & t
}
...
function stiTreeNode(A, e, t, o, i) {
    this.id = A, this.pid = e, this.name = t, this.url = o ? o.replace(/'/g, "\\'") : o, this.title = i, null == this.page, i && (this.page = parseInt(i.substr(5)) - 1), this.target = null, this.icon = null, this.iconOpen = null, this._io = !1, this._is = !1, this._ls = !1, this._hc = !1, this._ai = 0, this._p
}
function stiTree(A, e, t, o) {
    this.config = {
        ...
        closeSameLevel: !1,
        inOrder: !1
    }, this.icon = {nlPlus: "img/nolines_plus.gif", nlMinus: "img/nolines_minus.gif"};
    for (var i in o)this.icon[i] = o[i];
    this.obj = A, this.mobileViewerId = e, this.currentPageNumber = t, this.aNodes = [], this.aIndent = [], this.root = new stiTreeNode((-1)), this.selectedNode = null, this.selectedFound = !1, this.completed = !1
}
function StiJsViewer(A) {
    if (this.defaultParameters = {
            options: {
                reportGuid: "f062fbe58c3e43ff94cc93f98abb0719",
                clientGuid: "1952913744494cdf94ab33fd8b62cbef",
                ...
                productVersion: "2016.2.6 from 4 November 2016 ",
                email: {
                    showEmailDialog: !0,
                    defaultEmailMessage: "",
                    defaultEmailSubject: "",
                ...
                theme: "Office2013",
                requestAbsoluteUrl: "http://localhost:13773/default.aspx"
            },
            defaultExportSettings: {
                StiOdsExportSettings: {ImageQuality: .75, ImageResolution: 100, PageRange: "All"},
                ...
                StiPpt2007ExportSettings: {ImageQuality: .75, ImageResolution: 100, PageRange: "All"},
        ...
        }, A.loc && this.collections.loc && (this.collections.loc = A.loc), this.controls = {}, this.controls.head = document.getElementsByTagName("head")[0], this.controls.viewer = document.getElementById(this.options.viewerId), this.controls.mainPanel = document.getElementById(this.options.viewerId + "_JsViewerMainPanel"), this.controls.findHelper = {findLabels: []}, this.reportParams = {
            ...
            drillDownParameters: []
        }, this.options.actions.printReport || (this.options.actions.printReport = this.options.actions.viewerEvent), this.options.actions.exportReport || (this.options.actions.exportReport = this.options.actions.viewerEvent), this.options.actions.interaction || (this.options.actions.interaction = this.options.actions.viewerEvent), this.options.requestStylesUrl) {
        var e = this.options.requestStylesUrl.replace("{action}", this.options.actions.viewerEvent);
        e += e.indexOf("?") > 0 ? "&" : "?", e += "jsviewer_resource=styles&jsviewer_theme=" + this.options.theme + "&jsviewer_version=" + this.options.shortProductVersion;
        var t = document.createElement("link");
        t.setAttribute("type", "text/css"), t.setAttribute("rel", "stylesheet"), t.setAttribute("href", e), this.controls.head.appendChild(t)
    }
    this.InitializeJsViewer(), this.InitializeToolBar(), this.options.toolbar.showFindButton && this.InitializeFindPanel(), this.InitializeDrillDownPanel(), this.InitializeDisabledPanels(), this.InitializeAboutPanel(), this.InitializeReportPanel(), this.InitializeProcessImage(), this.InitializeDatePicker(), this.InitializeToolTip(), this.options.toolbar.showSaveButton && this.options.toolbar.visible && this.InitializeSaveMenu(), this.options.toolbar.showSendEmailButton && this.options.toolbar.visible && this.InitializeSendEmailMenu(), this.options.toolbar.showPrintButton && this.options.toolbar.visible && this.InitializePrintMenu(), this.options.toolbar.showZoomButton && this.options.toolbar.visible && this.InitializeZoomMenu(), this.options.toolbar.showViewModeButton && this.options.toolbar.visible && this.InitializeViewModeMenu(), (this.options.exports.showExportDialog || this.options.email.showExportDialog) && this.InitializeExportForm(), this.options.toolbar.showSendEmailButton && this.options.email.showEmailDialog && this.options.toolbar.visible && this.InitializeSendEmailForm(), this.addHoverEventsToMenus();
    var o = this;
...
StiJsViewer.prototype.ShowAnimationVerticalMenu = function (A, e, t) {
    ...
    var i = new Date, s = i.getTime(), n = Math.round((e - o) / ((Math.abs(t - s) + 1) / 30));
    Math.abs(n) > Math.abs(e - o) && (n = e - o), o += n;
    var a;
    s < t ? (a = o, A.animationTimer = setTimeout(function () {
        A.jsObject.ShowAnimationVerticalMenu(A, e, t)
    }, 30)) : (a = e, A.style.overflow = "visible", A.animationTimer = null), A.innerContent.style.top = a + "px"
}, StiJsViewer.prototype.ShowAnimationForm = function (A, e) {
    A.flag || (A.currentOpacity = 1, A.flag = !0), clearTimeout(A.animationTimer);
    var t = new Date, o = t.getTime(), i = Math.round((100 - A.currentOpacity) / ((Math.abs(e - o) + 1) / 30));
    Math.abs(i) > Math.abs(100 - A.currentOpacity) && (i = 100 - A.currentOpacity), A.currentOpacity = A.currentOpacity + i;
    var s;
    o < e ? (s = A.currentOpacity, A.animationTimer = setTimeout(function () {
    ...
    if (!A)return;
    var i = 0;
    A.jsObject.options.appearance.scrollbarsMode ? i = A.scrollTop : (i = document.documentElement.scrollTop, 0 == i && (i = document.getElementsByTagName("BODY")[0].scrollTop)), clearTimeout(A.animationTimer);
    var s = new Date, n = s.getTime(), a = Math.round((e - i) / ((Math.abs(t - n) + 1) / 30));
    Math.abs(a) > Math.abs(e - i) && (a = e - i), i += a;
    var r, l = this;
    n < t ? (r = i, A.animationTimer = setTimeout(function () {
        l.ShowAnimationForScroll(A, e, t, o)
    }, 30)) : (r = e, o && o()), A.jsObject.options.appearance.scrollbarsMode ? A.scrollTop = r : window.scrollTo(0, r)
    ...
    for (var t in window.this_.options.animations) {
        var o = window.this_.options.animations[t], i = o.el;
        if (o.duration <= e - o.start) {
            for (var s in o.animations) {
                var n = o.animations[s];
                i.style[n.style] = parseFloat(n.end) + n.postfix
            }
            n.finish && n.finish(), window.this_.options.animations.splice(t, 1)
        } else for (var t in o.animations) {
            var n = o.animations[t];
            i.style[n.style] = parseFloat(n.start) + window.this_.easeInOutQuad((e - parseFloat(o.start)) / o.duration) * (parseFloat(n.end) - parseFloat(n.start)) + n.postfix, console.log(i.style[n.style])
        }
    }
    ...
    var t = "";
    for (var o in e.animations)t += ("" != t ? ", " : "") + (e.animations[o].property || e.animations[o].style);
    ...
    for (var A = this.controls.reportPanel.pages, e = 0; e < A.length; e++) {
        var t = A[e], o = t.getElementsByTagName("*");
        for (k = 0; k < o.length; k++) {
            var i = o[k].getAttribute("editable");
            if (i) {
                var s = i.split(";"), n = {};
                n.compIndex = s[0], n.pageIndex = e.toString(), n.type = s[1], "CheckBox" == n.type ? this.ShowCheckBoxEditableField(o[k], n, s) : "Text" == n.type ? this.ShowTextEditableField(o[k], n) : "RichText" == n.type && this.ShowRichTextEditableField(o[k], n)
            }
        }
    }
    ...
    for (var e = 0; e < A.length; e++)A[e].className = A[e].className.replace(" stiEditableField stiEditableFieldSelected", ""), A[e].onclick = null, A[e].style.outline = ""
    ...
    var s = this.GetSvgCheckBox(t[3], t[5], this.StrToInt(t[6]), t[7], A.sizes.inPixels), n = this.GetSvgCheckBox(t[4], t[5], this.StrToInt(t[6]), t[7], A.sizes.inPixels);
    e.falseImage = "<div style='width:" + A.sizes.widthStyle + ";height:" + A.sizes.heightStyle + ";'>" + s + "</div>", e.trueImage = "<div style='width:" + A.sizes.widthStyle + ";height:" + A.sizes.heightStyle + ";'>" + n + "</div>", e.checked = "true" == t[2] || "True" == t[2], A.params = e, A.jsObject = this, A.hasChanged || (A.checked = e.checked, A.innerHTML = e.checked ? e.trueImage : e.falseImage), A.onclick = function () {
        this.checked = !this.checked, this.innerHTML = this.checked ? e.trueImage : e.falseImage, this.hasChanged = !0, this.jsObject.AddEditableParameters(this)
    }, this.options.editableFields.push(A)
}, StiJsViewer.prototype.ShowTextEditableField = function (A, e) {
    A.className += " stiEditableField stiEditableFieldSelected", "Google Chrome" != this.getNavigatorName() && (A.style.outline = "1px solid gray"), A.params = e, A.jsObject = this, A.onclick = function () {
        ...
        e.jsObject = this.jsObject, e.style.width = this.offsetWidth - 5 + "px", e.style.height = this.offsetHeight - 5 + "px", e.style.maxWidth = this.offsetWidth - 5 + "px", e.style.maxHeight = this.offsetHeight - 5 + "px", e.className = this.className.replace(" stiEditableField stiEditableFieldSelected", "") + " stiEditableTextArea", e.style.border = "0px", e.value = this.innerHTML, this.appendChild(e), e.focus(), this.jsObject.options.currentEditableTextArea = e, e.onblur = function () {
    ...
    var e = {};
    e.type = A.params.type, "CheckBox" == e.type && (e.checked = A.checked), "Text" == e.type && (e.text = A.innerHTML), this.reportParams.editableParameters[A.params.pageIndex] || (this.reportParams.editableParameters[A.params.pageIndex] = {}), this.reportParams.editableParameters[A.params.pageIndex][A.params.compIndex] = e
}, StiJsViewer.prototype.GetSvgCheckBox = function (A, e, t, o, i) {
    var s = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="' + i + 'px" height="' + i + 'px">', n = '<path stroke="' + e + '" stroke-width="' + t + '" fill="' + o + '" stroke-linecap="round" stroke-linejoin="round" transform="scale(' + 1 / (200 / i) + ')" d="', a = "";
    switch (A) {
        case"Cross":
    ...
    if (A.offsetParent)while (A.className != e) {
        if (o += A.offsetLeft,
                !A.offsetParent)break;
        A = A.offsetParent
    } else A.x && (o += A.x);
    return o
    ...
    var t = 0;
    if (A.parentElement)while (A.className != e) {
        if ("scrollLeft" in A && (t -= A.scrollLeft), !A.parentElement)break;
        A = A.parentElement
    }
    return t
    ...
    var t = 0;
    if (A.parentElement)while (A.className != e) {
        if ("scrollTop" in A && (t -= A.scrollTop), !A.parentElement)break;
        A = A.parentElement
    }
    return t
}, StiJsViewer.prototype.scrollToAnchor = function (A) {
    for (var e = 0; e < document.anchors.length; e++)if (document.anchors[e].name == A) {
        var t = document.anchors[e], o = t.parentElement || t, i = this.FindPosY(t, this.options.appearance.scrollbarsMode ? "stiJsViewerReportPanel" : null, !0) - 2 * o.offsetHeight, s = new Date, n = s.getTime() + this.options.scrollDuration, a = this;
        this.ShowAnimationForScroll(this.controls.reportPanel, i, n, function () {
            var A = a.getPageFromAnchorElement(t), e = a.FindPosY(o, "stiJsViewerReportPanel", !0), i = A ? a.FindPosY(A, "stiJsViewerReportPanel", !0) : e, s = document.createElement("div");
            a.controls.bookmarksLabel = s, s.className = "stiJsViewerBookmarksLabel";
            var n = 20 * (a.reportParams.zoom / 100), r = A ? A.offsetWidth - n - 6 : o.offsetWidth, l = o.offsetHeight - 3;
            s.style.width = r + "px", s.style.height = l + "px";
            var c = A.margins ? a.StrToInt(A.margins[3]) : 0;
            s.style.marginLeft = n / 2 - c + "px";
            var h = A.margins ? a.StrToInt(A.margins[0]) : 0;
            s.style.marginTop = e - i - h - a.reportParams.zoom / 100 + "px", A.insertBefore(s, A.childNodes[0])
        });
        break
    }
}, StiJsViewer.prototype.isWholeWord = function (A, e) {
    var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890", o = A.indexOf(e), i = A.substring(o - 1, o), s = A.substring(o + e.length, o + e.length + 1);
    return !("" != i && t.indexOf(i) != -1 || "" != s && t.indexOf(s) != -1)
}, StiJsViewer.prototype.goToFindedElement = function (A) {
    if (A && A.ownerElement) {
        var e = this.FindPosY(A.ownerElement, this.options.appearance.scrollbarsMode ? "stiJsViewerReportPanel" : null, !0) - A.ownerElement.offsetHeight - 50, t = new Date, o = t.getTime() + this.options.scrollDuration, i = this;
    ...
    for (var e = this.controls.findPanel && this.controls.findPanel.controls.matchCase.isSelected, t = this.controls.findPanel && this.controls.findPanel.controls.matchWholeWord.isSelected, o = this.controls.reportPanel.pages, i = 0; i < o.length; i++) {
        var s = o[i], n = s.getElementsByTagName("*");
        for (k = 0; k < n.length; k++) {
            var a = n[k].innerHTML;
            if (a && 1 == n[k].childNodes.length && "#text" == n[k].childNodes[0].nodeName && (e || (a = a.toLowerCase(), A = A.toLowerCase()), a.indexOf(A) >= 0)) {
                if (t && !this.isWholeWord(a, A))continue;
    ...
    for (var t = 0, o = 0; o < e.length; o++)if (e[o].isSelected) {
        e[o].setSelected(!1), t = o;
        break
    }
    "Next" == A ? (t++, t > e.length - 1 && (t = 0)) : (t--, t < 0 && (t = e.length - 1)), e[t].setSelected(!0), this.goToFindedElement(e[t])
}, StiJsViewer.prototype.scrollToPage = function (A) {
    var e = 0;
    for (i = 0; i < A; i++)e += this.controls.reportPanel.pages[i].offsetHeight + 20;
    this.options.appearance.scrollbarsMode || (e += this.FindPosY(this.controls.reportPanel, null, !0));
    var t = new Date, o = t.getTime() + this.options.scrollDuration;
    ...
    while (e.parentElement) {
        if (e.className && 0 == e.className.indexOf("stiJsViewerPage"))return e;
        e = e.parentElement
    }
    return e
}, StiJsViewer.prototype.isContainted = function (A, e) {
    for (var t in A)if (e == A[t])return !0;
    return !1
    ...
    for (var e = 0; e < zoomValues.length; e++)if (zoomValues[e] == this.reportParams.zoom)break;
    A && e < zoomValues.length - 1 && this.postAction("Zoom" + zoomValues[e + 1]), !A && e > 0 && this.postAction("Zoom" + zoomValues[e - 1])
    ...
    return function (e, t) {
        var o = A, i = [], s = Math.random;
        if (t = t || o.length, e)for (var n = 0; n < e; n++)i[n] = o[0 | s() * t]; else {
            var a;
    ...
    var i = {name: A, caption: e, imageName: t, key: o};
    return i
    ...
    var t = A.getFullYear(), o = t.toString().substring(2), i = A.getMonth() + 1, s = i < 10 ? "0" + i : i, n = A.getDate(), a = n < 10 ? "0" + n : n, r = A.getHours(), l = r < 10 ? "0" + r : r, c = A.getMinutes(), h = c < 10 ? "0" + c : c, p = A.getSeconds(), g = p < 10 ? "0" + p : p;
    return e = e.replace(/yyyy/i, t), e = e.replace(/yy/i, o), e = e.replace(/mm/i, s), e = e.replace(/m/i, i), e = e.replace(/dd/i, a), e = e.replace(/d/i, n), e = e.replace(/hh/i, l), e = e.replace(/h/i, r), e = e.replace(/nn/i, h), e = e.replace(/n/i, c), e = e.replace(/ss/i, g), e = e.replace(/s/i, p)
}, StiJsViewer.prototype.stringToTime = function (A) {
    var e = A.split(":"), t = {hours: 0, minutes: 0, seconds: 0};
    return t.hours = this.StrToInt(e[0]), e.length > 1 && (t.minutes = this.StrToInt(e[1])), e.length > 2 && (t.seconds = this.StrToInt(e[2])), t.hours < 0 && (t.hours = 0), t.minutes < 0 && (t.minutes = 0), t.seconds < 0 && (t.seconds = 0), t.hours > 23 && (t.hours = 23), t.minutes > 59 && (t.minutes = 59), t.seconds > 59 && (t.seconds = 59), t
    ...
    if ("" != this.options.appearance.parametersPanelDateFormat)return this.formatDate(t, this.options.appearance.parametersPanelDateFormat);
    ...
    for (t in A)A.hasOwnProperty(t) && (o = A[t], o && "object" == typeof o ? e[t] = this.copyObject(o) : e[t] = o);
    return e
}, StiJsViewer.prototype.getNavigatorName = function () {
    var A = navigator.userAgent, e = "Unknown";
    return A.indexOf("MSIE") != -1 ? e = "MSIE" : A.indexOf("Gecko") != -1 ? e = A.indexOf("Chrome") != -1 ? "Google Chrome" : "Mozilla" : A.indexOf("Mozilla") != -1 ? e = "old Netscape or Mozilla" : A.indexOf("Opera") != -1 && (e = "Opera"), e
    ...
    var t = this.controls.viewer.offsetWidth / 2 - A.offsetWidth / 2, o = this.options.appearance.fullScreenMode ? this.controls.viewer.offsetHeight / 2 - A.offsetHeight / 2 : e ? e : 250;
    A.style.left = t > 0 ? t + "px" : 0, A.style.top = o > 0 ? o + "px" : 0
}, StiJsViewer.prototype.strToInt = function (A) {
    var e = parseInt(A);
    if (e)return e;
    return 0
    ...
    this.options.appearance.scrollbarsMode = A || this.options.appearance.userScrollbarsMode, this.options.appearance.fullScreenMode = A, this.options.toolbar.visible && this.options.toolbar.showFullScreenButton && this.controls.toolbar.controls.FullScreen.setSelected(A), A ? (this.controls.viewer.style.zIndex = "1000000", this.controls.viewer.style.position = "absolute", this.controls.viewer.style.width && (this.controls.viewer.style.userWidth = this.controls.viewer.style.width, this.controls.viewer.style.width = null), this.controls.viewer.style.height && (this.controls.viewer.style.userHeight = this.controls.viewer.style.height, this.controls.viewer.style.height = null), this.controls.reportPanel.style.position = "absolute", this.controls.reportPanel.style.top = this.options.toolbar.visible ? this.controls.toolbar.offsetHeight + "px" : 0, document.body.prevOverflow = document.body.style.overflow, document.body.style.overflow = "hidden") : (this.controls.viewer.style.zIndex = "auto", this.controls.viewer.style.position = "", this.controls.viewer.style.userWidth && (this.controls.viewer.style.width = this.controls.viewer.style.userWidth), this.controls.viewer.style.userHeight && (this.controls.viewer.style.height = this.controls.viewer.style.userHeight), this.controls.reportPanel.style.position = "Percentage" != this.options.viewerHeightType || this.options.appearance.scrollbarsMode ? "absolute" : "relative", this.controls.reportPanel.style.top = this.options.toolbar.visible && ("Percentage" != this.options.viewerHeightType || this.options.appearance.scrollbarsMode) ? this.controls.toolbar.offsetHeight + "px" : 0, "undefined" != typeof document.body.prevOverflow && (document.body.style.overflow = document.body.prevOverflow, delete document.body.prevOverflow)), this.controls.reportPanel.style.overflow = this.options.appearance.scrollbarsMode ? "auto" : "hidden"
    ...
    if ("Hover" == this.options.toolbar.showMenuMode)for (var A = ["Print", "Save", "SendEmail", "Zoom", "ViewMode"], e = 0; e < A.length; e++) {
        var t = this.controls.toolbar.controls[A[e]];
        if (t) {
            var o = this.controls.menus[this.lowerFirstChar(t.name) + "Menu"];
            o && (o.buttonName = t.name, o.onmouseover = function () {
    ...
    var t = A.toLocaleTimeString(), o = t.toLowerCase().indexOf("am") >= 0 || t.toLowerCase().indexOf("pm") >= 0, i = o ? "MM/dd/yyyy" : "dd.MM.yyyy", s = A.getFullYear(), n = s.toString().substring(2), a = A.getMonth() + 1, r = a < 10 ? "0" + a : a, l = A.getDate(), c = l < 10 ? "0" + l : l;
    if (i = i.replace(/yyyy/i, s), i = i.replace(/yy/i, n), i = i.replace(/MM/i, r), i = i.replace(/M/i, a), i = i.replace(/dd/i, c), i = i.replace(/d/i, l), "Time" == e)return t;
    if ("Date" == e)return i;
    return i + " " + t
}, StiJsViewer.prototype.UpdateAllHyperLinks = function () {
    if ("WholeReport" == this.reportParams.viewMode)return;
    var aHyperlinks = this.controls.reportPanel.getElementsByTagName("a");
    if (this.controls.bookmarksPanel)for (var aBookmarks = this.controls.bookmarksPanel.getElementsByTagName("a"), i = 0; i < aHyperlinks.length; i++)aHyperlinks[i].getAttribute("href") && (aHyperlinks[i].anchorName = aHyperlinks[i].getAttribute("href").replace("#", ""), aHyperlinks[i].onclick = function () {
    ...
    for (var A = [], e = [.25, .5, .75, 1, 1.25, 1.5, 2], t = 0; t < e.length; t++)A.push(this.Item("item" + t, 100 * e[t] + "%", null, e[t].toString()));
    return A
    ...
    for (var A = [], e = ["10", "25", "50", "75", "100", "200", "300", "400", "500"], t = 0; t < e.length; t++)A.push(this.Item("item" + t, e[t], null, e[t]));
    return A
    ...
    for (var A = [], e = [.25, .5, .75, .85, .9, .95, 1], t = 0; t < e.length; t++)A.push(this.Item("item" + t, 100 * e[t] + "%", null, e[t].toString()));
    return A
    ...
    var e = [];
    return e.push(this.Item("item0", this.collections.loc.ImageFormatColor, null, "Color")), e.push(this.Item("item1", this.collections.loc.ImageFormatGrayscale, null, "Grayscale")), A || e.push(this.Item("item2", this.collections.loc.ImageFormatMonochrome, null, "Monochrome")), e
...
StiJsViewer.prototype.InitializeAboutPanel = function () {
    ...
    this.controls.aboutPanel = A, this.controls.mainPanel.appendChild(A), A.jsObject = this, A.className = "stiJsViewerAboutPanel", A.style.background = "white url(" + this.collections.images["AboutInfo.png"] + ")", A.style.display = "none";
    var e = document.createElement("div");
    e.innerHTML = this.collections.loc.Version + ": " + this.options.productVersion, A.appendChild(e), e.style.fontFamily = "Arial", e.style.fontSize = "10pt", e.style.color = "#000000", e.style.padding = "60px 20px 5px 25px";
    var t = document.createElement("div");
    t.innerHTML = "Copyright 2003-" + (new Date).getFullYear() + " by Stimulsoft, All rights reserved.", A.appendChild(t), t.style.fontFamily = "Arial", t.style.fontSize = "10pt", t.style.color = "#000000", t.style.padding = "118px 20px 0px 25px", A.ontouchstart = function () {
    ...
    var createAndShow = !0;
    if (this.controls.bookmarksPanel && (this.controls.bookmarksPanel.visible || (createAndShow = !1), this.controls.bookmarksPanel.changeVisibleState(!1), this.controls.mainPanel.removeChild(this.controls.bookmarksPanel), delete this.controls.bookmarksPanel), this.options.toolbar.visible && this.options.toolbar.showBookmarksButton && this.controls.toolbar.controls.Bookmarks.setEnabled(null != this.reportParams.bookmarksContent), !this.reportParams.bookmarksContent)return;
    var bookmarksPanel = document.createElement("div");
    this.controls.mainPanel.appendChild(bookmarksPanel), this.controls.bookmarksPanel = bookmarksPanel, bookmarksPanel.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (bookmarksPanel.style.color = this.options.toolbar.fontColor), bookmarksPanel.jsObject = this, bookmarksPanel.id = this.controls.viewer.id + "_BookmarksPanel", bookmarksPanel.className = "stiJsViewerBookmarksPanel", bookmarksPanel.style.display = "none", bookmarksPanel.visible = !1, bookmarksPanel.style.width = this.options.appearance.bookmarksTreeWidth - 1 + "px", bookmarksPanel.style.top = (this.options.toolbar.visible ? this.controls.toolbar.offsetHeight + 2 : 2) + (this.controls.parametersPanel ? this.controls.parametersPanel.offsetHeight - 2 : 0) + (this.controls.findPanel ? this.controls.findPanel.offsetHeight : 0) + this.controls.drillDownPanel.offsetHeight + "px", bookmarksPanel.style.bottom = "2px", bookmarksPanel.container = document.createElement("div"), bookmarksPanel.container.className = "stiJsViewerBookmarksContainer", "" != this.options.toolbar.backgroundColor && (bookmarksPanel.container.style.background = this.options.toolbar.backgroundColor), "" != this.options.toolbar.borderColor && (bookmarksPanel.container.style.border = "1px solid " + this.options.toolbar.borderColor), bookmarksPanel.appendChild(bookmarksPanel.container), bookmarksPanel.changeVisibleState = function (A) {
        var e = this.jsObject.options;
        this.style.display = A ? "" : "none", this.visible = A, e.toolbar.visible && e.toolbar.showBookmarksButton && this.jsObject.controls.toolbar.controls.Bookmarks.setSelected(A), this.jsObject.controls.reportPanel.style.marginLeft = A ? this.jsObject.options.appearance.bookmarksTreeWidth + 2 + "px" : 0
    }, bookmarksPanel.addContent = function (A) {
        this.container.innerHTML = A
    };
    var imagesForBookmarks = this.GetImagesForBookmarks(), bookmarksContent = this.reportParams.bookmarksContent.replace("imagesForBookmarks", imagesForBookmarks);
    ...
    for (var A = ["root", "folder", "folderOpen", "node", "empty", "line", "join", "joinBottom", "plus", "plusBottom", "minus", "minusBottom"], e = {}, t = 0; t < A.length; t++)e[A[t]] = this.collections.images["Bookmarks" + A[t] + ".png"];
    ...
    var e = "", t = 0;
    for (this.config.inOrder && (t = A._ai), t; t < this.aNodes.length; t++)if (this.aNodes[t].pid == A.id) {
        var o = this.aNodes[t];
        if (o._p = A, o._ai = t, this.setCS(o), !o.target && this.config.target && (o.target = this.config.target), o._hc && !o._io && this.config.useCookies && (o._io = this.isOpen(o.id)), !this.config.folderLinks && o._hc && (o.url = null), this.config.useSelection && o.id == this.selectedNode && !this.selectedFound && (o._is = !0, this.selectedNode = t, this.selectedFound = !0), e += this.node(o, t), o._ls)break
    }
    return e
}, stiTree.prototype.node = function (A, e) {
    var t = '<div class="stiTreeNode">' + this.indent(A, e);
    if (this.config.useIcons && (A.icon || (A.icon = this.root.id == A.pid ? this.icon.root : A._hc ? this.icon.folder : this.icon.node), A.iconOpen || (A.iconOpen = A._hc ? this.icon.folderOpen : this.icon.node), this.root.id == A.pid && (A.icon = this.icon.root, A.iconOpen = this.icon.root), t += '<img id="i' + this.obj + e + '" src="' + (A._io ? A.iconOpen : A.icon) + '" alt="" />'), A.url) {
        t += '<a id="s' + this.obj + e + '" class="' + (this.config.useSelection && A._is ? "nodeSel" : "node") + '"', A.target && (t += ' target="' + A.target + '"'), this.config.useStatusText && (t += " onmouseover=\"window.status='" + A.name + "';return true;\" onmouseout=\"window.status='';return true;\" ");
        var o = "";
        this.config.useSelection && (A._hc && this.config.folderLinks || !A._hc) && (o += this.obj + ".s(" + e + ");"), null != A.page && (o += "document.getElementById('" + this.mobileViewerId + "').jsObject.postAction('BookmarkAction'," + A.page + ",'" + A.url.substr(1) + "');"), o.length > 0 && A.page >= 0 && (t += ' onclick="' + o + '"'), t += ">"
    } else this.config.folderLinks && A.url || !A._hc || A.pid == this.root.id || (t += '<a href="javascript: ' + this.obj + ".o(" + e + ');" class="node">');
    return t += A.name, !A.url && (this.config.folderLinks && A.url || !A._hc) || (t += "</a>"), t += "</div>", A._hc && (t += '<div id="d' + this.obj + e + '" class="clip" style="display:' + (this.root.id == A.pid || A._io ? "block" : "none") + ';">', t += this.addNode(A), t += "</div>"), this.aIndent.pop(), t
}, stiTree.prototype.indent = function (A, e) {
    var t = "";
    if (this.root.id != A.pid) {
        for (var o = 0; o < this.aIndent.length; o++)t += '<img src="' + (1 == this.aIndent[o] && this.config.useLines ? this.icon.line : this.icon.empty) + '" alt="" />';
        A._ls ? this.aIndent.push(0) : this.aIndent.push(1), A._hc ? (t += '<a href="javascript: ' + this.obj + ".o(" + e + ');"><img id="j' + this.obj + e + '" src="', t += this.config.useLines ? A._io ? A._ls && this.config.useLines ? this.icon.minusBottom : this.icon.minus : A._ls && this.config.useLines ? this.icon.plusBottom : this.icon.plus : A._io ? this.icon.nlMinus : this.icon.nlPlus, t += '" alt="" /></a>') : t += '<img src="' + (this.config.useLines ? A._ls ? this.icon.joinBottom : this.icon.join : this.icon.empty) + '" alt="" />'
    }
    return t
}, stiTree.prototype.setCS = function (A) {
    for (var e, t = 0; t < this.aNodes.length; t++)this.aNodes[t].pid == A.id && (A._hc = !0), this.aNodes[t].pid == A.pid && (e = this.aNodes[t].id);
    e == A.id && (A._ls = !0)
    ...
    var e = this.aNodes[A];
    if (e._hc && !this.config.folderLinks)return;
    this.selectedNode != A && ((this.selectedNode || 0 == this.selectedNode) && (eOld = document.getElementById("s" + this.obj + this.selectedNode), eOld.className = "node"), eNew = document.getElementById("s" + this.obj + A), eNew.className = "nodeSel", this.selectedNode = A, this.config.useCookies && this.setCookie("cs" + this.obj, e.id))
}, stiTree.prototype.o = function (A) {
    var e = this.aNodes[A];
    this.nodeStatus(!e._io, A, e._ls), e._io = !e._io, this.config.closeSameLevel && this.closeLevel(e), this.config.useCookies && this.updateCookie()
}, stiTree.prototype.oAll = function (A) {
    for (var e = 0; e < this.aNodes.length; e++)this.aNodes[e]._hc && this.aNodes[e].pid != this.root.id && (this.nodeStatus(A, e, this.aNodes[e]._ls), this.aNodes[e]._io = A);
    this.config.useCookies && this.updateCookie()
}, stiTree.prototype.openTo = function (A, e, t) {
    if (!t)for (var o = 0; o < this.aNodes.length; o++)if (this.aNodes[o].id == A) {
        A = o;
        break
    }
    var i = this.aNodes[A];
    if (i.pid == this.root.id || !i._p)return;
    i._io = !0, i._is = e, this.completed && i._hc && this.nodeStatus(!0, i._ai, i._ls),
        this.completed && e ? this.s(i._ai) : e && (this._sn = i._ai), this.openTo(i._p._ai, !1, !0)
}, stiTree.prototype.closeLevel = function (A) {
    for (var e = 0; e < this.aNodes.length; e++)this.aNodes[e].pid == A.pid && this.aNodes[e].id != A.id && this.aNodes[e]._hc && (this.nodeStatus(!1, e, this.aNodes[e]._ls), this.aNodes[e]._io = !1, this.closeAllChildren(this.aNodes[e]))
}, stiTree.prototype.closeAllChildren = function (A) {
    for (var e = 0; e < this.aNodes.length; e++)this.aNodes[e].pid == A.id && this.aNodes[e]._hc && (this.aNodes[e]._io && this.nodeStatus(!1, e, this.aNodes[e]._ls), this.aNodes[e]._io = !1, this.closeAllChildren(this.aNodes[e]))
}, stiTree.prototype.nodeStatus = function (A, e, t) {
    eDiv = document.getElementById("d" + this.obj + e), eJoin = document.getElementById("j" + this.obj + e), this.config.useIcons && (eIcon = document.getElementById("i" + this.obj + e), eIcon.src = A ? this.aNodes[e].iconOpen : this.aNodes[e].icon), eJoin.src = this.config.useLines ? A ? t ? this.icon.minusBottom : this.icon.minus : t ? this.icon.plusBottom : this.icon.plus : A ? this.icon.nlMinus : this.icon.nlPlus, eDiv.style.display = A ? "block" : "none"
}, stiTree.prototype.clearCookie = function () {
    var A = new Date, e = new Date(A.getTime() - 1e3 * 60 * 60 * 24);
    ...
    var e = "", t = document.cookie.indexOf(escape(A) + "=");
    if (t != -1) {
        var o = t + (escape(A) + "=").length, i = document.cookie.indexOf(";", o);
        e = i != -1 ? unescape(document.cookie.substring(o, i)) : unescape(document.cookie.substring(o))
    }
    return e
}, stiTree.prototype.updateCookie = function () {
    for (var A = "", e = 0; e < this.aNodes.length; e++)this.aNodes[e]._io && this.aNodes[e].pid != this.root.id && (A && (A += "."), A += this.aNodes[e].id);
    this.setCookie("co" + this.obj, A)
}, stiTree.prototype.isOpen = function (A) {
    for (var e = this.getCookie("co" + this.obj).split("."), t = 0; t < e.length; t++)if (e[t] == A)return !0;
    return !1
    ...
    return n.style.width = "100%", n.style.height = "100%", o.imageBlock.appendChild(n), n.addCell(o.image).style.textAlign = "center", null != e && (o.captionCell = o.addCell(), this.options.isTouchDevice || (o.captionCell.style.padding = "1px 0 0 4px"), o.captionCell.style.whiteSpace = "nowrap", o.captionCell.innerHTML = e), o.onmouseover = function () {
        ...
        this.image.style.visibility = A ? "visible" : "hidden", this.isChecked = A, this.onChecked()
    ...
    e.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (e.style.color = this.options.toolbar.fontColor), e.style.zIndex = "36", e.parentDataControl = null, e.dayButtons = [], e.showTime = !1, e.doubleDatePicker = A, e.key = new Date, A || (this.controls.datePicker = e, this.controls.mainPanel.appendChild(e));
    var t = this.CreateHTMLTable();
    e.innerContent.appendChild(t), e.prevMonthButton = this.SmallButton(null, null, "ArrowLeft.png"), e.prevMonthButton.style.margin = "1px 2px 0 1px", e.prevMonthButton.datePicker = e, e.prevMonthButton.action = function () {
        var A = this.datePicker.key.getMonth(), e = this.datePicker.key.getFullYear();
        A--, A == -1 && (A = 11, e--);
        var t = this.jsObject.GetCountDaysOfMonth(e, A);
        t < this.datePicker.key.getDate() && this.datePicker.key.setDate(t), this.datePicker.key.setMonth(A), this.datePicker.key.setYear(e), this.datePicker.fill(), this.datePicker.action()
    }, t.addCell(e.prevMonthButton), e.monthDropDownList = this.DropDownList(null, this.options.isTouchDevice ? 79 : 81, null, this.GetMonthesForDatePickerItems(), !0), e.monthDropDownList.style.margin = "1px 2px 0 0", e.monthDropDownList.datePicker = e, e.monthDropDownList.action = function () {
    ...
    }, t.addCell(e.monthDropDownList), e.monthDropDownList.menu.style.zIndex = "37", e.monthDropDownList.menu.datePicker = e, e.monthDropDownList.menu.onmousedown = function () {
    ...
    }, e.yearTextBox = this.TextBox(null, 40, "Year"), e.yearTextBox.style.margin = "1px 2px 0 0", e.yearTextBox.datePicker = e, e.yearTextBox.action = function () {
    ...
    }, t.addCell(e.yearTextBox), e.nextMonthButton = this.SmallButton(null, null, "ArrowRight.png"), e.nextMonthButton.datePicker = e, e.nextMonthButton.style.margin = "1px 1px 0 0", e.nextMonthButton.action = function () {
        var A = this.datePicker.key.getMonth(), e = this.datePicker.key.getFullYear();
        A++, 12 == A && (A = 0, e++);
        var t = this.jsObject.GetCountDaysOfMonth(e, A);
        t < this.datePicker.key.getDate() && this.datePicker.key.setDate(t), this.datePicker.key.setMonth(A), this.datePicker.key.setYear(e), this.datePicker.fill(), this.datePicker.action()
    ...
    o.style.margin = "2px 0 2px 0", o.className = "stiJsViewerDatePickerSeparator", e.innerContent.appendChild(o), e.daysTable = this.CreateHTMLTable(), e.innerContent.appendChild(e.daysTable), "Sunday" == this.options.appearance.datePickerFirstDayOfWeek && (this.collections.dayOfWeek.splice(6, 1), this.collections.dayOfWeek.splice(0, 0, "Sunday"));
    for (var i = 0; i < 7; i++) {
    ...
    for (var a = 1, i = 0; i < 42; i++) {
        ...
        r.datePicker = e, r.style.margin = "1px", e.dayButtons.push(r), e.daysTable.addCellInRow(a, r), (i + 1) % 7 == 0 && (e.daysTable.addRow(), a++)
    }
    var l = document.createElement("div");
    l.style.margin = "2px 0 2px 0", l.className = "stiJsViewerDatePickerSeparator", e.innerContent.appendChild(l);
    var c = this.CreateHTMLTable();
    c.style.width = "100%", e.innerContent.appendChild(c), c.addTextCell(this.collections.loc.Time + ":").style.padding = "0 4px 0 4px";
    var h = this.TextBox(null, 90);
    h.style.margin = "1px 2px 2px 2px";
    var p = c.addCell(h);
    return p.style.width = "100%", p.style.textAlign = "right", e.time = h, h.action = function () {
        var A = this.jsObject.stringToTime(this.value);
        e.key.setHours(A.hours), e.key.setMinutes(A.minutes), e.key.setSeconds(A.seconds), this.value = this.jsObject.formatDate(e.key, "h:nn:ss"), e.action()
    }, e.repaintDays = function () {
        var A = this.key.getMonth(), e = this.key.getFullYear(), t = this.jsObject.GetCountDaysOfMonth(e, A), o = this.jsObject.GetDayOfWeek(e, A, 1);
        ...
        for (var i = 0; i < 42; i++) {
            var s = i - o + 1, n = s == this.key.getDate(), a = this.dayButtons[i];
            i < o || i - o > t - 1 ? (a.caption.innerHTML = "", a.setEnabled(!1)) : (a.numberOfDay = s, a.caption.innerHTML = s, a.setEnabled(!0), a.setSelected(n))
        }
    }, e.fill = function () {
        this.yearTextBox.value = this.key.getFullYear(), this.monthDropDownList.setKey(this.key.getMonth()), this.repaintDays(), this.showTime && (this.time.value = this.jsObject.formatDate(this.key, "h:nn:ss"))
    }, e.onshow = function () {
        this.key = new Date, this.ownerValue && (this.key = new Date(this.ownerValue.year, this.ownerValue.month - 1, this.ownerValue.day, this.ownerValue.hours, this.ownerValue.minutes, this.ownerValue.seconds)), l.style.display = this.showTime ? "" : "none", c.style.display = this.showTime ? "" : "none", this.fill()
    }, e.action = function () {
        this.ownerValue || (this.ownerValue = this.jsObject.getNowDateTimeObject()), this.ownerValue.year = this.key.getFullYear(), this.ownerValue.month = this.key.getMonth() + 1, this.ownerValue.day = this.key.getDate(), this.ownerValue.hours = this.key.getHours(), this.ownerValue.minutes = this.key.getMinutes(), this.ownerValue.seconds = this.key.getSeconds(), this.parentDataControl && (this.parentDataControl.value = this.jsObject.dateTimeObjectToString(e.ownerValue, this.parentDataControl.parameter.params.dateTimeType))
        ...
        if (A) {
            this.onshow(), this.style.display = "", this.visible = !0, this.style.overflow = "hidden", this.parentDataControl.setSelected(!0), this.parentButton.setSelected(!0), this.jsObject.options.currentDatePicker = this, this.style.width = this.innerContent.offsetWidth + "px", this.style.height = this.innerContent.offsetHeight + "px", this.style.left = this.jsObject.FindPosX(this.parentButton, e) + "px", this.style.top = this.jsObject.FindPosY(this.parentButton, e) + this.parentButton.offsetHeight + 1 + "px", this.innerContent.style.top = -this.innerContent.offsetHeight + "px";
            var t = new Date, o = t.getTime();
    ...
    var A = this.SmallButton(null, "0", null, null, null, "stiJsViewerDatePickerDayButton"), e = this.options.isTouchDevice ? "25px" : "23px";
    return A.style.width = e, A.style.height = e, A.caption.style.textAlign = "center", A.innerTable.style.width = "100%", A.caption.style.padding = "0px", A.numberOfDay = 1, A.action = function () {
    ...
    var t = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], o = t[e];
    return 1 == e && (o = A % 4 != 0 || A % 100 == 0 && A % 400 != 0 ? 28 : 29), o
}, StiJsViewer.prototype.GetMonthesForDatePickerItems = function () {
    for (var A = [], e = 0; e < this.collections.months.length; e++)A.push(this.Item("Month" + e, this.collections.loc["Month" + this.collections.months[e]], null, e));
    return A
}, StiJsViewer.prototype.GetDayOfWeekItems = function () {
    for (var A = [], e = 0; e < this.collections.dayOfWeek.length; e++)A.push(this.Item("DayOfWeekItem" + e, this.collections.loc["Day" + this.collections.dayOfWeek[e]], null, this.collections.dayOfWeek[e]));
    return A
}, StiJsViewer.prototype.GetFirstDayOfWeek = function () {
    var A = new Date, e = A.toLocaleTimeString();
    ...
    for (var A = 1; A < 5; A++) {
        var e = document.createElement("div");
        e.jsObject = this, e.style.display = "none", this.controls.mainPanel.appendChild(e), this.controls.disabledPanels[A] = e, e.style.zIndex = 10 * A, e.className = "stiJsViewerDisabledPanel", e.changeVisibleState = function (A) {
            this.style.display = A ? "" : "none"
        }, e.onmousedown = function () {
            this.isTouchStartFlag || e.ontouchstart(!0)
        }, e.ontouchstart = function (A) {
            var t = this;
            this.isTouchStartFlag = !A, clearTimeout(this.isTouchStartTimer), e.jsObject.options.disabledPanelPressed = !0, this.isTouchStartTimer = setTimeout(function () {
    ...
    var A = document.createElement("div");
    this.controls.drillDownPanel = A, this.controls.mainPanel.appendChild(A), A.jsObject = this, A.className = "stiJsViewerToolBar", A.style.display = "none";
    var e = document.createElement("div");
    A.appendChild(e), e.style.padding = "0 2px 2px 2px";
    var t = this.CreateHTMLTable();
    t.className = "stiJsViewerToolBarTable", e.appendChild(t), t.style.margin = "0px", "" != this.options.toolbar.fontColor && (t.style.color = this.options.toolbar.fontColor), t.style.fontFamily = this.options.toolbar.fontFamily;
    var o = this.CreateHTMLTable();
    return t.addCell(o), A.buttonsRow = o.rows[0], A.buttons = {}, A.selectedButton = null, A.changeVisibleState = function (A) {
        this.style.display = A ? "" : "none";
        var e = this.offsetHeight, t = this.jsObject.controls.parametersPanel ? this.jsObject.controls.parametersPanel.offsetHeight : 0, o = this.jsObject.options.toolbar.visible ? this.jsObject.controls.toolbar.offsetHeight : 0;
        this.jsObject.controls.parametersPanel && (this.jsObject.controls.parametersPanel.style.top = o + e + "px"), this.jsObject.controls.bookmarksPanel && (this.jsObject.controls.bookmarksPanel.style.top = o + t + e + "px"), this.jsObject.controls.reportPanel.style.marginTop = ("relative" == this.jsObject.controls.reportPanel.style.position ? t : e + t) + "px"
    }, A.addButton = function (e, t) {
        var i = "button" + (A.buttonsRow.children.length + 1), s = A.jsObject.SmallButton(i, e);
        s.style.display = "inline-block", s.reportParams = t ? t : this.reportParams = {}, A.buttons[i] = s, s.style.margin = "2px 1px 2px 2px";
        var n = o.addCell(s);
        if (n.style.padding = "0px", n.style.border = "0px", n.style.lineHeight = "0px", s.select = function () {
                A.selectedButton && A.selectedButton.setSelected(!1), this.setSelected(!0), A.selectedButton = this, A.jsObject.reportParams = this.reportParams
            }, s.action = function () {
    ...
    var n = this.CreateHTMLTable();
    n.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (n.style.color = this.options.toolbar.fontColor), n.jsObject = this, n.name = A, n.key = null, n.imageCell = null, n.readOnly = i, n.items = null == o ? {} : o, n.isEnabled = !0, n.isSelected = !1, n.isOver = !1, n.isFocused = !1, n.fullWidth = e + 3, t && n.setAttribute("title", t);
    ...
    return n.className = "stiJsViewerDropDownList", A && (this.controls.dropDownLists || (this.controls.dropDownLists = {}), this.controls.dropDownLists[A] = n), s && (n.image = document.createElement("div"), n.image.dropDownList = n, n.image.jsObject = this, n.image.className = "stiJsViewerDropDownListImage", n.imageCell.style.lineHeight = "0", n.imageCell = n.addCell(n.image), i && (n.image.onclick = function () {
        ...
        this.key = A;
        for (var e in this.items)if (A == this.items[e].key)return this.textBox.value = this.items[e].caption, void(this.image && (this.image.style.background = "url(" + this.jsObject.collections.images[this.items[e].imageName] + ")"));
        this.textBox.value = A.toString()
    }, n.haveKey = function (A) {
        for (var e in this.items)if (this.items[e].key == A)return !0;
        return !1
    }, n.action = function () {
    }, n
    ...
    return e.dropDownList = A, e.innerContent.style.minWidth = A.fullWidth + "px", e.changeVisibleState = function (A) {
        var e = "stiJsViewerMainPanel";
        if (A) {
            this.onshow(), this.style.display = "", this.visible = !0, this.style.overflow = "hidden", this.parentButton.dropDownList.setSelected(!0), this.parentButton.setSelected(!0), this.jsObject.options.currentDropDownListMenu = this, this.style.width = this.innerContent.offsetWidth + "px", this.style.height = this.innerContent.offsetHeight + "px", this.style.left = this.jsObject.FindPosX(this.parentButton.dropDownList, e) + "px", this.style.top = this.jsObject.FindPosY(this.parentButton.dropDownList, e) + this.parentButton.offsetHeight + 3 + "px", this.innerContent.style.top = -this.innerContent.offsetHeight + "px", d = new Date;
            var t = d.getTime();
            this.jsObject.options.toolbar.menuAnimation && (t += this.jsObject.options.menuAnimDuration), this.jsObject.ShowAnimationVerticalMenu(this, 0, t)
    ...
    var A = document.createElement("div");
    A.style.display = "none", A.controls = {}, this.controls.findPanel = A, this.controls.mainPanel.appendChild(A), A.jsObject = this, A.className = "stiJsViewerToolBar";
    var e = document.createElement("div");
    A.innerContent = e, A.appendChild(e), e.style.padding = "0 3px 3px 3px";
    var t = document.createElement("div");
    e.appendChild(t), t.className = "stiJsViewerToolBarTable";
    var o = this.CreateHTMLTable();
    t.appendChild(o);
    for (var i = [["close", this.SmallButton(null, null, "CloseFindPanel.png", null), "2px"], ["text", this.TextBlock(this.collections.loc.FindWhat), "2px"], ["findTextBox", this.TextBox(null, 170), "2px"], ["findPreviows", this.SmallButton(null, this.collections.loc.FindPrevious, "ArrowUpBlue.png"), "2px"], ["findNext", this.SmallButton(null, this.collections.loc.FindNext, "ArrowDownBlue.png"), "2px"], ["matchCase", this.SmallButton(null, this.collections.loc.MatchCase.replace("&", ""), null), "2px"], ["matchWholeWord", this.SmallButton(null, this.collections.loc.MatchWholeWord.replace("&", ""), null), "2px"]], s = 0; s < i.length; s++)A.controls[i[s][0]] = i[s][1], o.addCell(i[s][1]), i[s][1].style.margin = i[s][2];
    var n = function (e) {
    ...
    A.controls.close.action = function () {
        ...
        var t = this.jsObject.options, o = this.jsObject.controls;
        e || this.jsObject.hideFindLabels(), this.style.display = e ? "" : "none", e && (A.controls.findTextBox.value = "", A.controls.findTextBox.focus()), t.toolbar.showFindButton && o.toolbar.controls.Find.setSelected(e), o.parametersPanel && (o.parametersPanel.style.top = (t.toolbar.visible ? o.toolbar.offsetHeight : 0) + (o.findPanel ? o.findPanel.offsetHeight : 0) + "px"), o.bookmarksPanel && (o.bookmarksPanel.style.top = (t.toolbar.visible ? o.toolbar.offsetHeight : 0) + (o.findPanel ? o.findPanel.offsetHeight : 0) + (o.parametersPanel ? o.parametersPanel.offsetHeight : 0) + "px"), o.reportPanel.style.marginTop = (o.parametersPanel ? o.parametersPanel.offsetHeight : 0) + ("absolute" == o.reportPanel.style.position && o.findPanel ? o.findPanel.offsetHeight : 0) + "px"
    }
    ...
    i.style.fontFamily = this.options.toolbar.fontFamily, i.style.color = this.options.toolbarFontColor, i.jsObject = this, t && (i.style.minWidth = t + "px"), i.style.overflow = "hidden", i.isOpened = e;
    ...
    return o && (n.style.padding = o), n.style.display = e ? "" : "none", n.className = "stiJsViewerGroupPanelContainer", i.container = n, i.appendChild(n), i.changeOpeningState = function (A) {
    ...
    return t.jsObject = this, this.clearStyles(t), t.cellPadding = 0, t.cellSpacing = 0, t.tbody = document.createElement("tbody"), t.appendChild(t.tbody), t.tr = [], t.tr[0] = document.createElement("tr"), this.clearStyles(t.tr[0]), t.tbody.appendChild(t.tr[0]), t.addCell = function (A) {
        var e = document.createElement("td");
        return this.jsObject.clearStyles(e), this.tr[0].appendChild(e), A && e.appendChild(A), e
    }, t.addCellInNextRow = function (A) {
        var e = this.tr.length;
        this.tr[e] = document.createElement("tr"), this.jsObject.clearStyles(this.tr[e]), this.tbody.appendChild(this.tr[e]);
        var t = document.createElement("td");
        return this.jsObject.clearStyles(t), this.tr[e].appendChild(t), A && t.appendChild(A), t
    }, t.addCellInLastRow = function (A) {
        var e = this.tr.length, t = document.createElement("td");
        return this.jsObject.clearStyles(t), this.tr[e - 1].appendChild(t), A && t.appendChild(A), t
    }, t.addTextCellInLastRow = function (A) {
        var e = this.tr.length, t = document.createElement("td");
        return this.jsObject.clearStyles(t), this.tr[e - 1].appendChild(t), t.innerHTML = A, t
    }, t.addCellInRow = function (A, e) {
        var t = document.createElement("td");
        return this.jsObject.clearStyles(t), this.tr[A].appendChild(t), e && t.appendChild(e), t
    }, t.addTextCell = function (A) {
        var e = document.createElement("td");
        return this.jsObject.clearStyles(e), this.tr[0].appendChild(e), e.innerHTML = A, e
    }, t.addRow = function () {
    ...
    var e = document.createElement("div");
    return e.style.fontFamily = this.options.toolbar.fontFamily, e.style.fontSize = "12px", e.innerHTML = A, e
}, StiJsViewer.prototype.InitializeInteractions = function (A) {
    A.getComponentOffset = function (A) {
        var e = 0, t = 0, o = A;
        while (A && !isNaN(A.offsetLeft) && !isNaN(A.offsetTop) && (A == o || "" == A.style.position || "static" == A.style.position))e += A.offsetLeft - A.scrollLeft, t += A.offsetTop - A.scrollTop, A = A.offsetParent;
        return {top: t, left: e}
        ...
        var o = this.jsObject.reportParams.zoom / 100 * 9, i = this.jsObject.reportParams.zoom / 100 * 5;
        t.style.position = "absolute", t.style.width = o + "px", t.style.height = i + "px", A.appendChild(t);
        var s = A.style.position, n = A.className;
        A.style.position = "relative", n || (A.className = "stiSortingParentElement");
        var a = this.jsObject.FindPosX(t, A.className), r = this.jsObject.FindPosY(t, A.className);
        t.style.marginLeft = A.offsetWidth - a - o - this.jsObject.reportParams.zoom / 100 * 3 + "px", t.style.marginTop = A.offsetHeight / 2 - i / 2 - r + "px", A.style.position = s, A.className = n
    }, A.paintCollapsingIcon = function (e, t) {
        var o = document.createElement("img");
        o.src = t ? this.jsObject.collections.images["CollapsingPlus.png"] : this.jsObject.collections.images["CollapsingMinus.png"], o.style.position = "absolute";
        var i = this.jsObject.reportParams.zoom / 100 * 10, s = this.jsObject.reportParams.zoom / 100 * 10;
        o.style.width = i + "px", o.style.height = s + "px", e.appendChild(o);
        var n = A.getComponentOffset(e), a = A.getComponentOffset(o);
        ...
        this.jsObject.controls.parametersPanel && (t.variables = this.jsObject.controls.parametersPanel.getParametersValues()), this.jsObject.postInteraction(t)
        ...
        var e = A.getAttribute("interaction"), t = A.getAttribute("compindex"), o = "true" != A.getAttribute("collapsed");
        this.jsObject.reportParams.interactionCollapsingStates || (this.jsObject.reportParams.interactionCollapsingStates = {}),
        this.jsObject.reportParams.interactionCollapsingStates[e] || (this.jsObject.reportParams.interactionCollapsingStates[e] = {}), this.jsObject.reportParams.interactionCollapsingStates[e][t] = o;
        var i = {
            action: "Collapsing",
    ...
    for (var e = A.getElementsByTagName("TD"), t = [], o = 0; o < e.length; o++)if (e[o].getAttribute("interaction") && (e[o].getAttribute("pageguid") || e[o].getAttribute("collapsed") || e[o].getAttribute("databandsort"))) {
        e[o].style.cursor = "pointer", e[o].jsObject = this;
        ...
        if (s) {
            ...
            t.indexOf(n) < 0 && (A.paintCollapsingIcon(e[o], "true" == s), t.push(n))
        }
    ...
    if (this.options.parameters[A.name] = e, e.params = A, e.controls = {}, e.jsObject = this, e.params.isNull = !1, e.menu = null, e.addCell = function (A) {
            var t = document.createElement("td");
            return t.style.height = e.jsObject.options.parameterRowHeight + "px", t.style.padding = "0px 2px 0 2px", this.tr[0].appendChild(t), A && t.appendChild(A), t
        }, "Bool" != e.params.type || "Value" != e.params.basicType && "NullableValue" != e.params.basicType || e.addCell(this.CreateBoolCheckBox(e)), "Range" == e.params.basicType && (e.addCell().innerHTML = this.collections.loc.RangeFrom), "Bool" == e.params.type && "List" != e.params.basicType || e.addCell(this.CreateFirstTextBox(e)), "DateTime" == e.params.type && e.params.allowUserValues && "List" != e.params.basicType && "Range" != e.params.basicType && e.addCell(this.CreateFirstDateTimeButton(e)), "Guid" == e.params.type && e.params.allowUserValues && "List" != e.params.basicType && e.addCell(this.CreateFirstGuidButton(e)), "Range" == e.params.basicType && (e.addCell().innerHTML = this.collections.loc.RangeTo), "Range" == e.params.basicType && e.addCell(this.CreateSecondTextBox(e)), "Range" == e.params.basicType && "DateTime" == e.params.type && e.params.allowUserValues && e.addCell(this.CreateSecondDateTimeButton(e)), "Range" == e.params.basicType && "Guid" == e.params.type && e.params.allowUserValues && e.addCell(this.CreateSecondGuidButton(e)), (null != e.params.items || "List" == e.params.basicType && e.params.allowUserValues) && e.addCell(this.CreateDropDownButton(e)), "NullableValue" == e.params.basicType && e.params.allowUserValues && e.addCell(this.CreateNullableCheckBox(e)), "NullableValue" == e.params.basicType && e.params.allowUserValues) {
        var t = e.addCell();
        t.innerHTML = "Null", t.style.padding = "0px"
    }
    return e.setEnabled = function (A) {
        this.params.isNull = !A;
        for (var e in this.controls)this.controls[e].setEnabled(A)
        ...
        } else null != e.menu && (e.params.allowUserValues && "List" == e.params.basicType && e.menu.updateItems(), e.menu.changeVisibleState(!1))
        ...
        var A = null;
        if (e.params.isNull)return null;
        if ("Value" == e.params.basicType || "NullableValue" == e.params.basicType) {
            if ("Bool" == e.params.type)return e.controls.boolCheckBox.isChecked;
            if ("DateTime" == e.params.type)return this.getStringDateTime(e.params.key);
            A = e.params.allowUserValues ? e.controls.firstTextBox.value : e.params.key
        }
        if ("Range" == e.params.basicType && (A = {}, A.from = "DateTime" == e.params.type ? this.getStringDateTime(e.params.key) : e.controls.firstTextBox.value, A.to = "DateTime" == e.params.type ? this.getStringDateTime(e.params.keyTo) : e.controls.secondTextBox.value), "List" == e.params.basicType)if (A = [], e.params.allowUserValues)for (var t in e.params.items)A[t] = "DateTime" == e.params.type ? this.getStringDateTime(e.params.items[t].key) : e.params.items[t].key; else {
            num = 0;
            for (var t in e.params.items)e.params.items[t].isChecked && (A[num] = "DateTime" == e.params.type ? this.getStringDateTime(e.params.items[t].key) : e.params.items[t].key, num++)
        }
        return A
        ...
        var t = e.jsObject, o = A.split(":"), i = o[0].split("."), s = i.length > 1 ? t.strToInt(i[0]) : 0, n = t.strToInt(i.length > 1 ? i[1] : i[0]), a = o.length > 1 ? t.strToInt(o[1]) : 0, r = o.length > 2 ? t.strToInt(o[2]) : 0;
        return (1e4 * (864e5 * s + 36e5 * n + 6e4 * a + 1e3 * r)).toString()
    }, e.getSingleValueForReportServer = function () {
        var A = null;
        if (e.params.isNull)return null;
        if ("Value" == e.params.basicType || "NullableValue" == e.params.basicType) {
            if ("Bool" == e.params.type)return e.controls.boolCheckBox.isChecked ? "True" : "False";
            if ("DateTime" == e.params.type)return e.getDateTimeForReportServer(e.params.key);
            A = e.params.allowUserValues ? e.controls.firstTextBox.value : e.params.key, "TimeSpan" == e.params.type && (A = e.getTimeSpanForReportServer(A))
        }
        return A
    }, e.getRangeValuesForReportServer = function () {
        var A = {};
        return A.from = "DateTime" == e.params.type ? e.getDateTimeForReportServer(e.params.key) : "TimeSpan" == e.params.type ? e.getTimeSpanForReportServer(e.controls.firstTextBox.value) : e.controls.firstTextBox.value, A.to = "DateTime" == e.params.type ? e.getDateTimeForReportServer(e.params.keyTo) : "TimeSpan" == e.params.type ? e.getTimeSpanForReportServer(e.controls.secondTextBox.value) : e.controls.secondTextBox.value, A
    }, e.getListValuesForReportServer = function () {
        var A = [], t = 0;
        for (var o in e.params.items) {
            var i = {};
            i.Ident = "Single", (e.params.allowUserValues || !e.params.allowUserValues && e.params.items[o].isChecked) && (i.Value = "DateTime" == e.params.type ? e.getDateTimeForReportServer(e.params.items[o].key) : "TimeSpan" == e.params.type ? e.getTimeSpanForReportServer(e.params.items[o].key) : e.params.items[o].key, i.Type = null == i.Value ? null : e.getSingleType(), A.push(i))
        }
        return A
    }, e.getParameterObjectForReportServer = function () {
        var A = {};
        switch (A.Ident = e.params.basicType.indexOf("Value") != -1 ? "Single" : e.params.basicType, A.Name = e.params.name, A.Ident) {
            case"Single":
                A.Value = e.getSingleValueForReportServer(), A.Type = null == A.Value ? null : e.getSingleType();
                break;
            case"Range":
                var t = e.getRangeValuesForReportServer();
                A.FromValue = t.from, A.ToValue = t.to, A.RangeType = e.params.type + "Range", A.FromType = null == A.FromValue ? null : e.getSingleType(), A.ToType = null == A.ToValue ? null : e.getSingleType();
                break;
            case"List":
                A.ListType = e.params.type + "List", A.Values = e.getListValuesForReportServer()
        }
        return A
    ...
    return A.controls.boolCheckBox = e, e.setChecked("boolean" == typeof A.params.value && A.params.value || "true" == A.params.value || "True" == A.params.value), e.setEnabled(A.params.allowUserValues), e
}, StiJsViewer.prototype.CreateFirstTextBox = function (A) {
    var e = this.ParameterTextBox(A);
    if (A.controls.firstTextBox = e, e.setReadOnly("List" == A.params.basicType || !A.params.allowUserValues), "Value" == A.params.basicType || "NullableValue" == A.params.basicType) {
    ...
    if ("List" == A.params.basicType)for (var o in A.params.items) {
        var i = !0;
        A.params.value instanceof Array && !A.params.value.contains(A.params.items[o].value) && (i = !1), A.params.items[o].isChecked = i, i && ("" != e.value && (e.value += ";"), A.params.allowUserValues ? e.value += this.getStringKey(A.params.items[o].key, A) : e.value += "" != A.params.items[o].value ? A.params.items[o].value : this.getStringKey(A.params.items[o].key, A))
    }
    return e
}, StiJsViewer.prototype.CreateFirstDateTimeButton = function (A) {
    var e = this.ParameterButton("DateTimeButton", A);
    return A.controls.firstDateTimeButton = e, e.action = function () {
    ...
    return A.controls.firstGuidButton = e, e.action = function () {
    ...
    var e = this.ParameterTextBox(A);
    if (A.controls.secondTextBox = e, e.setReadOnly(!A.params.allowUserValues), "DateTime" == A.params.type && A.params.keyTo && A.params.keyTo.isNull) {
        var t = this.getNowDateTimeObject(new Date);
        A.params.keyTo = t
    }
    return e.value = this.getStringKey(A.params.keyTo, A), e
}, StiJsViewer.prototype.CreateSecondDateTimeButton = function (A) {
    var e = this.ParameterButton("DateTimeButton", A);
    return A.controls.secondDateTimeButton = e, e.action = function () {
        var A = {
    ...
    var e = this.ParameterButton("GuidButton", A);
    return A.controls.secondGuidButton = e, e.action = function () {
    ...
    return A.controls.dropDownButton = e, e.action = function () {
    ...
    if (this.controls.parametersPanel && (this.controls.parametersPanel.changeVisibleState(!1), this.controls.mainPanel.removeChild(this.controls.parametersPanel), delete this.controls.parametersPanel), this.options.toolbar.visible && this.options.toolbar.showParametersButton && this.controls.toolbar.controls.Parameters.setEnabled(null != this.options.paramsVariables), null == this.options.paramsVariables)return;
    var A = document.createElement("div");
    A.menus = {}, this.controls.parametersPanel = A, this.controls.mainPanel.appendChild(A), A.className = "stiJsViewerParametersPanel", A.id = this.controls.viewer.id + "_ParametersPanel", A.style.display = "none", A.visible = !1, A.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (A.style.color = this.options.toolbar.fontColor), A.jsObject = this, A.currentOpeningParameter = null, A.dropDownButtonWasClicked = !1, A.dateTimeButtonWasClicked = !1;
    var e = document.createElement("div");
    A.appendChild(e), e.style.padding = "0 2px 2px 2px", A.style.top = this.controls.drillDownPanel.offsetHeight + (this.options.toolbar.visible ? this.controls.toolbar.offsetHeight : 0) + (this.controls.findPanel ? this.controls.findPanel.offsetHeight : 0) + "px", A.container = document.createElement("div"), e.appendChild(A.container), A.container.className = "stiJsViewerInnerContainerParametersPanel", "" != this.options.toolbar.backgroundColor && (A.container.style.background = this.options.toolbar.backgroundColor), "" != this.options.toolbar.borderColor && (A.container.style.border = "1px solid " + this.options.toolbar.borderColor), A.container.id = A.id + "Container", A.container.style.maxHeight = this.options.appearance.parametersPanelMaxHeight + "px", A.container.jsObject = this;
    var t = this.CreateHTMLTable();
    A.mainButtons = t, t.setAttribute("align", "right"), t.style.margin = "5px 0 10px 0", t.ID = A.id + "MainButtons", A.mainButtons.reset = this.FormButton("Reset", this.collections.loc.Reset, null, 80), A.mainButtons.submit = this.FormButton("Submit", this.collections.loc.Submit, null, 80), t.addCell(A.mainButtons.reset), t.addCell(A.mainButtons.submit).style.paddingLeft = "10px", this.options.isTouchDevice || (A.container.onscroll = function () {
        A.hideAllMenus()
    }), A.changeVisibleState = function (e) {
        var t = A.jsObject.options, o = A.jsObject.controls;
        A.style.display = e ? "" : "none", A.visible = e, t.toolbar.visible && t.toolbar.showParametersButton && o.toolbar.controls.Parameters.setSelected(e), o.reportPanel.style.marginTop = ("relative" == o.reportPanel.style.position ? A.offsetHeight : o.drillDownPanel.offsetHeight + A.offsetHeight) + "px", null != o.bookmarksPanel && (o.bookmarksPanel.style.top = (t.toolbar.visible ? o.toolbar.offsetHeight : 0) + o.drillDownPanel.offsetHeight + (o.findPanel ? o.findPanel.offsetHeight : 0) + A.offsetHeight + "px")
    }, A.addParameters = function () {
        var e = this.jsObject.copyObject(A.jsObject.options.paramsVariables), t = this.jsObject.getCountObjects(e), o = t <= 5 ? 1 : A.jsObject.options.appearance.parametersPanelColumnsCount, i = parseInt(t / o);
        i * o < t && i++;
        ...
        for (var a = {}, r = 0; r < i + 1; r++) {
            ...
            for (n.appendChild(l), p = 0; p < o; p++) {
                var c = document.createElement("td");
                c.style.padding = "0 10px 0 " + (p > 0 ? "30px" : 0), l.appendChild(c);
                var h = document.createElement("td");
                h.style.padding = 0, l.appendChild(h), a[r + ";" + p + "name"] = c, a[r + ";" + p + "controls"] = h
            }
        }
        for (var p = 0, r = 0, g = 0; g < t; g++)a[r + ";" + p + "name"].style.whiteSpace = "nowrap", a[r + ";" + p + "name"].innerHTML = e[g].alias, a[r + ";" + p + "controls"].appendChild(A.jsObject.CreateParameter(e[g])), r++, g == t - 1 && a[r + ";" + p + "controls"].appendChild(A.mainButtons), r == i && (r = 0, p++)
    }, A.clearParameters = function () {
        while (A.container.childNodes[0])A.container.removeChild(A.container.childNodes[0])
        ...
        A.jsObject.options.currentMenu && A.jsObject.options.currentMenu.changeVisibleState(!1), A.jsObject.options.currentDatePicker && A.jsObject.options.currentDatePicker.changeVisibleState(!1)
    }, this.options.parameters = {}, A.addParameters(), A.changeVisibleState(!0)
}, StiJsViewer.prototype.ParameterButton = function (A, e) {
    var t = this.SmallButton(null, null, A + ".png", null, null, "stiJsViewerFormButton");
    return t.style.height = this.options.isTouchDevice ? "26px" : "21px", t.style.height = this.options.isTouchDevice ? "26px" : "21px", t.innerTable.style.width = "100%", t.imageCell.style.textAlign = "center", t.parameter = e, t.buttonType = A, t
}, StiJsViewer.prototype.ParameterTextBox = function (A) {
    var e = this.TextBox(null, null, null, !0);
    e.parameter = A, "Char" == A.params.type && (e.maxLength = 1);
    var t = "210px";
    return "Range" == A.params.basicType ? (t = "140px", "Guid" != A.params.type && "String" != A.params.type || (t = "190px"), "DateTime" == A.params.type && (t = "235px"), "Char" == A.params.type && (t = "60px")) : t = "Guid" == A.params.type ? "265px" : "210px", e.style.width = t, "DateTime" == A.params.type && (e.action = function () {
        if (this.oldValue == this.value)return;
        try {
            var A = (new Date).toLocaleTimeString(), t = A.toLowerCase().indexOf("am") >= 0 || A.toLowerCase().indexOf("pm") >= 0, o = t ? "MM/dd/yyyy" : "dd.MM.yyyy", i = o + " hh:mm:ss";
            "Date" == e.parameter.params.dateTimeType && (i = o), "Time" == e.parameter.params.dateTimeType && (i = "hh:mm:ss");
            var s = e.jsObject.GetDateTimeFromString(this.value, i), n = e.jsObject.getNowDateTimeObject(s);
            e.parameter.params[e.parameter.controls.secondTextBox == e ? "keyTo" : "key"] = n, e.value = e.jsObject.dateTimeObjectToString(n, e.parameter.params.dateTimeType)
        } catch (A) {
            alert(A)
        }
    }), e
    ...
    e.parameter = A, e.changeVisibleState = function (e, t) {
        var o = "stiJsViewerMainPanel";
        if (t && (this.parentButton = t, t.haveMenu = !0), e) {
            this.onshow(), this.style.display = "", this.visible = !0, this.style.overflow = "hidden", this.parentButton.setSelected(!0), this.jsObject.options.currentMenu = this, this.style.width = this.innerContent.offsetWidth + "px", this.style.height = this.innerContent.offsetHeight + "px", this.style.left = this.jsObject.FindPosX(A, o) + "px", this.style.top = "Down" == this.animationDirection ? this.jsObject.FindPosY(this.parentButton, o) + this.parentButton.offsetHeight + 2 + "px" : this.jsObject.FindPosY(this.parentButton, o) - this.offsetHeight + "px", this.innerContent.style.top = ("Down" == this.animationDirection ? -1 : 1) * this.innerContent.offsetHeight + "px", A.menu = this, d = new Date;
            var i = d.getTime();
            this.jsObject.options.toolbar.menuAnimation && (i += this.jsObject.options.menuAnimDuration), this.jsObject.ShowAnimationVerticalMenu(this, "Down" == this.animationDirection ? 0 : -1, i)
    ...
    var t = this.CreateHTMLTable();
    return t.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (t.style.color = this.options.toolbar.fontColor), t.style.fontSize = "12px", t.style.width = A.offsetWidth - 5 + "px", t.className = "stiJsViewerClearAllStyles stiJsViewerParametersMenuInnerTable", e.innerContent.appendChild(t), e.innerTable = t, e
}, StiJsViewer.prototype.parameterMenuItem = function (A) {
    var e = document.createElement("div");
    e.jsObject = this, e.parameter = A, e.isOver = !1, e.className = "stiJsViewerParametersMenuItem", e.style.height = this.options.isTouchDevice ? "30px" : "24px";
    var t = this.CreateHTMLTable();
    return t.className = "stiJsViewerClearAllStyles stiJsViewerParametersMenuItemInnerTable", e.appendChild(t), e.onmouseover = function () {
        this.jsObject.options.isTouchDevice || this.onmouseenter()
    ...
    }, e.innerContainer = t.addCell(), e.innerContainer.style.padding = "0 5px 0 5px", e
}, StiJsViewer.prototype.TouchEndMenuItem = function (A, e) {
    var t = document.getElementById(A);
    if (!t || t.parameter.jsObject.options.fingerIsMoved)return;
    if (e)return t.className = "stiJsViewerParametersMenuItemPressed", "undefined" != typeof event && "preventDefault" in event && event.preventDefault(), void setTimeout("js" + t.parameter.jsObject.controls.viewer.id + ".TouchEndMenuItem('" + t.id + "', false)", 200);
    t.className = t.isOver ? "stiJsViewerParametersMenuItemOver" : "stiJsViewerParametersMenuItem", null != t.action && t.action()
    ...
    for (var t in A.params.items) {
        var o = e.innerTable.addCellInNextRow(), i = this.parameterMenuItem(A);
        o.appendChild(i), i.id = A.jsObject.controls.viewer.id + A.params.name + "Item" + t, i.parameter = A, i.key = A.params.items[t].key, i.value = A.params.items[t].value, i.innerContainer.innerHTML = "" != i.value && "DateTime" != A.params.type && "TimeSpan" != A.params.type && "Bool" != A.params.type ? i.value : this.getStringKey(i.key, i.parameter), i.action = function () {
            if (this.parameter.params.key = this.key, "Bool" != this.parameter.params.type ? this.parameter.controls.firstTextBox.value = "DateTime" == this.parameter.params.type || "TimeSpan" == this.parameter.params.type ? this.parameter.jsObject.getStringKey(this.key, this.parameter) : this.parameter.params.allowUserValues ? this.key : "" != this.value ? this.value : this.key : this.parameter.controls.boolCheckBox.setChecked("True" == this.key), this.parameter.changeVisibleStateMenu(!1), this.parameter.params.binding) {
                var A = {action: "InitVars", variables: this.jsObject.controls.parametersPanel.getParametersValues()};
    ...
    for (var t in A.params.items) {
        var o = e.innerTable.addCellInNextRow(), i = this.parameterMenuItem(A);
        o.appendChild(i), i.id = A.jsObject.controls.viewer.id + A.params.name + "Item" + t, i.parameter = A, i.value = A.params.items[t].value, i.key = A.params.items[t].key, i.keyTo = A.params.items[t].keyTo, i.innerContainer.innerHTML = i.value + " [" + this.getStringKey(i.key, i.parameter) + " - " + this.getStringKey(i.keyTo, i.parameter) + "]", i.action = function () {
    ...
    for (var o in A.params.items) {
        ...
        menuItem = this.parameterMenuItem(A), i.appendChild(menuItem), menuItem.action = null, menuItem.id = A.jsObject.controls.viewer.id + A.params.name + "Item" + o, menuItem.parameter = A, menuItem.value = A.params.items[o].value, menuItem.key = A.params.items[o].key, e.menuItems[o] = menuItem;
        var s = this.CreateHTMLTable();
        menuItem.innerContainer.appendChild(s);
        var n = s.addCell(), a = this.ParameterCheckBox(A);
        a.style.marginRight = "5px", n.appendChild(a), a.menuParent = e, a.setChecked(A.params.items[o].isChecked), menuItem.checkBox = a, a.isChecked || (t = !1), a.onChecked = function () {
            this.parameter.params.items = {}, this.parameter.controls.firstTextBox.value = "";
            var A = !0;
            for (var t in this.menuParent.menuItems)this.parameter.params.items[t] = {}, this.parameter.params.items[t].key = this.menuParent.menuItems[t].key, this.parameter.params.items[t].value = this.menuParent.menuItems[t].value, this.parameter.params.items[t].isChecked = this.menuParent.menuItems[t].checkBox.isChecked, A && !this.menuParent.menuItems[t].checkBox.isChecked && (A = !1), this.parameter.params.items[t].isChecked && ("" != this.parameter.controls.firstTextBox.value && (this.parameter.controls.firstTextBox.value += ";"), this.parameter.controls.firstTextBox.value += "" != this.menuParent.menuItems[t].value ? this.menuParent.menuItems[t].value : this.parameter.jsObject.getStringKey(this.menuParent.menuItems[t].key, this.parameter));
            e.checkBoxSelectAll.setChecked(A)
        };
        var r = s.addCell();
        if (r.style.whiteSpace = "nowrap", r.innerHTML = "" != menuItem.value ? menuItem.value : this.getStringKey(menuItem.key, menuItem.parameter), o == this.getCountObjects(A.params.items) - 1) {
            var l = this.parameterMenuItem(A);
            l.id = A.jsObject.controls.viewer.id + A.params.name + "ItemClose", l.innerContainer.innerHTML = this.collections.loc.Close, l.innerContainer.style.paddingLeft = "13px", l.action = function () {
            ...
            e.checkBoxSelectAll = c, c.style.margin = "8px 7px 8px 7px", i.appendChild(c), i.appendChild(this.parameterMenuSeparator()), i.appendChild(l), c.setChecked(t), c.action = function () {
                var t = this.isChecked;
                for (var o in A.params.items)e.menuItems[o].checkBox.setChecked(t)
            }
        }
    }
    return e
    ...
    e.newItem = function (A, t) {
        ...
        o.id = t.jsObject.controls.viewer.id + t.params.name + "Item" + t.jsObject.newGuid().replace(/-/g, ""), o.onmouseover = null, o.onmousedown = null, o.ontouchend = null, o.action = null, o.parameter = t, o.value = A.value, o.key = A.key;
        var i = o.jsObject.CreateHTMLTable();
        o.innerContainer.appendChild(i);
        var s = t.jsObject.ParameterTextBox(t);
        if (o.textBox = s, s.value = t.jsObject.getStringKey(o.key, o.parameter), s.thisMenu = e, i.addCell(s).style.padding = "0 1px 0 0", "DateTime" == t.params.type) {
            var n = t.jsObject.ParameterButton("DateTimeButton", t);
            n.id = o.id + "DateTimeButton", n.parameter = t, n.thisItem = o, i.addCell(n).style.padding = "0 1px 0 1px", n.action = function () {
        ...
        if ("Guid" == t.params.type) {
            ...
            a.id = o.id + "GuidButton", a.thisItem = o, a.thisMenu = e, i.addCell(a).style.padding = "0 1px 0 1px", a.action = function () {
        ...
        return r.id = o.id + "RemoveButton", r.itemsContainer = this.itemsContainer, r.thisItem = o, r.thisMenu = e, i.addCell(r).style.padding = "0 1px 0 1px", r.action = function () {
    ...
    e.innerTable.addCell(t), t.id = A.jsObject.controls.viewer.id + A.params.name + "ItemNew", t.innerContainer.innerHTML = this.collections.loc.NewItem, t.thisMenu = e, t.action = function () {
        var A = {};
        "DateTime" == this.parameter.params.type ? (A.key = this.parameter.jsObject.getNowDateTimeObject(), A.value = this.parameter.jsObject.dateTimeObjectToString(A.key, this.parameter)) : "TimeSpan" == this.parameter.params.type ? (A.key = "00:00:00", A.value = "00:00:00") : "Bool" == this.parameter.params.type ? (A.key = "False", A.value = "False") : (A.key = "", A.value = "");
        var e = this.thisMenu.newItem(A, this.parameter);
        this.thisMenu.itemsContainer.appendChild(e), "textBox" in e && e.textBox.focus(), this.thisMenu.updateItems()
    };
    var o = e.innerTable.addCellInNextRow();
    e.itemsContainer = o;
    for (var i in A.params.items)o.appendChild(e.newItem(A.params.items[i], A));
    var s = e.innerTable.addCellInNextRow(), n = this.parameterMenuItem(A);
    s.appendChild(n), n.id = A.jsObject.controls.viewer.id + A.params.name + "ItemRemoveAll", n.innerContainer.innerHTML = this.collections.loc.RemoveAll, n.thisMenu = e, n.action = function () {
    ...
    for (var e = 1; e <= 12; e++) {
        ...
        switch (e) {
            case 1:
                t = "January", o = this.collections.loc.MonthJanuary;
                break;
            case 2:
                t = "February", o = this.collections.loc.MonthFebruary;
                break;
            case 3:
                t = "March", o = this.collections.loc.MonthMarch;
                break;
            case 4:
                t = "April", o = this.collections.loc.MonthApril;
                break;
            case 5:
                t = "May", o = this.collections.loc.MonthMay;
                break;
            case 6:
                t = "June", o = this.collections.loc.MonthJune;
                break;
            case 7:
                t = "July", o = this.collections.loc.MonthJuly;
                break;
            case 8:
                t = "August", o = this.collections.loc.MonthAugust;
                break;
            case 9:
                t = "September", o = this.collections.loc.MonthSeptember;
                break;
            case 10:
                t = "October", o = this.collections.loc.MonthOctober;
                break;
            case 11:
                t = "November", o = this.collections.loc.MonthNovember;
                break;
            case 12:
                t = "December", o = this.collections.loc.MonthDecember
        }
        var i = t.substring(0, 3), s = o.substring(0, 3);
        A = A.replace(t, e).replace(t.toLowerCase(), e).replace(i, e).replace(i.toLowerCase(), e), A = A.replace(o, e).replace(o.toLowerCase(), e).replace(s, e).replace(s.toLowerCase(), e)
    }
    return A
    ...
    var i = 1970, s = 1, n = 1, a = 0, r = 0, l = 0, c = 0, h = "", p = 0, g = [];
    while (p < A.length) {
        if (h = A.charAt(p), t(h)) {
            g.push(h), p++;
            while (p < A.length && t(A.charAt(p)))g[g.length - 1] += A.charAt(p), p++;
    ...
    p = 0;
    var m = 0, u = -1, d = !1;
    while (p < e.length && u + 1 < g.length) {
        if (h = e.charAt(p), m = 0, "Y" == h || "y" == h || "M" == h || "d" == h || "h" == h || "H" == h || "m" == h || "s" == h || "f" == h || "F" == h || "t" == h || "z" == h) {
            u++;
            while (p < e.length && e.charAt(p) == h)p++, m++
        }
        switch (h) {
            case"Y":
                i = g[u];
    ...
    var A = this.Progress();
    return A.jsObject = this, A.style.display = "none", this.controls.processImage = A, this.controls.mainPanel.appendChild(A), A.style.left = "50%", A.style.marginLeft = "-32px", this.options.appearance.fullScreenMode ? (A.style.top = "50%", A.style.marginTop = "-100px") : A.style.top = "250px", A.show = function () {
        this.style.display = ""
    }, A.hide = function () {
    ...
    var e = document.createElement("div");
    return A.appendChild(e), e.className = "js_viewer_loader", A
}, StiJsViewer.prototype.RadioButton = function (A, e, t, o) {
    var i = this.CreateHTMLTable();
    return i.style.fontFamily = this.options.toolbar.fontFamily, i.jsObject = this, i.name = A, i.isEnabled = !0, i.isChecked = !1, i.groupName = e, i.className = "stiJsViewerRadioButton", i.captionText = t, o && i.setAttribute("title", o), A && (this.controls.radioButtons || (this.controls.radioButtons = {}), this.controls.radioButtons[A] = i), i.outCircle = document.createElement("div"), i.outCircle.className = "stiJsViewerRadioButtonOutCircle", i.circleCell = i.addCell(i.outCircle), i.innerCircle = document.createElement("div"), i.innerCircle.style.visibility = "hidden", i.innerCircle.className = "stiJsViewerRadioButtonInnerCircle", i.innerCircle.style.margin = this.options.isTouchDevice ? "4px" : "3px", i.innerCircle.style.width = this.options.isTouchDevice ? "9px" : "7px", i.innerCircle.style.height = this.options.isTouchDevice ? "9px" : "7px", i.outCircle.appendChild(i.innerCircle), null != t && (i.captionCell = i.addCell(), i.captionCell.style.paddingLeft = "4px", i.captionCell.style.whiteSpace = "nowrap", i.captionCell.innerHTML = t), i.lastCell = i.addCell(), i.onmouseover = function () {
        this.jsObject.options.isTouchDevice || this.onmouseenter()
        ...
        if (this.groupName && A)for (var e in this.jsObject.controls.radioButtons)this.groupName == this.jsObject.controls.radioButtons[e].groupName && this.jsObject.controls.radioButtons[e].setChecked(!1);
    ...
    var A = document.createElement("div");
    A.id = this.controls.viewer.id + "ReportPanel", A.jsObject = this, this.controls.reportPanel = A, this.controls.mainPanel.appendChild(A), A.style.textAlign = "default" == this.options.appearance.pageAlignment ? "center" : this.options.appearance.pageAlignment, A.className = "stiJsViewerReportPanel", A.style.bottom = "0px", A.pages = [], A.addPage = function (e) {
        if (!e)return null;
        var t = document.createElement("DIV");
        t.jsObject = this.jsObject, A.appendChild(t), A.pages.push(t), t.loadContent = function (A) {
            t.style.display = "inline-block";
            var e = A[0];
            t.style.background = "Transparent" == e.background ? "White" : e.background, t.innerHTML = e.content
        }, t.className = this.jsObject.options.appearance.showPageShadow ? "stiJsViewerPageShadow" : "stiJsViewerPage";
        for (var o = e.sizes.split(";"), i = e.margins.split(" "), s = [], n = 0; n < i.length; n++)s.push(parseInt(i[n].replace("px", "")));
        t.margins = s, t.pageWidth = parseInt(o[0]), t.pageHeight = parseInt(o[1]), t.style.overflow = "hidden", t.style.margin = "10px", t.style.display = "inline-block", t.style.verticalAlign = "top", t.style.padding = e.margins, t.style.border = "1px solid " + this.jsObject.options.appearance.pageBorderColor, t.style.color = "#000000", t.style.background = "Transparent" == e.background ? "White" : e.background, t.style.boxSizing = "content-box", t.innerHTML = e.content, this.jsObject.reportParams.pagesWidth = t.offsetWidth || t.pageWidth, this.jsObject.reportParams.pagesHeight = t.offsetHeight || t.pageHeight;
        for (var n = 0; n < t.childNodes.length; n++)if (t.childNodes[n].style && t.childNodes[n].style.backgroundImage) {
            t.style.backgroundImage = t.childNodes[n].style.backgroundImage, t.childNodes[n].style.backgroundImage = "", t.childNodes[n].style.backgroundColor = "";
            break
        }
        for (var n = 0; n < t.childNodes.length; n++)if (t.childNodes[n].style && t.childNodes[n].style.backgroundImage) {
            t.style.backgroundImage = t.childNodes[n].style.backgroundImage, t.childNodes[n].style.backgroundImage = "", t.childNodes[n].style.backgroundColor = "";
        ...
        if ("Div" == this.jsObject.options.appearance.reportDisplayMode || "Span" == this.jsObject.options.appearance.reportDisplayMode) {
            ...
            if (a && a.length > 0) {
                var r = a[0];
                r.style.position = "relative", t.style.width = t.pageWidth - t.margins[1] - t.margins[3] + "px", t.style.height = t.pageHeight - t.margins[0] - t.margins[2] + "px"
            }
        }
        var l = t.offsetHeight - s[0] - s[2];
        return (null == A.maxHeights[o[1]] || l > A.maxHeights[o[1]]) && (A.maxHeights[o[1]] = l), this.jsObject.InitializeInteractions(t), t
        ...
        this.jsObject.controls.toolbar && (A -= this.jsObject.controls.toolbar.offsetHeight), this.jsObject.controls.parametersPanel && (A -= this.jsObject.controls.parametersPanel.offsetHeight);
        ...
        A.style.top = this.jsObject.options.toolbar.visible && ("Percentage" != this.jsObject.options.viewerHeightType || this.jsObject.options.appearance.scrollbarsMode) ? this.jsObject.controls.toolbar.offsetHeight + "px" : "0px", this.clear(), this.maxHeights = {};
        var e = this.jsObject.reportParams.pagesArray.length;
        this.jsObject.controls.css || (this.jsObject.controls.css = document.getElementById(this.jsObject.options.viewerId + "Styles")), this.jsObject.controls.css || (this.jsObject.controls.css = document.createElement("STYLE"), this.jsObject.controls.css.id = this.jsObject.options.viewerId + "Styles", this.jsObject.controls.css.setAttribute("type", "text/css"), this.jsObject.controls.head.appendChild(this.jsObject.controls.css)), this.jsObject.controls.css.styleSheet ? this.jsObject.controls.css.styleSheet.cssText = this.jsObject.reportParams.pagesArray[e - 2] : this.jsObject.controls.css.innerHTML = this.jsObject.reportParams.pagesArray[e - 2];
        var t = document.getElementById(this.jsObject.options.viewerId + "chartScriptJsViewer");
        if (t && this.jsObject.controls.head.removeChild(t), this.jsObject.reportParams.pagesArray[e - 1]) {
            var o = document.createElement("Script");
            o.setAttribute("type", "text/javascript"), o.id = this.jsObject.options.viewerId + "chartScriptJsViewer", o.textContent = this.jsObject.reportParams.pagesArray[e - 1], this.jsObject.controls.head.appendChild(o)
        }
        for (num = 0; num <= e - 3; num++)var i = this.addPage(this.jsObject.reportParams.pagesArray[num]);
        ...
        for (var e in this.childNodes)if (null != this.childNodes[e].pageHeight) {
        ...
        "undefined" != typeof A && A.touches.length > 1 && this.jsObject.options.allowTouchZoom && ("preventDefault" in A && A.preventDefault(), this.jsObject.options.zoomStep++, 0 == this.jsObject.options.firstZoomDistance && (this.jsObject.options.firstZoomDistance = Math.sqrt(Math.pow(A.touches[0].pageX - A.touches[1].pageX, 2) + Math.pow(A.touches[0].pageY - A.touches[1].pageY, 2))), this.jsObject.options.zoomStep > 2 && 0 == this.jsObject.options.secondZoomDistance && (this.jsObject.options.secondZoomDistance = Math.sqrt(Math.pow(A.touches[0].pageX - A.touches[1].pageX, 2) + Math.pow(A.touches[0].pageY - A.touches[1].pageY, 2)), this.jsObject.SetZoom(this.jsObject.options.secondZoomDistance > this.jsObject.options.firstZoomDistance)))
    }
    ...
    return n.innerTable = a, a.style.height = "100%", n.appendChild(a), null != t && (n.image = document.createElement("img"), n.image.src = this.collections.images[t], n.imageCell = a.addCell(n.image), n.imageCell.style.lineHeight = "0", n.imageCell.style.padding = this.options.isTouchDevice && null == e ? "0 7px" : "0 3px"), null != e && (n.caption = a.addCell(), n.caption.style.padding = (i ? "1px 0 " : "1px 5px ") + (t ? "0 0" : "0 5px"), n.caption.style.whiteSpace = "nowrap", n.caption.style.textAlign = "left", n.caption.innerHTML = e), null != i && (n.arrow = document.createElement("img"), n.arrow.src = this.collections.images["ButtonArrow" + i + ".png"], a.addCell(n.arrow).style.padding = e ? "0 5px 0 5px" : this.options.isTouchDevice ? "0 7px 0 0" : "0 5px 0 2px", n.arrow.style.marginTop = "1px", n.arrow.style.verticalAlign = "baseline"), o && "object" != typeof o && n.setAttribute("title", o), n.onmouseoverAction = function () {
        ...
        this.jsObject.options.buttonsTimer = [this, this.className, e], this.className = this.styleName + " " + this.styleName + "Over", this.isTouchEndTimer = setTimeout(function () {
            A.isTouchEndFlag = !1
        }, 1e3)
    ...
    o.style.width = e + "px", o.style.height = t + "px", o.style.minWidth = e + "px", o.style.minHeight = t + "px", o.jsObject = this, o.name = A, o.isEnabled = !0, o.isSelected = !1, o.isOver = !1;
    ...
    if (i.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (i.style.color = this.options.toolbar.fontColor), e && (i.style.width = e + "px"), i.jsObject = this, i.name = A, i.isEnabled = !0, i.isSelected = !1, i.isFocused = !1, i.isOver = !1, i.actionLostFocus = o, t)try {
    ...
    var A = document.createElement("div");
    A.controls = {}, A.shortType = !1, A.minWidth = 0, this.controls.toolbar = A, this.controls.mainPanel.appendChild(A), A.jsObject = this, A.className = "stiJsViewerToolBar", this.options.toolbar.visible || (A.style.height = "0px", A.style.width = "0px");
    var e = document.createElement("div");
    A.innerContent = e, A.appendChild(e), e.style.padding = "2px";
    var t = this.CreateHTMLTable();
    e.appendChild(t), t.className = "stiJsViewerToolBarTable", t.style.margin = 0, "" != this.options.toolbar.backgroundColor && (t.style.background = this.options.toolbar.backgroundColor), "" != this.options.toolbar.borderColor && (t.style.border = "1px solid " + this.options.toolbar.borderColor), "" != this.options.toolbar.fontColor && (t.style.color = this.options.toolbar.fontColor), t.style.fontFamily = this.options.toolbar.fontFamily;
    var o = t.addCell(), i = t.addCell(), s = this.options.appearance.rightToLeft ? i : o, n = this.options.appearance.rightToLeft ? o : i;
    s.style.width = "100%";
    var a = this.CreateHTMLTable(), r = this.CreateHTMLTable();
    s.appendChild(a), n.appendChild(r), a.setAttribute("align", this.options.appearance.rightToLeft ? "right" : "default" == this.options.toolbar.alignment ? "left" : this.options.toolbar.alignment), a.style.margin = "1px", r.style.margin = "1px", this.options.exports.showExportToPowerPoint || this.options.exports.showExportToPdf || this.options.exports.showExportToXps || this.options.exports.showExportToOpenDocumentWriter || this.options.exports.showExportToOpenDocumentCalc || this.options.exports.showExportToText || this.options.exports.showExportToRtf || this.options.exports.showExportToWord2007 || this.options.exports.showExportToCsv || this.options.exports.showExportToDbf || this.options.exports.showExportToXml || this.options.exports.showExportToDif || this.options.exports.showExportToSylk || this.options.exports.showExportToExcel || this.options.exports.showExportToExcel2007 || this.options.exports.showExportToExcelXml || this.options.exports.showExportToHtml || this.options.exports.showExportToHtml5 || this.options.exports.showExportToMht || this.options.exports.showExportToImageBmp || this.options.exports.showExportToImageGif || this.options.exports.showExportToImageJpeg || this.options.exports.showExportToImageMetafile || this.options.exports.showExportToImagePcx || this.options.exports.showExportToImagePng || this.options.exports.showExportToImageTiff || this.options.exports.showExportToImageSvg || this.options.exports.showExportToImageSvgz || (this.options.exports.showExportToDocument || (this.options.toolbar.showSaveButton = !1), this.options.toolbar.showSendEmailButton = !1);
    var l = !0, c = [];
    this.options.toolbar.showAboutButton && c.push(["About", null, "About.png", !1]), this.options.toolbar.showAboutButton && this.options.toolbar.showDesignButton && c.push(["Separator1"]), this.options.toolbar.showDesignButton && c.push(["Design", this.collections.loc.Design, "Design.png", !1]), this.options.toolbar.showPrintButton && (c.push(["Print", this.collections.loc.Print, "Print.png", !0]), l = !1), this.options.toolbar.showSaveButton && (c.push(["Save", this.collections.loc.Save, "Save.png", !0]), l = !1), this.options.toolbar.showSendEmailButton && (c.push(["SendEmail", this.collections.loc.SendEmail, "SendEmail.png", !0]), l = !1), (this.options.toolbar.showBookmarksButton || this.options.toolbar.showParametersButton) && (l || c.push(["Separator2"]), l = !1), this.options.toolbar.showBookmarksButton && (c.push(["Bookmarks", null, "Bookmarks.png", !0]), l = !1), this.options.toolbar.showParametersButton && (c.push(["Parameters", null, "Parameters.png", !0]), l = !1), (this.options.toolbar.showFindButton || this.options.toolbar.showEditorButton) && (l || c.push(["Separator2_1"]), l = !1), this.options.toolbar.showFindButton && (c.push(["Find", null, "Find.png", !0]), l = !1), this.options.toolbar.showEditorButton && (c.push(["Editor", null, "Editor.png", !0]), l = !1), (this.options.toolbar.showFirstPageButton || this.options.toolbar.showPreviousPageButton || this.options.toolbar.showNextPageButton || this.options.toolbar.showLastPageButton || this.options.toolbar.showCurrentPageControl) && (l || c.push(["Separator3"]), l = !1), this.options.toolbar.showFirstPageButton && (c.push(["FirstPage", null, this.options.appearance.rightToLeft ? "LastPage.png" : "FirstPage.png", !0]), l = !1), this.options.toolbar.showPreviousPageButton && (c.push(["PrevPage", null, this.options.appearance.rightToLeft ? "NextPage.png" : "PrevPage.png", !0]), l = !1), this.options.toolbar.showCurrentPageControl && (c.push(["PageControl"]), l = !1), this.options.toolbar.showNextPageButton && (c.push(["NextPage", null, this.options.appearance.rightToLeft ? "PrevPage.png" : "NextPage.png", !0]), l = !1), this.options.toolbar.showLastPageButton && (c.push(["LastPage", null, this.options.appearance.rightToLeft ? "FirstPage.png" : "LastPage.png", !0]), l = !1), (this.options.toolbar.showViewModeButton || this.options.toolbar.showZoomButton) && (l || c.push(["Separator4"]), l = !1), this.options.toolbar.showFullScreenButton && (c.push(["FullScreen", null, "FullScreen.png", !0]), c.push(["Separator5"]), l = !1), this.options.toolbar.showZoomButton && (c.push(["Zoom", "100%", "Zoom.png", !0]), l = !1), this.options.toolbar.showViewModeButton && (c.push(["ViewMode", this.collections.loc.OnePage, "ViewMode.png", !0]), l = !1), "undefined" != typeof this.options.toolbar.multiPageWidthCount && (this.reportParams.multiPageWidthCount = this.options.toolbar.multiPageWidthCount), "undefined" != typeof this.options.toolbar.multiPageHeightCount && (this.reportParams.multiPageHeightCount = this.options.toolbar.multiPageHeightCount), this.options.appearance.rightToLeft || "right" != this.options.toolbar.alignment || !this.options.toolbar.showAboutButton && !this.options.toolbar.showDesignButton || c.push(["Separator6"]);
    for (var h = 0; h < c.length; h++) {
        var p = this.options.appearance.rightToLeft ? c.length - 1 - h : h, g = c[p][0], m = "About" == g || "Design" == g || "Separator1" == g ? r : a;
        if (0 == g.indexOf("Separator")) {
            m.addCell(this.ToolBarSeparator());
            continue
        }
        var u = "Print" == g && "Default" == this.options.toolbar.printDestination || "Save" == g || "SendEmail" == g || "Zoom" == g || "ViewMode" == g ? "Down" : null, d = "PageControl" != g ? this.SmallButton(g, c[p][1], c[p][2], c[p][3] ? [this.collections.loc[g + "ToolTip"], this.helpLinks[g]] : null, u) : this.PageControl();
        d.caption && (d.caption.style.display = this.options.toolbar.showButtonCaptions ? "" : "none"), "Editor" == g && (d.style.display = "none"), d.style.margin = "Design" == g ? "1px 5px 1px 5px" : "1px", A.controls[g] = d, m.addCell(d)
    }
    if ("Hover" == this.options.toolbar.showMenuMode)for (var B = ["Print", "Save", "SendEmail", "Zoom", "ViewMode"], h = 0; h < B.length; h++) {
        var w = A.controls[B[h]];
    ...
    A.haveScroll = function () {
        ...
        var A = s.offsetWidth, e = a.offsetWidth, o = t.offsetWidth;
        return o - (A - e) + 50
    }, A.minWidth = A.getMinWidth(), A.changeToolBarState = function () {
        var e = A.jsObject.reportParams, t = A.controls, o = A.jsObject.collections;
        if (t.FirstPage && t.FirstPage.setEnabled(e.pageNumber > 0 && "OnePage" == e.viewMode), t.PrevPage && t.PrevPage.setEnabled(e.pageNumber > 0 && "OnePage" == e.viewMode), t.NextPage && t.NextPage.setEnabled(e.pageNumber < e.pagesCount - 1 && "OnePage" == e.viewMode), t.LastPage && t.LastPage.setEnabled(e.pageNumber < e.pagesCount - 1 && "OnePage" == e.viewMode), t.ViewMode && (t.ViewMode.caption.innerHTML = o.loc[e.viewMode]), t.Zoom && (t.Zoom.caption.innerHTML = e.zoom + "%"), t.PageControl && (t.PageControl.countLabel.innerHTML = e.pagesCount, t.PageControl.textBox.value = e.pageNumber + 1, t.PageControl.textBox.setEnabled(!(e.pagesCount <= 1 || "WholeReport" == e.viewMode))), A.jsObject.controls.menus.zoomMenu) {
        ...
        for (var e in shortButtons)w = A.controls[shortButtons[e]], w && w.caption && (w.caption.style.display = A.shortType ? "none" : "")
    }, A.setEnabled = function (e) {
        e ? A.disabledPanel && (A.removeChild(A.disabledPanel), A.disabledPanel = null) : A.disabledPanel || (A.disabledPanel = document.createElement("div"), A.disabledPanel.className = "stiJsViewerDisabledPanel", A.appendChild(A.disabledPanel))
    }, window.onresize = function () {
    }, A.controls.Bookmarks && A.controls.Bookmarks.setEnabled(!1), A.controls.Parameters && A.controls.Parameters.setEnabled(!1)
}, StiJsViewer.prototype.ToolBarSeparator = function () {
    var A = document.createElement("div");
    return A.style.width = "1px", A.style.height = this.options.isTouchDevice ? "26px" : "21px", A.className = "stiJsViewerToolBarSeparator", A
}, StiJsViewer.prototype.PageControl = function () {
    var A = this.CreateHTMLTable(), e = A.addCell();
    e.style.padding = "0 2px 0 0", e.innerHTML = this.collections.loc.Page;
    var t = this.TextBox("PageControl", 45);
    A.addCell(t), A.textBox = t, t.action = function () {
        t.jsObject.options.pageNumber != t.getCorrectValue() - 1 && t.jsObject.postAction("GoToPage")
    }, t.getCorrectValue = function () {
        return value = parseInt(this.value), (value < 1 || !value) && (value = 1), value > t.jsObject.reportParams.pagesCount && (value = t.jsObject.reportParams.pagesCount), value
    };
    var o = A.addCell();
    ...
    var o = document.createElement("div");
    o.name = A, o.id = this.generateKey(), o.className = "stiJsViewerForm", o.jsObject = this, o.level = t, o.caption = null, o.visible = !1, o.style.display = "none", null == t && (t = 1), o.style.zIndex = 10 * t + 1, A && (this.controls.forms || (this.controls.forms = {}), null != this.controls.forms[A] && (this.controls.forms[A].changeVisibleState(!1), this.controls.mainPanel.removeChild(this.controls.forms[A])), this.controls.forms[A] = o), this.controls.mainPanel.appendChild(o), o.header = document.createElement("div"), o.header.thisForm = o, o.appendChild(o.header), o.header.className = "stiJsViewerFormHeader";
    var i = this.CreateHTMLTable();
    i.style.width = "100%", o.header.appendChild(i), o.caption = i.addCell(), null != e && (e && (o.caption.innerHTML = e), o.caption.style.textAlign = "left", o.caption.style.padding = "5px 10px 8px 15px"), o.buttonClose = this.SmallButton(null, null, "CloseForm.png"), o.buttonClose.style.display = "inline-block", o.buttonClose.form = o, o.buttonClose.action = function () {
    ...
    return o.buttonsPanel.appendChild(n), o.buttonOk = this.FormButton(null, this.collections.loc.ButtonOk), o.buttonOk.action = function () {
        ...
        if (A) {
            ...
            this.flag = !1, this.jsObject.ShowAnimationForm(this, e)
        ...
        var e = A.clientX, t = A.clientY, o = this.thisForm.jsObject.FindPosX(this.thisForm, "stiJsViewerMainPanel"), i = this.thisForm.jsObject.FindPosY(this.thisForm, "stiJsViewerMainPanel");
        ...
        var t = A.touches[0].pageX, o = A.touches[0].pageY, i = this.thisForm.jsObject.FindPosX(this.thisForm, "stiJsViewerMainPanel"), s = this.thisForm.jsObject.FindPosY(this.thisForm, "stiJsViewerMainPanel");
        this.thisForm.jsObject.options.formInDrag = [t, o, i, s, this.thisForm], this.isTouchStartTimer = setTimeout(function () {
            e.isTouchStartFlag = !1
        }, 1e3)
    }, o.header.ontouchmove = function (A) {
        if (A.preventDefault(), this.thisForm.jsObject.options.formInDrag) {
            var e = this.thisForm.jsObject.options.formInDrag, t = e[2], o = e[3], i = A.touches[0].pageX, s = A.touches[0].pageY, n = e[0] - i, a = e[1] - s, r = t - n, l = o - a;
            e[4].style.left = r + "px", e[4].style.top = l + "px"
        }
    }, o.header.ontouchend = function () {
        event.preventDefault(), this.thisForm.jsObject.options.formInDrag = !1;
    }, o.move = function (A) {
        var e = this.jsObject.options.formInDrag[2] + (A.clientX - this.jsObject.options.formInDrag[0]), t = this.jsObject.options.formInDrag[3] + (A.clientY - this.jsObject.options.formInDrag[1]);
        this.style.left = e > 0 ? e + "px" : 0, this.style.top = t > 0 ? t + "px" : 0
    }, o
    ...
    A.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (A.style.color = this.options.toolbar.fontColor), A.style.fontSize = "12px", A.controls = {}, A.labels = {}, A.container.style.padding = "3px", A.addControlToParentControl = function (e, t, o, i) {
        null == o.innerTable && (o.innerTable = A.jsObject.CreateHTMLTable(), o.innerTable.style.width = "100%", o.appendChild(o.innerTable)), t.parentRow = o.innerTable.addRow();
        var s = o.innerTable.addCellInLastRow(), n = null != e ? o.innerTable.addCellInLastRow() : s;
        if (null != e) {
            s.style.padding = "0 8px 0 8px", s.style.minWidth = "150px", e && (s.innerHTML = e), A.labels[i] = s;
    ...
    for (var e = "8px", t = [["SavingReportGroup", null, this.GroupPanel(this.collections.loc.SavingReport, !0, 390, "4px 0 4px 0"), null, "4px"], ["SaveReportMdc", null, this.RadioButton(A.name + "SaveReportMdc", A.name + "SavingReportGroup", this.collections.loc.SaveReportMdc, null), "SavingReportGroup.container", "6px " + e + " 3px " + e], ["SaveReportMdz", null, this.RadioButton(A.name + "SaveReportMdz", A.name + "SavingReportGroup", this.collections.loc.SaveReportMdz, null), "SavingReportGroup.container", "3px " + e + " 3px " + e], ["SaveReportMdx", null, this.RadioButton(A.name + "SaveReportMdx", A.name + "SavingReportGroup", this.collections.loc.SaveReportMdx, null), "SavingReportGroup.container", "3px " + e + " 0px " + e], ["SaveReportPassword", this.collections.loc.PasswordSaveReport, this.TextBox(null, 140, this.collections.loc.PasswordSaveReportTooltip), "SavingReportGroup.container", "4px " + e + " 0px " + e], ["PageRangeGroup", null, this.GroupPanel(this.collections.loc.PagesRange, !0, 390, "4px 0 4px 0"), null, "4px"], ["PageRangeAll", null, this.RadioButton(A.name + "PagesRangeAll", A.name + "PageRangeGroup", this.collections.loc.PagesRangeAll, this.collections.loc.PagesRangeAllTooltip), "PageRangeGroup.container", "6px " + e + " 6px " + e], ["PageRangeCurrentPage", null, this.RadioButton(A.name + "PagesRangeCurrentPage", A.name + "PageRangeGroup", this.collections.loc.PagesRangeCurrentPage, this.collections.loc.PagesRangeCurrentPageTooltip), "PageRangeGroup.container", "0px " + e + " 4px " + e], ["PageRangePages", null, this.RadioButton(A.name + "PagesRangePages", A.name + "PageRangeGroup", this.collections.loc.PagesRangePages, this.collections.loc.PagesRangePagesTooltip), "PageRangeGroup.container", "0px " + e + " 0px " + e], ["PageRangePagesText", null, this.TextBox(null, 130, this.collections.loc.PagesRangePagesTooltip), "PageRangePages.lastCell", "0 0 0 30px"], ["SettingsGroup", null, this.GroupPanel(this.collections.loc.SettingsGroup, !0, 390, "4px 0 4px 0"), null, "4px"], ["ImageType", this.collections.loc.Type, this.DropDownListForExportForm(null, 160, this.collections.loc.TypeTooltip, this.GetImageTypesItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["DataType", this.collections.loc.Type, this.DropDownListForExportForm(null, 160, this.collections.loc.TypeTooltip, this.GetDataTypesItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ExcelType", this.collections.loc.Type, this.DropDownListForExportForm(null, 160, this.collections.loc.TypeTooltip, this.GetExcelTypesItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["HtmlType", this.collections.loc.Type, this.DropDownListForExportForm(null, 160, this.collections.loc.TypeTooltip, this.GetHtmlTypesItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["Zoom", this.collections.loc.ZoomHtml, this.DropDownListForExportForm(null, 160, this.collections.loc.ZoomHtmlTooltip, this.GetZoomItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ImageFormatForHtml", this.collections.loc.ImageFormatForHtml, this.DropDownListForExportForm(null, 160, this.collections.loc.ImageFormatForHtmlTooltip, this.GetImageFormatForHtmlItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ExportMode", this.collections.loc.ExportMode, this.DropDownListForExportForm(null, 160, this.collections.loc.ExportModeTooltip, this.GetExportModeItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["CompressToArchive", null, this.CheckBox(null, this.collections.loc.CompressToArchive, this.collections.loc.CompressToArchiveTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["UseEmbeddedImages", null, this.CheckBox(null, this.collections.loc.EmbeddedImageData, this.collections.loc.EmbeddedImageDataTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["AddPageBreaks", null, this.CheckBox(null, this.collections.loc.AddPageBreaks, this.collections.loc.AddPageBreaksTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ImageResolution", this.collections.loc.ImageResolution, this.DropDownListForExportForm(null, 160, this.collections.loc.ImageResolutionTooltip, this.GetImageResolutionItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ImageCompressionMethod", this.collections.loc.ImageCompressionMethod, this.DropDownListForExportForm(null, 160, this.collections.loc.ImageCompressionMethodTooltip, this.GetImageCompressionMethodItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["AllowEditable", this.collections.loc.AllowEditable, this.DropDownListForExportForm(null, 160, this.collections.loc.AllowEditableTooltip, this.GetAllowEditableItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ImageQuality", this.collections.loc.ImageQuality, this.DropDownListForExportForm(null, 160, this.collections.loc.ImageQualityTooltip, this.GetImageQualityItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ContinuousPages", null, this.CheckBox(null, this.collections.loc.ContinuousPages, this.collections.loc.ContinuousPagesTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["StandardPdfFonts", null, this.CheckBox(null, this.collections.loc.StandardPDFFonts, this.collections.loc.StandardPDFFontsTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["EmbeddedFonts", null, this.CheckBox(null, this.collections.loc.EmbeddedFonts, this.collections.loc.EmbeddedFontsTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["UseUnicode", null, this.CheckBox(null, this.collections.loc.UseUnicode, this.collections.loc.UseUnicodeTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["Compressed", null, this.CheckBox(null, this.collections.loc.Compressed, this.collections.loc.CompressedTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ExportRtfTextAsImage", null, this.CheckBox(null, this.collections.loc.ExportRtfTextAsImage, this.collections.loc.ExportRtfTextAsImageTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["PdfACompliance", null, this.CheckBox(null, this.collections.loc.PdfACompliance, this.collections.loc.PdfAComplianceTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["KillSpaceLines", null, this.CheckBox(null, this.collections.loc.KillSpaceLines, this.collections.loc.KillSpaceLinesTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["PutFeedPageCode", null, this.CheckBox(null, this.collections.loc.PutFeedPageCode, this.collections.loc.PutFeedPageCodeTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["DrawBorder", null, this.CheckBox(null, this.collections.loc.DrawBorder, this.collections.loc.DrawBorderTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["CutLongLines", null, this.CheckBox(null, this.collections.loc.CutLongLines, this.collections.loc.CutLongLinesTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["BorderType", this.collections.loc.BorderType + ":", this.DropDownListForExportForm(null, 160, this.collections.loc.BorderTypeTooltip, this.GetBorderTypeItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ZoomX", this.collections.loc.ZoomXY ? this.collections.loc.ZoomXY.replace(":", "") + " X: " : "", this.DropDownListForExportForm(null, 160, this.collections.loc.ZoomXYTooltip, this.GetZoomItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ZoomY", this.collections.loc.ZoomXY ? this.collections.loc.ZoomXY.replace(":", "") + " Y: " : "", this.DropDownListForExportForm(null, 160, this.collections.loc.ZoomXYTooltip, this.GetZoomItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["EncodingTextOrCsvFile", this.collections.loc.EncodingData, this.DropDownListForExportForm(null, 160, this.collections.loc.EncodingDataTooltip, this.GetEncodingDataItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ImageFormat", this.collections.loc.ImageFormat, this.DropDownListForExportForm(null, 160, this.collections.loc.ImageFormatTooltip, this.GetImageFormatItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["DitheringType", this.collections.loc.MonochromeDitheringType, this.DropDownListForExportForm(null, 160, this.collections.loc.MonochromeDitheringTypeTooltip, this.GetMonochromeDitheringTypeItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["TiffCompressionScheme", this.collections.loc.TiffCompressionScheme, this.DropDownListForExportForm(null, 160, this.collections.loc.TiffCompressionSchemeTooltip, this.GetTiffCompressionSchemeItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["CutEdges", null, this.CheckBox(null, this.collections.loc.CutEdges, this.collections.loc.CutEdgesTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["MultipleFiles", null, this.CheckBox(null, this.collections.loc.MultipleFiles, this.collections.loc.MultipleFilesTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ExportDataOnly", null, this.CheckBox(null, this.collections.loc.ExportDataOnly, this.collections.loc.ExportDataOnlyTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["UseDefaultSystemEncoding", null, this.CheckBox(null, this.collections.loc.UseDefaultSystemEncoding, this.collections.loc.UseDefaultSystemEncodingTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["EncodingDifFile", this.collections.loc.EncodingDifFile, this.DropDownListForExportForm(null, 160, this.collections.loc.EncodingDifFileTooltip, this.GetEncodingDifFileItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["ExportModeRtf", this.collections.loc.ExportModeRtf, this.DropDownListForExportForm(null, 160, this.collections.loc.ExportModeRtfTooltip, this.GetExportModeRtfItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["UsePageHeadersAndFooters", null, this.CheckBox(null, this.collections.loc.UsePageHeadersFooters, this.collections.loc.UsePageHeadersFootersTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["RemoveEmptySpaceAtBottom", null, this.CheckBox(null, this.collections.loc.RemoveEmptySpace, this.collections.loc.RemoveEmptySpaceTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["Separator", this.collections.loc.Separator, this.TextBox(null, 160, this.collections.loc.SeparatorTooltip), "SettingsGroup.container", "2px " + e + " 2px " + e], ["DataExportMode", this.collections.loc.BandsFilter, this.DropDownListForExportForm(null, 160, this.collections.loc.BandsFilterTooltip, this.GetDataExportModeItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["SkipColumnHeaders", null, this.CheckBox(null, this.collections.loc.SkipColumnHeaders, this.collections.loc.SkipColumnHeadersTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ExportObjectFormatting", null, this.CheckBox(null, this.collections.loc.ExportObjectFormatting, this.collections.loc.ExportObjectFormattingTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["UseOnePageHeaderAndFooter", null, this.CheckBox(null, this.collections.loc.UseOnePageHeaderFooter, this.collections.loc.UseOnePageHeaderFooterTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ExportEachPageToSheet", null, this.CheckBox(null, this.collections.loc.ExportEachPageToSheet, this.collections.loc.ExportEachPageToSheetTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["ExportPageBreaks", null, this.CheckBox(null, this.collections.loc.ExportPageBreaks, this.collections.loc.ExportPageBreaksTooltip), "SettingsGroup.container", "4px " + e + " 4px " + e], ["EncodingDbfFile", this.collections.loc.EncodingDbfFile, this.DropDownListForExportForm(null, 160, this.collections.loc.EncodingDbfFileTooltip, this.GetEncodingDbfFileItems(), !0), "SettingsGroup.container", "2px " + e + " 2px " + e], ["DocumentSecurityButton", null, this.SmallButton(null, this.collections.loc.DocumentSecurityButton, null, null, "Down", "stiJsViewerFormButton"), "SettingsGroup.container", "2px " + e + " 2px " + e], ["DigitalSignatureButton", null, this.SmallButton(null, this.collections.loc.DigitalSignatureButton, null, null, "Down", "stiJsViewerFormButton"), "SettingsGroup.container", "2px " + e + " 2px " + e], ["OpenAfterExport", null, this.CheckBox(null, this.collections.loc.OpenAfterExport, this.collections.loc.OpenAfterExportTooltip), null, "4px " + e + " 4px " + e], ["DocumentSecurityMenu", null, this.BaseMenu(A.name + "DocumentSecurityMenu", null, "Down", "stiJsViewerDropdownPanel"), null, null], ["PasswordInputUser", this.collections.loc.UserPassword, this.TextBox(null, 160, this.collections.loc.UserPasswordTooltip), "DocumentSecurityMenu.innerContent", "8px " + e + " 2px " + e], ["PasswordInputOwner", this.collections.loc.OwnerPassword, this.TextBox(null, 160, this.collections.loc.OwnerPasswordTooltip), "DocumentSecurityMenu.innerContent", "2px " + e + " 2px " + e], ["PrintDocument", null, this.CheckBox(null, this.collections.loc.AllowPrintDocument, this.collections.loc.AllowPrintDocumentTooltip), "DocumentSecurityMenu.innerContent", "4px " + e + " 4px " + e], ["ModifyContents", null, this.CheckBox(null, this.collections.loc.AllowModifyContents, this.collections.loc.AllowModifyContentsTooltip), "DocumentSecurityMenu.innerContent", "4px " + e + " 4px " + e], ["CopyTextAndGraphics", null, this.CheckBox(null, this.collections.loc.AllowCopyTextAndGraphics, this.collections.loc.AllowCopyTextAndGraphicsTooltip), "DocumentSecurityMenu.innerContent", "4px " + e + " 4px " + e], ["AddOrModifyTextAnnotations", null, this.CheckBox(null, this.collections.loc.AllowAddOrModifyTextAnnotations, this.collections.loc.AllowAddOrModifyTextAnnotationsTooltip), "DocumentSecurityMenu.innerContent", "4px " + e + " 4px " + e], ["KeyLength", this.collections.loc.EncryptionKeyLength, this.DropDownListForExportForm(null, 160, this.collections.loc.EncryptionKeyLengthTooltip, this.GetEncryptionKeyLengthItems(), !0), "DocumentSecurityMenu.innerContent", "2px " + e + " 8px " + e], ["DigitalSignatureMenu", null, this.BaseMenu(A.name + "DigitalSignatureMenu", null, "Down", "stiJsViewerDropdownPanel"), null, null], ["UseDigitalSignature", null, this.CheckBox(null, this.collections.loc.UseDigitalSignature, this.collections.loc.UseDigitalSignatureTooltip), "DigitalSignatureMenu.innerContent", "8px " + e + " 4px " + e], ["GetCertificateFromCryptoUI", null, this.CheckBox(null, this.collections.loc.GetCertificateFromCryptoUI, this.collections.loc.GetCertificateFromCryptoUITooltip), "DigitalSignatureMenu.innerContent", "4px " + e + " 4px " + e], ["SubjectNameString", this.collections.loc.SubjectNameString, this.TextBox(null, 160, this.collections.loc.SubjectNameStringTooltip), "DigitalSignatureMenu.innerContent", "8px " + e + " 8px " + e]], o = 0; o < t.length; o++) {
        var i = t[o][0], s = t[o][1], n = t[o][2], a = t[o][3];
        if (A.controls[i] = n, t[o][4] && (n.style.margin = t[o][4]), "stiJsViewerGroupPanel" == n.className && (n.container.style.paddingBottom = "6px"), "DocumentSecurityMenu" == i || "DigitalSignatureMenu" == i)continue;
        if (null != a) {
            var r = a.split("."), l = A.controls[r[0]];
            if (r.length > 1)for (var c = 1; c < r.length; c++)l && (l = l[r[c]]);
    ...
    for (var h = ["DocumentSecurityButton", "DigitalSignatureButton"], o = 0; o < h.length; o++) {
        var p = A.controls[h[o]];
        p.innerTable.style.width = "100%", p.style.minWidth = "220px", p.caption.style.textAlign = "center", p.caption.style.width = "100%", p.style.display = "inline-block"
    }
    ...
    A.controls.PdfACompliance.onChecked = function () {
        for (var e = ["StandardPdfFonts", "EmbeddedFonts", "UseUnicode"], t = 0; t < e.length; t++)A.controls[e[t]].setEnabled(!this.isChecked)
    };
    ...
    A.controls.StandardPdfFonts.onChecked = function () {
        ...
        for (var e = ["EmbeddedFonts", "UseUnicode"], t = 0; t < e.length; t++)A.controls[e[t]].setChecked(!1)
    ...
    }, A.setControlsValue = function (e) {
        var t = A.jsObject.getDefaultExportSettings(A.exportFormat);
        if (!t)return;
        var o = A.getExportControlNames();
        for (var i in A.controls)null != A.controls[i].setEnabled && A.controls[i].setEnabled(!0);
        var s = A.jsObject.isContainted(o, "ImageType") && "ImageTiff" != A.exportFormat;
        A.controls[s ? "PageRangeCurrentPage" : "PageRangeAll"].setChecked(!0), A.controls.PageRangeAll.setEnabled(!s);
        for (var n in t)if (A.jsObject.isContainted(o, n)) {
            if ("ImageType" == n || "DataType" == n || "ExcelType" == n || "HtmlType" == n) {
                if (e)continue;
                switch (n) {
                    case"ImageType":
                        A.jsObject.options.exports.showExportToImageBmp || "Bmp" != t[n] || (t[n] = "Gif"), A.jsObject.options.exports.showExportToImageGif || "Gif" != t[n] || (t[n] = "Jpeg"), A.jsObject.options.exports.showExportToImageJpeg || "Jpeg" != t[n] || (t[n] = "Pcx"), A.jsObject.options.exports.showExportToImagePcx || "Pcx" != t[n] || (t[n] = "Png"), A.jsObject.options.exports.showExportToImagePng || "Png" != t[n] || (t[n] = "Tiff"), A.jsObject.options.exports.showExportToImageTiff || "Tiff" != t[n] || (t[n] = "Emf"), A.jsObject.options.exports.showExportToImageMetafile || "Emf" != t[n] || (t[n] = "Svg"), A.jsObject.options.exports.showExportToImageSvg || "Svg" != t[n] || (t[n] = "Svgz"), A.jsObject.options.exports.showExportToImageSvgz || "Svgz" != t[n] || (t[n] = "Bmp");
                        break;
                    case"DataType":
                        A.jsObject.options.exports.showExportToCsv || "Csv" != t[n] || (t[n] = "Dbf"), A.jsObject.options.exports.showExportToDbf || "Dbf" != t[n] || (t[n] = "Xml"), A.jsObject.options.exports.showExportToXml || "Xml" != t[n] || (t[n] = "Dif"), A.jsObject.options.exports.showExportToDif || "Dif" != t[n] || (t[n] = "Sylk"), A.jsObject.options.exports.showExportToSylk || "Sylk" != t[n] || (t[n] = "Csv");
                        break;
                    case"ExcelType":
                        A.jsObject.options.exports.showExportToExcel2007 || "Excel2007" != t[n] || (t[n] = "ExcelBinary"), A.jsObject.options.exports.showExportToExcel2007 || "Excel2007" != t[n] || (t[n] = "ExcelBinary"), A.jsObject.options.exports.showExportToExcel || "ExcelBinary" != t[n] || (t[n] = "ExcelXml"), A.jsObject.options.exports.showExportToExcelXml || "ExcelXml" != t[n] || (t[n] = "Excel2007");
                        break;
                    case"HtmlType":
                        A.jsObject.options.exports.showExportToHtml || "Html" != t[n] || (t[n] = "Html5"), A.jsObject.options.exports.showExportToHtml5 || "Html5" != t[n] || (t[n] = "Mht"), A.jsObject.options.exports.showExportToMht || "Mht" != t[n] || (t[n] = "Html")
                }
            }
            var a = A.controls[n];
            A.setDefaultValueToControl(a, t[n])
        }
        if ("Document" == A.exportFormat && A.controls.SaveReportMdc.setChecked(!0), "Pdf" == A.exportFormat && t.StandardPdfFonts && A.controls.StandardPdfFonts.setChecked(!0), A.jsObject.isContainted(o, "HtmlType") && t.ImageFormat && A.controls.ImageFormatForHtml.setKey(t.ImageFormat), "Rtf" == A.exportFormat && t.ExportMode && A.controls.ExportModeRtf.setKey(t.ExportMode), A.jsObject.isContainted(o, "ImageType") && t.ImageZoom && A.controls.Zoom.setKey(t.ImageZoom.toString()), "Pdf" == A.exportFormat) {
            var r = t.UserAccessPrivileges;
            A.controls.PrintDocument.setChecked(r.indexOf("PrintDocument") != -1 || "All" == r), A.controls.ModifyContents.setChecked(r.indexOf("ModifyContents") != -1 || "All" == r), A.controls.CopyTextAndGraphics.setChecked(r.indexOf("CopyTextAndGraphics") != -1 || "All" == r), A.controls.AddOrModifyTextAnnotations.setChecked(r.indexOf("AddOrModifyTextAnnotations") != -1 || "All" == r)
        }
        "Difs" != A.exportFormat && "Sylk" != A.exportFormat || A.controls.EncodingDifFile.setKey("437"), "Dbf" == A.exportFormat && t.CodePage && A.controls.EncodingDbfFile.setKey(t.CodePage), "Text" != A.exportFormat && "Csv" != A.exportFormat || !t.Encoding || A.controls.EncodingTextOrCsvFile.setKey(t.Encoding)
    }, A.show = function (e, t) {
        A.actionType = t, A.showControlsByExportFormat(e || "Pdf"), A.controls.SavingReportGroup.changeOpeningState(!0), A.controls.PageRangeGroup.changeOpeningState(!0), A.controls.SettingsGroup.changeOpeningState(!1), A.changeVisibleState(!0)
    }, A.action = function () {
        var e = A.getExportSettingsObject();
        A.changeVisibleState(!1), A.actionType == A.jsObject.options.actions.exportReport ? A.jsObject.postExport(A.exportFormat, e) : A.jsObject.options.email.showEmailDialog ? A.jsObject.controls.forms.sendEmailForm.show(A.exportFormat, e) : (e.Email = A.jsObject.options.email.defaultEmailAddress, e.Message = A.jsObject.options.email.defaultEmailMessage, e.Subject = A.jsObject.options.email.defaultEmailSubject, A.jsObject.postEmail(A.exportFormat, e))
    }, A.showControlsByExportFormat = function (e, t) {
        A.exportFormat = e;
        for (var o in A.controls) {
            var i = A.controls[o], s = A.getExportControlNames();
        ...
        return e.ImageGif = e.ImageJpeg = e.ImagePcx = e.ImageJpeg = e.ImagePng = e.ImageTiff = e.ImageEmf = e.ImageSvg = e.ImageSvgz = e.ImageBmp, e[A.exportFormat]
    }, A.getExportSettingsObject = function () {
        for (var e = {}, t = A.getExportControlNames(), o = 0; o < t.length; o++) {
            var i = A.controls, s = t[o], n = i[s];
            if (n.groupName == A.name + "SavingReportGroup" || n.groupName == A.name + "PageRangeGroup" || "PageRangePagesText" == s)continue;
            if ("SavingReportGroup" == s) e.Format = i.SaveReportMdc.isChecked ? "Mdc" : i.SaveReportMdz.isChecked ? "Mdz" : "Mdx", "Mdx" == e.Format && (e.Password = i.SaveReportPassword.value); else if ("PageRangeGroup" == s) e.PageRange = i.PageRangeAll.isChecked ? "All" : i.PageRangeCurrentPage.isChecked ? (A.jsObject.reportParams.pageNumber + 1).toString() : i.PageRangePagesText.value; else {
        ...
        if ("Pdf" == A.exportFormat) {
            ...
            for (var r = ["PrintDocument", "ModifyContents", "CopyTextAndGraphics", "AddOrModifyTextAnnotations"], o = 0; o < r.length; o++)e[r[o]] && ("" != e.UserAccessPrivileges && (e.UserAccessPrivileges += ", "), e.UserAccessPrivileges += r[o], delete e[r[o]])
        }
        A.jsObject.isContainted(t, "ImageType") && (e.ImageZoom = e.Zoom, delete e.Zoom);
        for (var r = [["ImageFormatForHtml", "ImageFormat"], ["EncodingTextOrCsvFile", "Encoding"], ["ExportModeRtf", "ExportMode"], ["EncodingDifFile", "Encoding"], ["EncodingDbfFile", "CodePage"]], o = 0; o < r.length; o++)null != e[r[o][0]] && (e[r[o][1]] = e[r[o][0]], delete e[r[o][0]]);
        return e
    }
    ...
    return n.onChange = function () {
        ...
        n.key = A, n.onChange();
        for (var e in n.items)if (A == n.items[e].key)return this.textBox.value = n.items[e].caption, void(n.image && (n.image.style.background = "url(" + n.jsObject.collections.images[n.items[e].imageName] + ")"));
    ...
    var e = this.CreateHTMLTable();
    return A.container.appendChild(e), A.image = document.createElement("img"), A.image.style.padding = "15px", A.image.src = this.collections.images["MsgFormError.png"], e.addCellInLastRow(A.image), A.description = e.addCellInLastRow(), A.description.className = "stiJsViewerMessagesFormDescription", A.description.style.maxWidth = "600px", A.description.style.color = this.options.toolbar.fontColor, A.show = function (A, e) {
        if (this.visible)return void(this.description.innerHTML += "<br/>" + A);
        this.jsObject.controls.forms.errorMessageForm && (this.jsObject.controls.mainPanel.removeChild(this.jsObject.controls.forms.errorMessageForm), this.jsObject.controls.mainPanel.appendChild(this.jsObject.controls.forms.errorMessageForm)), this.image.src = e ? this.jsObject.collections.images["MsgFormInfo.png"] : this.jsObject.collections.images["MsgFormError.png"], this.caption.innerHTML = e ? this.jsObject.collections.loc.FormViewerTitle : this.jsObject.collections.loc.Error, this.changeVisibleState(!0), this.description.innerHTML = A
    }, A.action = function () {
        this.changeVisibleState(!1)
    }, A
    ...
    e.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (e.style.color = this.options.toolbar.fontColor), e.style.fontSize = "12px", e.controls = {};
    var t = [["Email", this.collections.loc.Email, this.TextBox("sendEmailFormEmail", 280)], ["Subject", this.collections.loc.Subject, this.TextBox("sendEmailFormSubject", 280)], ["Message", this.collections.loc.Message, this.TextArea("sendEmailFormMessage", 280, 70)], ["AttachmentCell", this.collections.loc.Attachment, document.createElement("div")]], o = this.CreateHTMLTable();
    e.container.appendChild(o);
    for (var i = 0; i < t.length; i++) {
        var s = t[i][2];
        s.style.margin = "4px", e.controls[t[i][0]] = s, o.addTextCellInLastRow(t[i][1]).className = "stiJsViewerCaptionControls",
            o.addCellInLastRow(s), i < t.length - 1 && o.addRow()
    }
    e.show = function (A, e) {
        this.changeVisibleState(!0), this.exportSettings = e, this.exportFormat = A;
        for (var t in this.controls)this.controls[t].value = "";
        ...
        e.exportSettings.Email = e.controls.Email.value, e.exportSettings.Subject = e.controls.Subject.value, e.exportSettings.Message = e.controls.Message.value, e.changeVisibleState(!1), e.jsObject.postEmail(e.exportFormat, e.exportSettings)
    }
}, StiJsViewer.prototype.BaseMenu = function (A, e, t, o) {
    var i = document.createElement("div");
    i.className = "stiJsViewerParentMenu", i.jsObject = this, i.id = this.generateKey(), i.name = A, i.items = {}, i.parentButton = e, i.type = null, e && (e.haveMenu = !0), i.animationDirection = t, i.rightToLeft = this.options.appearance.rightToLeft, i.visible = !1, i.style.display = "none", A && (this.controls.menus || (this.controls.menus = {}), null != this.controls.menus[A] && (this.controls.menus[A].changeVisibleState(!1), this.controls.mainPanel.removeChild(this.controls.menus[A])), this.controls.menus[A] = i), this.controls.mainPanel.appendChild(i);
    var s = document.createElement("div");
    return s.style.overflowY = "auto", s.style.overflowX = "hidden", s.style.maxHeight = "420px", s.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (s.style.color = this.options.toolbar.fontColor), i.appendChild(s), i.innerContent = s, s.className = o || "stiJsViewerMenu", i.changeVisibleState = function (A, e, t) {
        var o = "stiJsViewerMainPanel";
        if (e && (this.parentButton = e, e.haveMenu = !0), A) {
            this.onshow(), this.style.display = "", this.visible = !0, this.style.overflow = "hidden", this.parentButton.setSelected(!0), this.jsObject.options[null == this.type ? "currentMenu" : "current" + this.type] = this, this.style.width = this.innerContent.offsetWidth + "px", this.style.height = this.innerContent.offsetHeight + "px", this.style.left = this.rightToLeft || t ? this.jsObject.FindPosX(this.parentButton, o) - this.innerContent.offsetWidth + this.parentButton.offsetWidth + "px" : this.jsObject.FindPosX(this.parentButton, o) + "px", this.style.top = "Down" == this.animationDirection ? this.jsObject.FindPosY(this.parentButton, o) + this.parentButton.offsetHeight + 2 + "px" : this.jsObject.FindPosY(this.parentButton, o) - this.offsetHeight + "px", this.innerContent.style.top = ("Down" == this.animationDirection ? -1 : 1) * this.innerContent.offsetHeight + "px", d = new Date;
            var i = d.getTime();
            this.jsObject.options.toolbar.menuAnimation && (i += this.jsObject.options.menuAnimDuration), this.jsObject.ShowAnimationVerticalMenu(this, "Down" == this.animationDirection ? 0 : -1, i)
        } else this.onHide(), clearTimeout(this.innerContent.animationTimer), this.visible = !1, this.parentButton.setSelected(!1), this.style.display = "none", this.jsObject.options[null == this.type ? "currentMenu" : "current" + this.type] == this && (this.jsObject.options[null == this.type ? "currentMenu" : "current" + this.type] = null)
    }, i.action = function (A) {
        return A
    ...
    e.action = function (A) {
        e.changeVisibleState(!1), e.jsObject.postPrint(A.key)
    }
    ...
    t.action = function (A) {
        t.changeVisibleState(!1), t.jsObject.options.exports.showExportDialog ? t.jsObject.controls.forms.exportForm.show(A.key, t.jsObject.options.actions.exportReport) : t.jsObject.postExport(A.key, t.jsObject.getDefaultExportSettings(A.key))
    }
}, StiJsViewer.prototype.InitializeBaseSaveMenu = function (A, e) {
    var t = !0, o = [];
    if (this.options.exports.showExportToDocument && "saveMenu" == A && (o.push(this.Item("Document", this.collections.loc.SaveDocument, "SaveDocument.png", "Document")), t = !1), ("saveMenu" == A && this.options.exports.showExportToPdf || this.options.exports.showExportToXps || this.options.exports.showExportToPowerPoint) && (t || o.push("separator1"), t = !1), this.options.exports.showExportToPdf && o.push(this.Item("Pdf", this.collections.loc.SavePdf, "SavePdf.png", "Pdf")), this.options.exports.showExportToXps && o.push(this.Item("Xps", this.collections.loc.SaveXps, "SaveXps.png", "Xps")), this.options.exports.showExportToPowerPoint && o.push(this.Item("Ppt2007", this.collections.loc.SavePpt2007, "SavePpt2007.png", "Ppt2007")), this.options.exports.showExportToHtml || this.options.exports.showExportToHtml5 || this.options.exports.showExportToMht) {
        t || o.push("separator2"), t = !1;
    ...
    if ((this.options.exports.showExportToText || this.options.exports.showExportToRtf || this.options.exports.showExportToWord2007 || this.options.exports.showExportToOdt) && (t || o.push("separator3"), t = !1), this.options.exports.showExportToText && o.push(this.Item("Text", this.collections.loc.SaveText, "SaveText.png", "Text")), this.options.exports.showExportToRtf && o.push(this.Item("Rtf", this.collections.loc.SaveRtf, "SaveRtf.png", "Rtf")), this.options.exports.showExportToWord2007 && o.push(this.Item("Word2007", this.collections.loc.SaveWord2007, "SaveWord2007.png", "Word2007")), this.options.exports.showExportToOpenDocumentWriter && o.push(this.Item("Odt", this.collections.loc.SaveOdt, "SaveOdt.png", "Odt")), (this.options.exports.showExportToExcel || this.options.exports.showExportToExcel2007 || this.options.exports.showExportToExcelXml || this.options.exports.showExportToOpenDocumentWriter) && (t || o.push("separator4"), t = !1), this.options.exports.showExportToExcel || this.options.exports.showExportToExcelXml || this.options.exports.showExportToExcel2007) {
    ...
    if (this.options.exports.showExportToImageBmp || this.options.exports.showExportToImageGif || this.options.exports.showExportToImageJpeg || this.options.exports.showExportToImagePcx || this.options.exports.showExportToImagePng || this.options.exports.showExportToImageTiff || this.options.exports.showExportToImageMetafile || this.options.exports.showExportToImageSvg || this.options.exports.showExportToImageSvgz) {
        t || o.push("separator6"), t = !1;
        var a = this.options.exports.defaultSettings.StiImageExportSettings.ImageType, r = "Emf" == a ? "Metafile" : a;
    ...
    A.action = function (A) {
        if (this.changeVisibleState(!1), this.jsObject.options.email.showExportDialog) this.jsObject.controls.forms.exportForm.show(A.key, this.jsObject.options.actions.emailReport); else if (this.jsObject.options.email.showEmailDialog) this.jsObject.controls.forms.sendEmailForm.show(A.key, this.jsObject.getDefaultExportSettings(A.key)); else {
    ...
    return n.itemStyleName = i, n.addItems = function (A) {
        while (this.innerContent.childNodes[0])this.innerContent.removeChild(this.innerContent.childNodes[0]);
        for (var e in A)"string" != typeof A[e] ? this.innerContent.appendChild(this.jsObject.VerticalMenuItem(this, A[e].name, A[e].caption, A[e].imageName, A[e].key, this.itemStyleName)) : this.innerContent.appendChild(this.jsObject.VerticalMenuSeparator(this, A[e]))
    }, n.addItems(o), n
}, StiJsViewer.prototype.VerticalMenuItem = function (A, e, t, o, i, s) {
    var n = document.createElement("div");
    n.jsObject = this, n.menu = A, n.name = e, n.key = i, n.caption_ = t, n.imageName = o, n.styleName = s || "stiJsViewerMenuStandartItem", n.id = this.generateKey(), n.className = n.styleName, A.items[e] = n, n.isEnabled = !0, n.isSelected = !1, n.style.height = this.options.isTouchDevice ? "30px" : "24px";
    var a = this.CreateHTMLTable();
    if (n.appendChild(a), a.style.height = "100%", a.style.width = "100%", null != o) {
        ...
        n.image = r, n.cellImage.style.lineHeight = "0", n.cellImage.appendChild(r), r.src = this.collections.images[o]
    }
    if (null != t) {
        var l = a.addCell();
        n.caption = l, l.style.padding = "0 20px 0 7px", l.style.textAlign = "left", l.style.whiteSpace = "nowrap", l.innerHTML = t
    }
    ...
    var t = document.createElement("div");
    return t.className = "stiJsViewerVerticalMenuSeparator", A.items[e] = t, t
}, StiJsViewer.prototype.InitializeViewModeMenu = function () {
    var A = [];
    A.push(this.Item("OnePage", this.collections.loc.OnePage, "OnePage.png", "ViewModeOnePage")), A.push(this.Item("WholeReport", this.collections.loc.WholeReport, "WholeReport.png", "ViewModeWholeReport"));
    var e = this.VerticalMenu("viewModeMenu", this.controls.toolbar.controls.ViewMode, "Down", A);
    e.action = function (A) {
        e.changeVisibleState(!1), e.jsObject.postAction(A.key)
    }
}, StiJsViewer.prototype.InitializeZoomMenu = function () {
    for (var A = [], e = ["25", "50", "75", "100", "150", "200"], t = 0; t < e.length; t++)A.push(this.Item("Zoom" + e[t], e[t] + "%", "SelectedItem.png", "Zoom" + e[t]));
    A.push("separator1"), A.push(this.Item("ZoomOnePage", this.collections.loc.ZoomOnePage, "ZoomOnePage.png", "ZoomOnePage")), A.push(this.Item("ZoomPageWidth", this.collections.loc.ZoomPageWidth, "ZoomPageWidth.png", "ZoomPageWidth"));
    var o = this.VerticalMenu("zoomMenu", this.controls.toolbar.controls.Zoom, "Down", A);
    o.action = function (A) {
        o.changeVisibleState(!1), o.jsObject.postAction(A.key)
    }
};
var Base64 = {
    _keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function (A) {
        ...
        while (l < A.length)t = A.charCodeAt(l++), o = A.charCodeAt(l++), i = A.charCodeAt(l++), s = t >> 2, n = (3 & t) << 4 | o >> 4, a = (15 & o) << 2 | i >> 6, r = 63 & i, isNaN(o) ? a = r = 64 : isNaN(i) && (r = 64), e = e + this._keyStr.charAt(s) + this._keyStr.charAt(n) + this._keyStr.charAt(a) + this._keyStr.charAt(r);
        return e
    }, decode: function (A) {
        var e = "", t, o, i, s, n, a, r, l = 0;
        A = A.replace(/[^A-Za-z0-9\+\/\=]/g, "");
        while (l < A.length)s = this._keyStr.indexOf(A.charAt(l++)), n = this._keyStr.indexOf(A.charAt(l++)), a = this._keyStr.indexOf(A.charAt(l++)), r = this._keyStr.indexOf(A.charAt(l++)), t = s << 2 | n >> 4, o = (15 & n) << 4 | a >> 2, i = (3 & a) << 6 | r, e += String.fromCharCode(t), 64 != a && (e += String.fromCharCode(o)), 64 != r && (e += String.fromCharCode(i));
        ...
        var e = "", t = 0, o = c1 = c2 = 0;
        while (t < A.length)o = A.charCodeAt(t), o < 128 ? (e += String.fromCharCode(o), t++) : o > 191 && o < 224 ? (c2 = A.charCodeAt(t + 1), e += String.fromCharCode((31 & o) << 6 | 63 & c2), t += 2) : (c2 = A.charCodeAt(t + 1), c3 = A.charCodeAt(t + 2), e += String.fromCharCode((15 & o) << 12 | (63 & c2) << 6 | 63 & c3), t += 3);
        return e
    }
}, JSON = JSON || {};
JSON.stringify = JSON.stringify || function (A) {
        var e = typeof A;
        if ("object" != e || null === A)return "string" == e && (A = '"' + A + '"'), String(A);
        var t, o, i = [], s = A && A.constructor == Array;
        for (t in A)o = A[t], e = typeof o, "string" == e ? o = '"' + o + '"' : "object" == e && null !== o && (o = JSON.stringify(o)), i.push((s ? "" : '"' + t + '":') + String(o));
        return (s ? "[" : "{") + String(i) + (s ? "]" : "}")
    }, JSON.parse = JSON.parse || function (str) {
        return "" === str && (str = '""'), eval("var p=" + str + ";"), p
    }, StiJsViewer.prototype.mergeOptions = function (A, e) {
    for (var t in A)void 0 === e[t] || "object" != typeof e[t] ? e[t] = A[t] : this.mergeOptions(A[t], e[t])
}, StiJsViewer.prototype.showError = function (A) {
    if (null != A && "string" == typeof A && "Error:" == A.substr(0, 6))return 7 == A.length && (A += "Undefined"), alert(A), !0;
    return !1
}, StiJsViewer.prototype.createXMLHttp = function () {
    if ("undefined" != typeof XMLHttpRequest)return new XMLHttpRequest;
    if (window.ActiveXObject)for (var A = ["MSXML2.XMLHttp.5.0", "MSXML2.XMLHttp.4.0", "MSXML2.XMLHttp.3.0", "MSXML2.XMLHttp", "Microsoft.XMLHttp"], e = 0; e < A.length; e++)try {
    ...
    var i = null;
    return e ? (i = {}, t.action && (i.jsviewer_action = t.action, delete t.action), i.jsviewer_parameters = Base64.encode(JSON.stringify(t))) : (i = "", t.action && (i += "jsviewer_action=" + t.action + "&", delete t.action), i += "jsviewer_parameters=" + encodeURIComponent(Base64.encode(JSON.stringify(t)))), i
    ...
    var o = this, i = this.createXMLHttp();
    0 != o.options.server.requestTimeout && setTimeout(function () {
        i.readyState < 4 && i.abort()
    }, 1e3 * o.options.server.requestTimeout), i.open("POST", A, !0), i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), i.responseType = "text", e && e.responseType && (i.responseType = e.responseType), i.onreadystatechange = function () {
        if (4 == i.readyState) {
            var A = 0;
            try {
                A = i.status
    ...
    t.body.appendChild(o), o.submit(), t.body.removeChild(o)
    ...
    switch (A) {
        ...
        case"GoToPage":
            ...
            break;
        case"BookmarkAction":
            if (this.reportParams.pageNumber == e || "WholeReport" == this.reportParams.viewMode)return void this.scrollToAnchor(t);
            this.reportParams.pageNumber = e, this.options.bookmarkAnchor = t;
            break;
        case"Bookmarks":
        ...
        case"Submit":
            return this.reportParams.editableParameters = null, this.reportParams.pageNumber = 0, void this.postInteraction({
                action: "Variables",
    ...
    this.controls.processImage.show(), this.postAjax(this.options.requestUrl.replace("{action}", null == A || "None" == this.options.server.cacheMode ? this.options.actions.getReportSnapshot : this.options.actions.viewerEvent), {action: null == A ? "GetReport" : "GetPages"}, this.showReportPage)
}, StiJsViewer.prototype.postPrint = function (A) {
    var e = {action: "PrintReport", printAction: A, bookmarksPrint: this.options.appearance.bookmarksPrint};
    switch (A) {
        case"PrintPdf":
            var t = this.options.requestAbsoluteUrl.replace("{action}", this.options.actions.printReport);
            window.navigator && window.navigator.msSaveOrOpenBlob ? this.printAsPdfIE(t, e) : this.printAsPdf(t, e);
            break;
    ...
    e.responseType = "blob", this.postAjax(this.options.requestAbsoluteUrl.replace("{action}", this.options.actions.printReport), e, function (A, e) {
        var t = document.getElementById("pdfPrintFrame");
        null != t && document.body.removeChild(t), t = document.createElement("iframe"), t.id = "pdfPrintFrame", t.name = "pdfPrintFrame", t.width = "0", t.height = "0", t.style.position = "absolute", t.style.border = "none", document.body.appendChild(t, document.body.firstChild), t.src = URL.createObjectURL(A)
    })
}, StiJsViewer.prototype.printAsPdfIE = function (A, e) {
    var t = document.getElementById("pdfPrintFrame");
    null != t && document.body.removeChild(t), t = document.createElement("iframe"), t.id = "pdfPrintFrame", t.name = "pdfPrintFrame", t.width = "0", t.height = "0", t.style.position = "absolute", t.style.border = "none", document.body.appendChild(t, document.body.firstChild);
    ...
    t.contentWindow.document.open("application/pdf"), t.contentWindow.document.write(a), t.contentWindow.document.close()
    ...
    if (e.showError(A))return;
    printFrame = document.getElementById("htmlPrintFrame"), null == printFrame && (printFrame = document.createElement("iframe"), printFrame.id = "htmlPrintFrame", printFrame.name = "htmlPrintFrame", printFrame.width = "0px", printFrame.height = "0px", printFrame.style.position = "absolute", printFrame.style.border = "none", document.body.appendChild(printFrame, document.body.firstChild)), printFrame.contentWindow.document.open(), printFrame.contentWindow.document.write(A), printFrame.contentWindow.document.close(), setTimeout(function () {
    ...
    var o = {
        ...
        exportFormat: A,
        exportSettings: e
    }, i = e.OpenAfterExport && "_blank" == this.options.appearance.openExportedReportTarget ? this.openNewWindow("about:blank", "_blank").document : null, s = i ? this.options.requestAbsoluteUrl : this.options.requestUrl;
    this.postForm(s.replace("{action}", t), o, i)
}, StiJsViewer.prototype.postEmail = function (A, e) {
    var t = {action: "SendEmail", exportFormat: A, exportSettings: e};
    this.controls.processImage.show(), this.postAjax(this.options.requestUrl.replace("{action}", this.options.actions.emailReport), t, this.emailResult)
}, StiJsViewer.prototype.postDesign = function () {
    var A = "_blank" == this.options.appearance.designTarget ? this.openNewWindow("about:blank", "_blank").document : null, e = A ? this.options.requestAbsoluteUrl : this.options.requestUrl;
    this.postForm(e.replace("{action}", this.options.actions.designReport), {action: "DesignReport"}, A)
    ...
    if ("InitVars" != A.action && ("DrillDown" == A.action && (A.drillDownParameters = this.reportParams.drillDownParameters.concat(A.drillDownParameters), A.drillDownGuid = hex_md5(JSON.stringify(A.drillDownParameters))), this.options.server.globalReportCache && (A.variables || A.sortingParameters || A.collapsingParameters))) {
        var e = {};
        A.variables && (e.variables = A.variables), A.sortingParameters && (e.sortingParameters = A.sortingParameters), A.collapsingParameters && (e.collapsingParameters = A.collapsingParameters), A.paramsGuid = hex_md5(JSON.stringify(e))
    }
    this.controls.processImage.show(), this.postAjax(this.options.requestUrl.replace("{action}", this.options.actions.interaction), A, "InitVars" == A.action ? this.initializeParametersPanel : this.showReportPage)
}, StiJsViewer.prototype.initializeParametersPanel = function (A, e) {
    e.showError(A) && (A = null), e.options.isParametersReceived = !0;
    var t = "string" == typeof A ? JSON.parse(A) : A;
    e.options.paramsVariables = t, e.InitializeParametersPanel(), e.controls.processImage.hide()
}, StiJsViewer.prototype.parseParameters = function (A) {
    var e = "string" == typeof A && "{" == A.substr(0, 1) ? JSON.parse(A) : A, t = this.controls.drillDownPanel;
    if (0 == t.buttonsRow.children.length && t.addButton(e.reportFileName, this.reportParams), "DrillDown" == e.action) {
        ...
        for (var i in t.buttons) {
            ...
            if (s.reportParams.reportGuid == e.reportGuid && s.reportParams.drillDownGuid == e.drillDownGuid) {
                o = !0, s.style.display = "inline-block", s.select();
                break
            }
        }
        o || (this.controls.drillDownPanel.addButton(e.reportFileName), this.reportParams.drillDownParameters = e.drillDownParameters, this.reportParams.pageNumber = 0, this.reportParams.pagesWidth = 0, this.reportParams.pagesHeight = 0)
    }
    return this.reportParams.pagesArray = e.pagesArray, "GetPages" != e.action && (this.reportParams.reportGuid = e.reportGuid, this.reportParams.paramsGuid = e.paramsGuid, this.reportParams.drillDownGuid = e.drillDownGuid, this.reportParams.pagesCount = e.pagesCount, this.reportParams.zoom = e.zoom, this.reportParams.viewMode = e.viewMode, this.reportParams.reportFileName = e.reportFileName, this.reportParams.interactionCollapsingStates = e.interactionCollapsingStates, e.bookmarksContent && (this.reportParams.bookmarksContent = e.bookmarksContent), e.isEditableReport && this.controls.buttons.Editor && (this.controls.buttons.Editor.style.display = "")), e
}, StiJsViewer.prototype.emailResult = function (A, e) {
    e.controls.processImage.hide(), "0" == A ? alert(e.collections.loc.EmailSuccessfullySent) : 0 == A.indexOf("<?xml") ? (alert(e.GetXmlValue(A, "ErrorCode")), alert(e.GetXmlValue(A, "ErrorDescription"))) : alert(A)
}, StiJsViewer.prototype.showReportPage = function (A, e) {
    if ("null" == A && e.options.isReportRecieved)return e.options.isReportRecieved = !1, void e.postAction();
    if (e.controls.processImage.hide(), e.options.isReportRecieved = !0, e.showError(A))return;
    if ("null" == A)return;
    var t = e.parseParameters(A);
    if (null == t)return;
    t.bookmarksContent && e.InitializeBookmarksPanel(), t.pagesArray && e.controls.reportPanel.addPages(), e.controls.toolbar && (e.controls.toolbar.changeToolBarState(), e.controls.toolbar.setEnabled(!0)), null != e.reportParams.autoZoom && (e.postAction(e.reportParams.autoZoom == -1 ? "ZoomPageWidth" : "ZoomOnePage"), delete e.reportParams.autoZoom), null != e.options.bookmarkAnchor && (e.scrollToAnchor(e.options.bookmarkAnchor), e.options.bookmarkAnchor = null), e.options.findMode && e.controls.findPanel && e.showFindLabels(e.controls.findPanel.controls.findTextBox.value), !e.options.isParametersReceived && e.options.toolbar.showParametersButton && e.postInteraction({action: "InitVars"})
    ...
    e.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (e.style.color = this.options.toolbar.fontColor), e.style.zIndex = "36", e.dayButtons = [], e.showTime = !1, e.key = new Date, this.controls.doubleDatePicker = e, this.controls.mainPanel.appendChild(e);
    var t = this.CreateHTMLTable();
    t.style.margin = "4px", t.style.border = "1px dotted #c6c6c6", e.innerContent.appendChild(t);
    ...
    i.ownerValue = A.secondOwnerValue, i.showTime = A.showTime, i.parentDataControl = A.secondParentDataControl, i.parentButton = A.secondParentButton, o.innerContent.className = "", i.innerContent.className = "", o.innerContent.style.margin = "4px", i.innerContent.style.margin = "4px", t.addCell(o.innerContent), t.addCell(i.innerContent).style.borderLeft = "1px dotted #c6c6c6";
    var s = document.createElement("div");
    t.addCell(s).style.borderLeft = "1px dotted #c6c6c6", s.jsObject = this, s.style.width = "150px", s.style.height = "250px", s.style.overflow = "auto", s.style.margin = "4px";
    for (var n = 0; n < this.collections.dateRanges.length; n++) {
        var a = this.collections.dateRanges[n], r = this.SmallButton(null, this.collections.loc[a]);
        r.name = a, s.appendChild(r), r.action = function () {
            var t = e.jsObject.GetValuesByDateRangeName(this.name);
            t && (e.setValuesToDatePickers(t[0], t[1]), A.hideOnClick && e.changeVisibleState(!1))
        }
    }
    return e.onshow = function () {
        o.onshow(), i.onshow()
    }, e.setValuesToDatePickers = function (A, e) {
        o.key = A, i.key = e, o.fill(), i.fill(), o.action(), i.action()
    }, e
}, StiJsViewer.prototype.GetValuesByDateRangeName = function (A) {
    var e = new Date, t = this, o = function (A, e) {
        A.setHours(0), A.setMinutes(0), A.setSeconds(0), e.setHours(23), e.setMinutes(59), e.setSeconds(59)
    }, i = function (A) {
        var i = t.GetFirstDayOfWeek(), s = 0 == i ? e.getDay() : e.getDay() - 1;
        s < 0 && (s = 6);
        var n = [new Date(e.valueOf() - 864e5 * s)];
        return n.push(new Date(n[0].valueOf() + 6 * 864e5)), o(n[0], n[1]), n
    }, s = new Date, n = new Date;
    o(s, n);
    var a = [s, n];
    switch (A) {
        case"CurrentMonth":
            a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), e.getMonth()));
            break;
        case"CurrentQuarter":
            var r = 3 * parseInt(e.getMonth() / 3);
            a[0].setMonth(r), a[1].setMonth(r + 2), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), r + 2));
            break;
        case"CurrentWeek":
            a = i(e);
            break;
        case"CurrentYear":
            ...
            break;
        case"NextMonth":
            var l = e.getMonth() + 1, c = e.getFullYear();
            l > 11 && (l = 0, c++), a[0].setYear(c), a[0].setMonth(l), a[0].setDate(1), a[1].setYear(c), a[1].setMonth(l), a[1].setDate(t.GetCountDaysOfMonth(c, l));
            break;
        case"NextQuarter":
            var c = e.getFullYear(), r = 3 * parseInt(e.getMonth() / 3) + 3;
            r > 11 && (r = 0, c++), a[0].setYear(c), a[1].setYear(c), a[0].setMonth(r), a[1].setMonth(r + 2), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(c, r + 2));
            break;
        case"NextWeek":
            a = i(e), a[0] = new Date(a[0].valueOf() + 7 * 864e5), a[1] = new Date(a[1].valueOf() + 7 * 864e5);
            break;
        case"NextYear":
            a[0].setYear(e.getFullYear() + 1), a[1].setYear(e.getFullYear() + 1), a[0].setMonth(0), a[1].setMonth(11), a[0].setDate(1), a[1].setDate(31);
            break;
        case"PreviousMonth":
            var l = e.getMonth() - 1, c = e.getFullYear();
            l < 0 && (l = 11, c--), a[0].setYear(c), a[0].setMonth(l), a[0].setDate(1), a[1].setYear(c), a[1].setMonth(l), a[1].setDate(t.GetCountDaysOfMonth(c, l));
            break;
        case"PreviousQuarter":
            var c = e.getFullYear(), r = 3 * parseInt(e.getMonth() / 3) - 3;
            r < 0 && (r = 9, c--), a[0].setYear(c), a[1].setYear(c), a[0].setMonth(r), a[1].setMonth(r + 2), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(c, r + 2));
            break;
        case"PreviousWeek":
            a = i(e), a[0] = new Date(a[0].valueOf() - 7 * 864e5), a[1] = new Date(a[1].valueOf() - 7 * 864e5);
            break;
        case"PreviousYear":
            ...
            break;
        case"FirstQuarter":
            a[0].setMonth(0), a[1].setMonth(2), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), 2));
            break;
        case"SecondQuarter":
            a[0].setMonth(3), a[1].setMonth(5), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), 5));
            break;
        case"ThirdQuarter":
            a[0].setMonth(6), a[1].setMonth(8), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), 8));
            break;
        case"FourthQuarter":
            a[0].setMonth(9), a[1].setMonth(11), a[0].setDate(1), a[1].setDate(t.GetCountDaysOfMonth(e.getFullYear(), 11));
            break;
        case"MonthToDate":
            a[0].setDate(1);
            break;
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Base.Localization.StiLocalization, o = function () {
            function t() {
            }
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Report.Components.StiText, o = e.Report.Components.StiCheckBox, i = e.Report.Components.StiRichText, n = e.System.Collections.Hashtable, a = function () {
            function t() {
            }
            ...
            return t.checkEditableReport = function (e) {
                for (var t = e.getComponents(), n = 0, a = t.list; n < a.length; n++) {
                    var s = a[n];
                    if (s.is(r) && s.editable)return !0;
                    if (s.is(o) && s.editable)return !0;
                    if (s.is(i) && s.editable)return !0
                }
                return !1
            }, t.applyEditableFieldsToReport = function (t, i) {
                if (null == i)return;
                try {
                    for (var a = i.as(n), s = 0, l = a.keys; s < l.length; s++)for (var p = l[s], g = p.toNumber(), m = a.get(p), u = 0, d = m.keys; u < d.length; u++) {
                        var c = d[u], S = c.toNumber(), y = m.get(c);
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Report.Export.StiDataExportMode, o = e.Report.StiExportFormat, i = e.Report.Export.StiHtmlExportMode, n = e.Report.Export.StiHtmlType, a = e.Report.ImageFormat, s = e.Report.StiRangeType, l = e.Report.Export.StiPdfAllowEditable, p = e.Report.Export.StiPdfImageCompressionMethod, g = e.Report.Export.StiPdfEncryptionKeyLength, m = e.Report.Export.StiUserAccessPrivileges, u = e.Report.Export.StiExcelType, d = function () {
            function e() {
            }
            ...
            return e.getReportFileName = function (e) {
                ...
                switch ("All" == t.PageRange ? d.pageRange.rangeType = s.All : (d.pageRange.rangeType = s.Pages, d.pageRange.pageRanges = t.PageRange), e) {
                    case o.Html:
                        d.htmlType = n[t.HtmlType], d.addPageBreaks = t.AddPageBreaks, d.exportMode = i[t.ExportMode], d.imageFormat = a[t.ImageFormat], d.useEmbeddedImages = t.UseEmbeddedImages, d.zoom = parseFloat(t.Zoom);
                        break;
                    case o.Html5:
                        d.htmlType = n[t.HtmlType], d.continuousPages = t.ContinuousPages, d.imageFormat = a[t.ImageFormat], d.imageQuality = parseFloat(t.ImageQuality), d.imageResolution = parseFloat(t.ImageResolution);
                        break;
                    case o.Pdf:
                        d.allowEditable = l[t.AllowEditable], d.compressed = !1, d.embeddedFonts = t.EmbeddedFonts, d.exportRtfTextAsImage = t.ExportRtfTextAsImage, d.getCertificateFromCryptoUI = t.GetCertificateFromCryptoUI, d.imageCompressionMethod = p[t.ImageCompressionMethod], d.imageQuality = parseFloat(t.ImageQuality), d.imageResolution = parseFloat(t.ImageResolution), d.keyLength = g[t.KeyLength], d.passwordInputOwner = t.PasswordInputOwner, d.passwordInputUser = t.PasswordInputUser, d.pdfACompliance = t.PdfACompliance, d.standardPdfFonts = t.StandardPdfFonts, d.useDigitalSignature = t.UseDigitalSignature, d.useUnicode = !1, d.userAccessPrivileges = 0;
                        for (var c = t.UserAccessPrivileges.replaceAll(" ", "").split(","), S = 0; S < c.length; S++)d.userAccessPrivileges += m[c[S]];
                        break;
                    case o.Excel2007:
                        d.excelType = u[t.ExcelType], d.exportDataOnly = t.ExportDataOnly, d.exportEachPageToSheet = t.ExportEachPageToSheet, d.exportObjectFormatting = t.ExportObjectFormatting, d.exportPageBreaks = t.ExportPageBreaks, d.imageQuality = parseFloat(t.ImageQuality), d.imageResolution = parseFloat(t.ImageResolution), d.useOnePageHeaderAndFooter = t.UseOnePageHeaderAndFooter;
                        break;
                    case o.Word2007:
                        d.imageQuality = parseFloat(t.ImageQuality), d.imageResolution = parseFloat(t.ImageResolution), d.removeEmptySpaceAtBottom = t.RemoveEmptySpaceAtBottom, d.usePageHeadersAndFooters = t.UsePageHeadersAndFooters;
                        break;
                    case o.Csv:
                        d.separator = t.Separator, d.skipColumnHeaders = t.SkipColumnHeaders, d.dataExportMode = r[t.DataExportMode]
                }
            }, e
        }();
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Report.Components.StiChart, o = e.Report.Components.StiCrossHeaderInteraction, i = e.Report.StiReport, n = e.Report.Components.StiDataBand, a = e.Report.Components.StiInteractionSortDirection, s = e.Report.Components.StiSortHelper, l = function () {
            function e() {
            }

            return e.applySorting = function (e, t) {
                var r = t.ComponentName.toString().split(";"), o = e.getComponentByName(r[0]), i = r[1].toBoolean();
                ...
                if (null != l && (l.sort = r.where(function (e, t) {
                    ...
                    if (null == l.sort || 0 == l.sort.length) l.sort = s.addColumnToSorting(l.sort, p, !0); else {
                        var g = s.getColumnIndexInSorting(l.sort, p);
                        if (i) g == -1 ? l.sort = s.addColumnToSorting(l.sort, p, !0) : l.sort = s.changeColumnSortDirection(l.sort, p); else if (g != -1) {
                ...
                var r = t.ComponentName.toString(), i = e.getComponentByName(r), n = i;
                ...
                var t = e.saveToJsonString(), r = new i;
                if (r.load(t), null != e.variables && e.variables.count > 0)for (var o = 0; o < e.variables.count; o++)r.setVariable(e.variables.keys[o], e.variables.values[o]);
                ...
                var n = o.PageIndex.toNumber(), a = o.ComponentIndex.toNumber(), s = o.PageGuid, l = o.ReportFile, p = null, g = e;
                if (String.isNullOrEmpty(s)) String.isNullOrEmpty(l) || (g = new i, g.loadFile(l)); else {
                    for (var m = 0, u = e.pages.list; m < u.length; m++) {
                        var d = u[m];
                        d.guid == s ? (p = d, d.enabled = !0, d.skip = !1) : d.enabled = !1
                    }
                    for (var c = e.getComponents(), S = 0, y = c.list; S < y.length; S++) {
                        var f = y[S];
                        if (null != f.interaction && f.interaction.drillDownEnabled && f.interaction.drillDownPageGuid == p.guid && (f.interaction.drillDownPage = null), f.is(r))for (var h = f.as(r), v = 0, A = h.series.list; v < A.length; v++)var E = A[v]
                    }
                }
                e.reportAlias == g.reportAlias && (g.reportAlias = null == p.alias || 0 == p.alias.length ? p.name : p.alias), e.reportDescription == g.reportDescription && (g.reportDescription = g.reportAlias);
                var w = t.renderedPages.getByIndex(n), b = w.components.getByIndex(a);
                if (null != b && null != b.drillDownParameters)for (var x = 0, T = b.drillDownParameters; x < T.length; x++) {
                    var P = T[x];
                ...
                var n = r.count - 1;
                if (0 != e.bookmarks.count)for (var a = 0; a < e.bookmarks.count; a++)this.addBookmarkNode(e.bookmarks.list[a], n, r)
                ...
                for (var S = 0; S < d.count; S++) {
                    var y = d[S], f = String.empty;
                    f = o[y.title] ? String.stiFormat("Page {0}", o[y.title] + 1) : "Page 0", c += String.stiFormat("bookmarks.add({0},{1},'{2}','{3}','{4}');", S, y.parent, y.title, y.url, f)
                }
                return c
            }, e
        }();
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Report.Dictionary.StiSelectionMode, o = e.Report.Dictionary.StiItemsInitializationType, i = e.Report.Engine.StiVariableHelper, n = e.Report.Dictionary.StiTypeMode, a = e.Report.Dictionary.StiType, s = e.System.Enum, l = e.Report.Dictionary.StiVariableInitBy, p = e.Report.Dictionary.StiDateTimeType, g = e.Report.StringRange, m = e.Report.FloatRange, u = e.Report.CharRange, d = e.Report.DateTimeRange, c = e.Report.TimeSpanRange, S = e.Report.DecimalRange, y = e.Report.DoubleRange, f = e.Report.ByteRange, h = e.Report.ShortRange, v = e.Report.IntRange, A = e.Report.LongRange, E = e.Report.GuidRange, w = function () {
            function t() {
            ...
            return t.fillDialogInfoItems = function (e) {
                ...
                var r = [], o = null != t.dialogInfo.bindingVariable ? t.dialogInfo.bindingVariable.value : null, i = 0;
                if (null != t.dialogInfo.keys && 0 != t.dialogInfo.keys.length)for (var n = t.dialogInfo.getDialogInfoItems(t.type), a = 0, s = n; a < s.length; a++) {
                    var l = s[a];
                    if (null == o || o == e.System.Convert.toString(l.valueBinding)) {
                        var p = {};
                        p.value = l.value, p.key = l.keyObject, p.keyTo = l.keyObjectTo, t.type == e.System.DateTime || t.type == e.System.NullableDateTime || t.type == e.System.StimulsoftDateTimeRange || t.type == e.System.StimulsoftDateTimeList ? (null != l.keyObject && (p.key = this.getDateTimeObject(l.keyObject)), null != l.keyObjectTo && (p.keyTo = this.getDateTimeObject(l.keyObjectTo))) : (null != p.value && (p.value = p.value.toString()), null != p.key && (p.key = p.key.toString()), null != p.keyTo && (p.keyTo = p.keyTo.toString())), r.add(p)
                    }
                    i++
                }
                return i > 0 ? r : null
            }, t.getDateTimeObject = function (t) {
                if (null != t && !t.is(e.System.DateTime))return t;
                ...
                for (var o in r)for (var i = 0, n = t.dictionary.variables.list; i < n.length; i++) {
                    var a = n[i];
                    a.name == o && (a.value = e.System.Convert.toString(r[o])), null != a.dialogInfo.bindingVariable && a.dialogInfo.bindingVariable.name == o && (a.dialogInfo.bindingVariable.value = e.System.Convert.toString(r[o]))
                }
            }, t.setVariableValue = function (t, r, o, i) {
                var n = ".", a = null, s = null, l = null;
                if (null != o && (o.is(Array) && (l = o), "object" == typeof o ? s = o : a = e.System.Convert.toString(o)), i.type == String) t.setVariable(r, o); else if (i.type == e.System.Single || i.type == e.System.Single) {
                    var p = 0;
                    ...
                    try {
                        ...
                        e.System.StiError.showError(t, !1), w = e.System.Guid.empty
                    }
                    t.setVariable(r, w)
                } else if (i.type == e.System.StimulsoftStringRange) t.setVariable(r, new g(e.System.Convert.toString(s.from), e.System.Convert.toString(s.to))); else if (i.type == e.System.StimulsoftFloatRange) {
                    var b = 0, x = 0;
                    b = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new m(b, x))
                } else if (i.type == e.System.StimulsoftDoubleRange) {
                    var b = 0, x = 0;
                    b = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new y(b, x))
                } else if (i.type == e.System.StimulsoftDecimalRange) {
                    var b = 0, x = 0;
                    b = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new S(b, x))
                } else if (i.type == e.System.StimulsoftIntRange) {
                    var b = 0, x = 0;
                    b = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new v(b, x))
                } else if (i.type == e.System.StimulsoftShortRange) {
                    var b = 0, x = 0;
                    b = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new h(b, x))
                } else if (i.type == e.System.StimulsoftLongRange) {
                    var b = 0, x = 0;
                    b = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new A(b, x))
                } else if (i.type == e.System.StimulsoftByteRange) {
                    var b = 0, x = 0;
                    b = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), x = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new f(b, x))
                } else if (i.type == e.System.StimulsoftCharRange) {
                    var b = 0, x = 0;
                    b = e.System.Convert.toString(s.from), x = e.System.Convert.toString(s.to), t.setVariable(r, new u(b, x))
                } else if (i.type == e.System.StimulsoftDateTimeRange) {
                    var b = e.System.DateTime.now, x = e.System.DateTime.now;
                    b = new e.System.DateTime(Date.parse(s.from)), x = new e.System.DateTime(Date.parse(s.to)), t.setVariable(r, new d(b, x))
                } else if (i.type == e.System.StimulsoftTimeSpanRange) {
                    var b = e.System.TimeSpan.zero, x = e.System.TimeSpan.zero;
                    b = e.System.TimeSpan.fromString(s.from), x = e.System.TimeSpan.fromString(s.to), t.setVariable(r, new c(b, x))
                } else if (i.type == e.System.StimulsoftGuidRange) {
                    var b = e.System.Guid.empty, x = e.System.Guid.empty;
                    try {
                        b = new e.System.Guid(e.System.Convert.toString(s.from)), x = new e.System.Guid(e.System.Convert.toString(s.to))
                    } catch (t) {
                        e.System.StiError.showError(t, !1)
                    }
                    t.setVariable(r, new E(b, x))
                } else if (i.type == e.System.StimulsoftStringList) {
                    for (var T = [], P = 0, I = l; P < I.length; P++) {
                        var p = I[P];
                        T.add(p.toString())
                    }
                    ...
                    for (var T = [], R = 0, C = l; R < C.length; R++) {
                        var p = C[R];
                        T.add(p.toNumber())
                    }
                    ...
                    for (var T = [], D = [], V = 0, B = l; V < B.length; V++) {
                        var p = B[V];
                        T.add(p.toNumber()), D.add(p.toString())
                    }
                    t.setVariable(r, T), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = D)
                } else if (i.type == e.System.StimulsoftCharList) {
                    for (var T = [], k = 0, F = l; k < F.length; k++) {
                        var p = F[k];
                        T.add(p.toString())
                    }
                    t.setVariable(r, T), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = T.toArray().select(function (e) {
                ...
                for (var o = {}, i = {}, n = 0, a = 0, g = t.dictionary.variables.list; a < g.length; a++) {
                    ...
                    if (m.requestFromUser) {
                        ...
                        var u = {};
                        u.name = m.name, u.alias = this.getVariableAlias(m), u.basicType = this.getBasicType(m), u.type = this.getStiType(m), u.allowUserValues = m.dialogInfo.allowUserValues, m.selection == r.FromVariable ? u.value = m.initBy == l.Value ? m.valueObject : t.getVariable(m.name) : m.selection == r.First ? u.value = t.getVariable(m.name) : u.value = "", u.key = u.value, u.keyTo = String.empty, u.dateTimeType = s.getName(p, m.dialogInfo.dateTimeType);
                        var d = this.getItems(m);
                        u.items = d;
                        var c = null;
                        if (null != d && d.count > 0)for (var S = e.System.Convert.toString(u.value), y = 0, f = d; y < f.length; y++) {
                            var h = f[y];
                        ...
                        if ("Value" == u.basicType || "NullableValue" == u.basicType) {
                            null != c && (u.key = c.key, u.value = c.value, (m.dialogInfo.allowUserValues || null == u.value || "string" == typeof u.value && "" == u.value) && (u.value = u.key));
                        ...
                        if ("Range" == u.basicType && ("DateTime" == u.type ? u.key = this.getDateTimeObject(m.initBy == l.Value ? m.valueObject.fromObject : t.getVariable(m.name).fromObject) : u.key = m.initBy == l.Value ? m.valueObject.fromObject.toString() : t.getVariable(m.name).fromObject.toString(), "DateTime" == u.type ? u.keyTo = this.getDateTimeObject(m.initBy == l.Value ? m.valueObject.toObject : t.getVariable(m.name).toObject) : u.keyTo = m.initBy == l.Value ? m.valueObject.toObject.toString() : t.getVariable(m.name).toObject.toString()), "List" == u.basicType) {
                            var w = t.getVariable(m.name);
                            u.value = w, u.key = w
                        }
                        "DateTime" != u.type, o[n.toString()] = u, n++
                    }
                }
                if (n > 0) {
                    for (var b in i)for (var x in o)o[x].name == b && (o[x].binding = !0);
                    return o
                }
                return null
            }, t
...
!function (e) {
    var t;
    !function (t) {
        var r = e.System.Drawing.Color, o = e.Report.Export.StiHtmlExportMode, i = function () {
            function e() {
                this.backgroundColor = r.white, this.rightToLeft = !1, this.fullScreenMode = !1, this.scrollbarsMode = !1, this.openLinksTarget = "_self", this.openExportedReportTarget = "_blank", this.showTooltips = !0, this.pageAlignment = t.StiContentAlignment.Center, this.showPageShadow = !0, this.pageBorderColor = r.gray, this.bookmarksPrint = !1, this.bookmarksTreeWidth = 180, this.parametersPanelMaxHeight = 300, this.parametersPanelColumnsCount = 2, this.parametersPanelDateFormat = String.empty, this.interfaceType = t.StiInterfaceType.Auto, this.chartRenderType = t.StiChartRenderType.AnimatedVector, this.htmlRenderMode = o.Table, this.datePickerFirstDayOfWeek = t.StiFirstDayOfWeek.Monday
            }
...
!function (e) {
    var t;
    !function (t) {
        var r = e.System.Drawing.Color, o = function () {
            function o() {
                this.visible = !0, this.backgroundColor = r.empty, this.borderColor = r.empty, this.fontColor = r.empty, this.fontFamily = "Arial", this.alignment = t.StiContentAlignment.Default, this.showButtonCaptions = !0, this.showPrintButton = !0, this.showSaveButton = !0, this.showSendEmailButton = !1, this.showBookmarksButton = !0, this.showParametersButton = !0, this.showEditorButton = !0, this.showFullScreenButton = !0, this.showFirstPageButton = !0, this.showPreviousPageButton = !0, this.showCurrentPageControl = !0, this.showNextPageButton = !0, this.showLastPageButton = !0, this.showZoomButton = !0, this.showViewModeButton = !0, this.showDesignButton = !1, this.showAboutButton = !0, this.printDestination = t.StiPrintDestination.Default, this.viewMode = t.StiWebViewMode.OnePage, this.multiPageWidthCount = 2, this.multiPageHeightCount = 2, this._zoom = 100, this.menuAnimation = !0, this.showMenuMode = t.StiShowMenuMode.Click
            }
...
!function (e) {
    ...
    !function (e) {
        ...
        !function (e) {
            e[e.Auto = 0] = "Auto", e[e.Mouse = 1] = "Mouse", e[e.Touch = 2] = "Touch"
        ...
        !function (e) {
            e[e.OnePage = 0] = "OnePage", e[e.WholeReport = 1] = "WholeReport", e[e.MultiPage = 2] = "MultiPage"
...
!function (e) {
    ...
    !function (e) {
        var t = function () {
            function e() {
                this._email = null, this._subject = null, this._message = null
            }
            ...
            return Object.defineProperty(e.prototype, "email", {
                ...
                return {email: this.email, subject: this.subject, message: this.message}
            }, e
        }();
...
!function (e) {
    var t;
    !function (t) {
        var r = e.Report.Export.StiCsvExportSettings, o = e.Report.Export.StiCsvExportService, i = e.Report.Export.StiHtmlChartType, n = e.Report.Export.StiWord2007ExportService, a = e.Report.Export.StiWord2007ExportSettings, s = e.System.Drawing.ColorTranslator, l = e.System.IO.TextWriter, p = e.Report.Export.StiHtmlExportService, g = e.Report.Export.StiHtmlTextWriter, m = e.Report.Export.StiHtmlExportSettings, u = e.Report.StiPagesRange, d = e.Report.StiRangeType, c = e.Report.Export.StiHtmlExportMode, S = e.Report.Export.StiHtmlExportQuality, y = e.Report.Export.StiHtmlExportBookmarksMode, f = e.Base.Drawing.StiBrush, h = e.Report.StiExportFormat, v = e.Base.StiGZipHelper, A = e.Report.Export.StiPdfExportSettings, E = e.Report.Export.StiPdfExportService, w = e.System.IO.MemoryStream, b = e.Report.Export.StiExcel2007ExportService, x = e.Report.Export.StiExcelExportSettings, T = e.System.Promise, P = function () {
            function P(e, r, o) {
                this.drillDownReportCache = {}, this.onBeginProcessData = null, this.onEndProcessData = null, this.onPrintReport = null, this.onBeginExportReport = null, this.onEndExportReport = null, this.onEmailReport = null, this.onDesignReport = null, this.reportCache = {}, this._visible = !0, this._options = e || new t.StiViewerOptions, this._viewerId = r || "StiViewer", this._options.viewerId = this._viewerId, this._renderAfterCreate = void 0 === o || o, this._renderAfterCreate && this.renderHtml()
            }
            ...
            return Object.defineProperty(P.prototype, "viewerId", {
                ...
                var s = String.isNullOrEmpty(this.options.width) ? "100%" : this.options.width, u = String.isNullOrEmpty(this.options.height) ? this.options.appearance.scrollbarsMode ? "600px" : "100%" : this.options.height, d = String.stiFormat("#{0:X2}{1:X2}{2:X2}", this.options.appearance.backgroundColor.r, this.options.appearance.backgroundColor.g, this.options.appearance.backgroundColor.b), c = "<div style='width: " + s + "; height: " + u + "; background: " + d + ";";
                this.visible || (c += " display: none;"), c += "' id='" + this.viewerId + "'><div id='" + this.viewerId + "_JsViewerMainPanel' class='stiJsViewerMainPanel'></div></div>", i && void 0 !== i.innerHTML ? i.innerHTML = c : document.write(c);
                var S = this.options.toParameters();
                S.loc = t.StiCollectionsHelper.GetLocalizationItems(), this._jsObject = new StiJsViewer(S), this._jsObject.viewer = this, e.System.StiError.errorMessageForm = e.System.StiError.errorMessageForm || this.jsObject.controls.forms.errorMessageForm || this.jsObject.InitializeErrorMessageForm(), this.jsObject.assignReport = function (t) {
                    var r = this;
                    if (null != this.viewer.report && (this.viewer.report.onBeginProcessData = null, this.viewer.report.onEndProcessData = null), this.viewer.drillDownReportCache = {}, t) {
                        ...
                        var i = function () {
                            r.options.isParametersReceived = !1, r.options.paramsVariables = null, r.controls.drillDownPanel.reset(), setTimeout(function () {
                    ...
                    return r.action = e.action, r.pagesArray = this.viewer.getPagesArray(this.viewer.report, {
                        ...
                        zoom: e.zoom,
                        openLinksTarget: this.options.appearance.openLinksTarget
                    }, e), "GetPages" != e.action && (r.pagesCount = 0, null != this.viewer.report && (r.reportGuid = this.viewer.report.reportGuid, r.isEditableReport = t.StiEditableFieldsHelper.checkEditableReport(this.viewer.report), r.pagesCount = this.viewer.report.renderedPages.count, r.reportFileName = this.viewer.getReportFileName(), r.interactionCollapsingStates = this.viewer.report.interactionCollapsingStates), r.paramsGuid = e.paramsGuid, r.drillDownGuid = e.drillDownGuid, r.zoom = e.zoom, r.viewMode = e.viewMode, "DrillDown" == e.action && (r.drillDownParameters = e.drillDownParameters), null != this.viewer.report.bookmark && this.viewer.report.bookmark.bookmarks.count > 0 && (r.bookmarksContent = t.StiReportHelper.getBookmarksContent(this.viewer.report, e.viewerId, "OnePage" == e.viewMode ? e.pageNumber : -1))), r
                }, this.jsObject.postAjax = function (t) {
                    var r = this, o = this.createPostParameters(t, !0), i = e.System.Convert.fromBase64StringText(o.jsviewer_parameters), n = JSON.parse(i);
                    ...
                    this.controls.processImage.show(), this.viewer.invokeDesignReport(), this.controls.processImage.hide()
                    ...
                    var d = h[i], c = null;
                    u == t.StiExportAction.SendEmail && (c = new t.StiEmailSettings, c.email = s.Email, c.message = s.Message, c.subject = s.Subject);
                    var S = this.viewer;
                    switch (d) {
                        case h.Document:
                            var y = S.getReportFileName(), f = S.invokeBeginExportReport(null, d, y);
                            if (null != f) {
                                if (f.preventDefault)break;
                                y = f.fileName
                            }
                            var T = S.report.saveDocumentToJsonString();
                            if (f = S.invokeEndExportReport(d, y, T), null != f) {
                                if (f.preventDefault)break;
                                y = f.fileName
                            }
                            if ("Mdz" == s.Format) {
                            ...
                            } else Object.saveAs(T, y + ".mdc", "application/json;charset=utf-8");
                            break;
                        case h.Html:
                            var I = new m;
                            I.useWatermarkMargins = !1, I.exportMode = S.options.appearance.htmlRenderMode, t.StiExportsHelper.applyExportSettings(d, s, I);
                            var R = S.getReportFileName(), C = S.invokeBeginExportReport(I, d, R);
                            if (null != C) {
                                if (C.preventDefault)break;
                                R = C.fileName
                            }
                            var D = new p, V = new l, B = new g(V);
                            D.exportToAsync(function () {
                                var e = V.getStringBuilder().toString();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, R, e);
                                if (C = S.invokeEndExportReport(d, R, e), null != C) {
                                    if (C.preventDefault)return;
                                    R = C.fileName
                                }
                                Object.saveAs(e, R + ".html", "text/html;charset=utf-8")
                            }, S.report, B, I);
                            break;
                        case h.Html5:
                            var I = new m;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var k = S.getReportFileName(), F = S.invokeBeginExportReport(I, d, k);
                            if (null != F) {
                                if (F.preventDefault)break;
                                k = F.fileName
                            }
                            var D = new p, M = new l, B = new g(M);
                            D.exportToAsync(function () {
                                var e = M.getStringBuilder().toString();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, k, e);
                                if (F = S.invokeEndExportReport(d, k, e), null != F) {
                                    if (F.preventDefault)return;
                                    k = F.fileName
                                }
                                Object.saveAs(e, k + ".html", "text/html;charset=utf-8")
                            }, S.report, B, I);
                            break;
                        case h.Pdf:
                            var I = new A;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var H = S.getReportFileName(), O = S.invokeBeginExportReport(I, d, H);
                            if (null != O) {
                                if (O.preventDefault)break;
                                H = O.fileName
                            }
                            var D = new E, j = new w;
                            D.exportToAsync(function () {
                                var e = j.toArray();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, H, e);
                                if (O = S.invokeEndExportReport(d, H, e), null != O) {
                        ...
                        case h.Excel2007:
                            var I = new x;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var Q = S.getReportFileName(), N = S.invokeBeginExportReport(I, d, Q);
                            if (null != N) {
                                if (N.preventDefault)break;
                                Q = N.fileName
                            }
                            var D = new b, W = new w;
                            D.exportToAsync(function () {
                                var e = W.toArray();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, Q, e);
                                if (N = S.invokeEndExportReport(d, Q, e), null != N) {
                        ...
                        case h.Word2007:
                            var I = new a;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var L = S.getReportFileName(), U = S.invokeBeginExportReport(I, d, L);
                            if (null != U) {
                                if (U.preventDefault)break;
                                L = U.fileName
                            }
                            var D = new n, z = new w;
                            D.exportToAsync(function () {
                                var e = z.toArray();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, L, e);
                                if (U = S.invokeEndExportReport(d, L, e), null != U) {
                        ...
                        case h.Csv:
                            var I = new r;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var G = S.getReportFileName(), J = S.invokeBeginExportReport(I, d, G);
                            if (null != J) {
                                if (J.preventDefault)break;
                                G = J.fileName
                            }
                            var D = new o, X = new w;
                            D.exportToAsync(function () {
                                var e = X.toArray();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, G, e);
                                if (J = S.invokeEndExportReport(d, G, e), null != J) {
                    ...
                    var t = this.viewer, r = t.invokePrintReport(e);
                    if (null == r || !r.preventDefault) {
                        var o = t.report;
                        switch (null != r && (o = r.report), e) {
                            case"PrintPdf":
                                o.printToPdf(null);
                                break;
                            case"PrintWithPreview":
                                var i = new m, n = new p, a = new l, s = new g(a);
                                i.exportMode = t.options.appearance.htmlRenderMode, i.useWatermarkMargins = !1, i.removeEmptySpaceAtBottom = !1, n.exportToAsync(function () {
                                    var e = a.getStringBuilder().toString(), r = new Blob([e], {type: "text/html"});
                    ...
                    if (null != o) {
                        ...
                        "Variables" != e.action && "Sorting" != e.action && "Collapsing" != e.action || (r.jsObject.controls.processImage.show(), setTimeout(function () {
                            t.StiVariablesHelper.applyReportParameters(o, e.variables), o.isRendered || o.renderAsync(function () {
                                r.jsObject.postAjax(e)
                            })
                        }, 50)), "Sorting" == e.action ? (r.jsObject.controls.processImage.show(), setTimeout(function () {
                            t.StiReportHelper.applySorting(o, e.sortingParameters), o.isRendered || o.renderAsync(function () {
                                r.jsObject.postAjax(e)
                            })
                        }, 50)) : "Collapsing" == e.action && (r.jsObject.controls.processImage.show(), setTimeout(function () {
                            t.StiReportHelper.applyCollapsing(o, e.collapsingParameters), o.isRendered || o.renderAsync(function () {
                                r.jsObject.postAjax(e)
                            })
                        }, 50)), "DrillDown" == e.action && (r.jsObject.controls.processImage.show(), e.drillDownParameters = this.reportParams.drillDownParameters.concat(e.drillDownParameters), e.drillDownGuid = hex_md5(JSON.stringify(e.drillDownParameters)), setTimeout(function () {
                            var o = t.StiReportHelper.cloneReport(r.reportTemplate), i = r.report, n = 0, a = function () {
                                i = t.StiReportHelper.applyDrillDown(o, i, e.drillDownParameters[n]), i.isRendered = !1, i.isInteractionRendering = !0, i.renderAsync(function () {
                                    i.isInteractionRendering = !1, n < e.drillDownParameters.length - 1 ? (n++, a()) : (r.reportCache[i.reportGuid + "|" + e.drillDownGuid] = i, r.jsObject.postAjax(e))
                                })
                            };
                            a()
                        }, 50))
                ...
                this.onBeginProcessData && this.onBeginProcessData.is(Function) && (e.sender = "Viewer", this.onBeginProcessData(e, t))
            }, P.prototype.invokeEndProcessData = function (e) {
                this.onEndProcessData && this.onEndProcessData.is(Function) && (e.sender = "Viewer", this.onEndProcessData(e))
                ...
                if (this.onBeginExportReport && this.onBeginExportReport.is(Function)) {
                    ...
                    return this.onBeginExportReport(o), o
                }
                return null
                ...
                if (this.onEndExportReport && this.onEndExportReport.is(Function)) {
                    ...
                    return this.onEndExportReport(o), o
                }
                return null
                ...
                var p = new m;
                switch (p.pageRange = new u(d.CurrentPage, "", o), p.zoom = n, p.exportMode = this.options.appearance.htmlRenderMode, p.exportQuality = S.High, p.exportBookmarksMode = y.ReportOnly, p.removeEmptySpaceAtBottom = !1, p.openLinksTarget = a, p.useWatermarkMargins = !0, this.options.appearance.chartRenderType) {
                ...
                var c = new l, h = new g(c);
                r.exportTo(e, h, p);
                var v = c.getStringBuilder().toString(), A = {};
                A.content = v;
                var E = e.renderedPages.getByIndex(o);
                if (!E)return null;
                return A.margins = String.stiFormat("{0}px {1}px {2}px {3}px", Math.round(e.unit.convertToHInches(E.margins.top) * n), Math.round(e.unit.convertToHInches(E.margins.right) * n), Math.round(e.unit.convertToHInches(E.margins.bottom) * n), Math.round(e.unit.convertToHInches(E.margins.left) * n)), A.sizes = String.stiFormat("{0};{1}", Math.round(e.unit.convertToHInches(E.pageWidth) * n), Math.round(e.unit.convertToHInches(E.pageHeight) * n)), A.background = s.toHtml(f.toColor(E.brush)), A
            }, P.prototype.getPagesArray = function (e, t, r) {
                if (null == e)return [];
                var o = new p;
                o.insertInteractionParameters = !0, o.renderAsDocument = this.options.appearance.htmlRenderMode != c.Table, o.styles = [], o.clearOnFinish = !1, o.renderStyles = !1, o.exportServiceId = this.viewerId;
                var i = String.empty, n = String.empty, a = String.empty, s = String.empty, m = [];
                if ("OnePage" == t.viewMode) {
                    var u = this.getReportPage(e, o, t.pageNumber, t.zoom / 100, t.openLinksTarget);
                    m.add(u)
                } else if ("WholeReport" == t.viewMode)for (var d = 0; d < e.renderedPages.count; d++) {
                    var u = this.getReportPage(e, o, d, t.zoom / 100, t.openLinksTarget);
                    m.add(u)
                } else if ("MultiPage" == t.viewMode) {
                    var S = t.multiPageWidthCount, y = t.multiPageHeightCount;
                    null == S && (S = 1), null == y && (y = 1);
                    for (var f = [], h = Math.min(t.pageNumber + S * y, t.pageNumber + e.renderedPages.count), d = 0; d < h; d++) {
                        var v = void 0;
                        null != f[f.length - 1] && f[f.length - 1].length < S ? v = f[f.length - 1] : (v = [], f.add(v)), v.add({
                    ...
                    for (var A = 0, E = 0, w = 0, b = f; w < b.length; w++) {
                        for (var v = b[w], x = 0, T = 0, P = 0, I = v; P < I.length; P++) {
                            var R = I[P];
                            x += t.multiPageMargins, x += R.pageWidth, x += t.multiPageMargins, T = Math.max(R.pageHeight, T)
                        }
                        A = Math.max(x, A), E += t.multiPageMargins, E += T, E += t.multiPageMargins
                    }
                    var C = t.multiPageContainerWidth / A, D = t.multiPageContainerHeight / E, V = Math.trunc(100 * Math.min(C, D)) / 100 - .05;
                    null == V && (V = 1), r.zoom = Math.round(100 * V);
                    for (var d = 0; d < e.renderedPages.count; d++) {
                        var u = this.getReportPage(e, o, d, V, t.openLinksTarget);
                        m.add(u)
                    }
                }
                var B = new l, k = new g(B);
                o.htmlWriter = k, null != o.tableRender && o.tableRender.renderStylesTable2(!0, !1, !1, null);
                var F = B.getStringBuilder().toString();
                m.add(F);
                var M = o.getChartScript();
                return m.add(M), o.clear(), m
...
!function (e) {
    ...
    !function (t) {
        var r = e.System.Drawing.Color, o = function () {
            function e() {
                this.appearance = new t.StiAppearanceOptions, this.toolbar = new t.StiToolbarOptions, this.exports = new t.StiExportsOptions, this.email = new t.StiEmailOptions, this.width = "100%", this.height = String.empty, this.viewerId = String.empty, this.requestStylesUrl = String.empty, this.productVersion = "2016.3", this.actions = {
            ...
            return e.prototype.toParameters = function () {
                var e = {};
                return this.serializeObject(this, e), {options: e}
            }, e.prototype.serializeObject = function (o, i) {
                for (var n in o)if ("object" == typeof o[n])if (o[n].is(r)) {
                    var a = o[n];
                    a.isNamedColor ? i[n] = a.name : i[n] = String.stiFormat("#{0:X2}{1:X2}{2:X2}", a.r, a.g, a.b)
                } else i[n] = {}, this.serializeObject(o[n], i[n]); else {
                    if (o.is(e) && ("width" == n || "height" == n))continue;
                    i[n] = o[n], o.is(t.StiAppearanceOptions) && ("pageAlignment" == n ? i[n] = t.StiContentAlignment[o[n]] : "interfaceType" == n ? i[n] = t.StiInterfaceType[o[n]] : "chartRenderType" == n ? i[n] = t.StiChartRenderType[o[n]] : "datePickerFirstDayOfWeek" == n && (i[n] = t.StiFirstDayOfWeek[o[n]])), o.is(t.StiToolbarOptions) && ("alignment" == n ? i[n] = t.StiContentAlignment[o[n]] : "printDestination" == n ? i[n] = t.StiPrintDestination[o[n]] : "viewMode" == n ? i[n] = t.StiWebViewMode[o[n]] : "showMenuMode" == n && (i[n] = t.StiWebViewMode[o[n]]))
                }
            }, e
        }();
